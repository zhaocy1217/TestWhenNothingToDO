...
[ArgumentDescription(1, typeof(int), "数量", new object[] {  }), ArgumentDescription(0, typeof(EHonorType), "荣誉类型", new object[] {  }), CheatCommand("英雄/属性修改/其它/ChangeHonorPoint", "加荣誉(局内)点", 0x48)]
