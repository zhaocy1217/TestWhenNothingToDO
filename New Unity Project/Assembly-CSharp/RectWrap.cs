...
public class RectWrap
{
    ...
    private static int _CreateRect(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            case 1:
            {
                Rect rect = (Rect) LuaScriptMgr.GetNetObject(L, 1, typeof(Rect));
            ...
            case 4:
            {
                ...
                Rect rect3 = new Rect(number, num3, num4, num5);
    ...
    private static int get_center(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, ((Rect) luaObject).get_center());
        return 1;
    }
    ...
    private static int get_height(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, ((Rect) luaObject).get_height());
        return 1;
    }
    ...
    private static int get_max(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, ((Rect) luaObject).get_max());
        return 1;
    }
    ...
    private static int get_min(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, ((Rect) luaObject).get_min());
        return 1;
    }
    ...
    private static int get_position(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, ((Rect) luaObject).get_position());
        return 1;
    }
    ...
    private static int get_size(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, ((Rect) luaObject).get_size());
        return 1;
    }
    ...
    private static int get_width(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, ((Rect) luaObject).get_width());
        return 1;
    }
    ...
    private static int get_x(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, ((Rect) luaObject).get_x());
        return 1;
    }
    ...
    private static int get_xMax(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, ((Rect) luaObject).get_xMax());
        return 1;
    }
    ...
    private static int get_xMin(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, ((Rect) luaObject).get_xMin());
        return 1;
    }
    ...
    private static int get_y(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, ((Rect) luaObject).get_y());
        return 1;
    }
    ...
    private static int get_yMax(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, ((Rect) luaObject).get_yMax());
        return 1;
    }
    ...
    private static int get_yMin(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, ((Rect) luaObject).get_yMin());
        return 1;
    }
    ...
    private static int MinMaxRect(IntPtr L)
    {
        ...
        float number = (float) LuaScriptMgr.GetNumber(L, 1);
        float num2 = (float) LuaScriptMgr.GetNumber(L, 2);
        float num3 = (float) LuaScriptMgr.GetNumber(L, 3);
        float num4 = (float) LuaScriptMgr.GetNumber(L, 4);
        Rect rect = Rect.MinMaxRect(number, num2, num3, num4);
    ...
    private static int NormalizedToPoint(IntPtr L)
    {
        ...
        Vector2 vector2 = Rect.NormalizedToPoint(rect, vector);
    ...
    private static int Overlaps(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            ...
            {
                Rect rect = (Rect) LuaScriptMgr.GetNetObjectSelf(L, 1, "Rect");
                Rect rect2 = (Rect) LuaScriptMgr.GetNetObject(L, 2, typeof(Rect));
                bool b = rect.Overlaps(rect2);
                LuaScriptMgr.Push(L, b);
                return 1;
            }
            case 3:
    ...
    private static int PointToNormalized(IntPtr L)
    {
        ...
        Rect rect = (Rect) LuaScriptMgr.GetNetObject(L, 1, typeof(Rect));
        Vector2 vector = LuaScriptMgr.GetVector2(L, 2);
        Vector2 vector2 = Rect.PointToNormalized(rect, vector);
        LuaScriptMgr.Push(L, vector2);
        return 1;
    }
    ...
    private static int Set(IntPtr L)
    {
        ...
        rect.Set(number, num2, num3, num4);
    ...
    private static int set_center(IntPtr L)
    {
        ...
        rect.set_center(LuaScriptMgr.GetVector2(L, 3));
        LuaScriptMgr.SetValueObject(L, 1, rect);
        return 0;
    }
    ...
    private static int set_height(IntPtr L)
    {
        ...
        Rect rect = (Rect) luaObject;
        rect.set_height((float) LuaScriptMgr.GetNumber(L, 3));
        LuaScriptMgr.SetValueObject(L, 1, rect);
        return 0;
    }
    ...
    private static int set_max(IntPtr L)
    {
        ...
        Rect rect = (Rect) luaObject;
        rect.set_max(LuaScriptMgr.GetVector2(L, 3));
        LuaScriptMgr.SetValueObject(L, 1, rect);
        return 0;
    }
    ...
    private static int set_min(IntPtr L)
    {
        ...
        Rect rect = (Rect) luaObject;
        rect.set_min(LuaScriptMgr.GetVector2(L, 3));
        LuaScriptMgr.SetValueObject(L, 1, rect);
        return 0;
    }
    ...
    private static int set_position(IntPtr L)
    {
        ...
        Rect rect = (Rect) luaObject;
        rect.set_position(LuaScriptMgr.GetVector2(L, 3));
        LuaScriptMgr.SetValueObject(L, 1, rect);
        return 0;
    }
    ...
    private static int set_size(IntPtr L)
    {
        ...
        Rect rect = (Rect) luaObject;
        rect.set_size(LuaScriptMgr.GetVector2(L, 3));
        LuaScriptMgr.SetValueObject(L, 1, rect);
        return 0;
    }
    ...
    private static int set_width(IntPtr L)
    {
        ...
        Rect rect = (Rect) luaObject;
        rect.set_width((float) LuaScriptMgr.GetNumber(L, 3));
        LuaScriptMgr.SetValueObject(L, 1, rect);
        return 0;
    }
    ...
    private static int set_x(IntPtr L)
    {
        ...
        Rect rect = (Rect) luaObject;
        rect.set_x((float) LuaScriptMgr.GetNumber(L, 3));
        LuaScriptMgr.SetValueObject(L, 1, rect);
        return 0;
    }
    ...
    private static int set_xMax(IntPtr L)
    {
        ...
        Rect rect = (Rect) luaObject;
        rect.set_xMax((float) LuaScriptMgr.GetNumber(L, 3));
        LuaScriptMgr.SetValueObject(L, 1, rect);
        return 0;
    }
    ...
    private static int set_xMin(IntPtr L)
    {
        ...
        Rect rect = (Rect) luaObject;
        rect.set_xMin((float) LuaScriptMgr.GetNumber(L, 3));
        LuaScriptMgr.SetValueObject(L, 1, rect);
        return 0;
    }
    ...
    private static int set_y(IntPtr L)
    {
        ...
        Rect rect = (Rect) luaObject;
        rect.set_y((float) LuaScriptMgr.GetNumber(L, 3));
        LuaScriptMgr.SetValueObject(L, 1, rect);
        return 0;
    }
    ...
    private static int set_yMax(IntPtr L)
    {
        ...
        Rect rect = (Rect) luaObject;
        rect.set_yMax((float) LuaScriptMgr.GetNumber(L, 3));
        LuaScriptMgr.SetValueObject(L, 1, rect);
        return 0;
    }
    ...
    private static int set_yMin(IntPtr L)
    {
        ...
        Rect rect = (Rect) luaObject;
        rect.set_yMin((float) LuaScriptMgr.GetNumber(L, 3));
        LuaScriptMgr.SetValueObject(L, 1, rect);
        return 0;
    }
