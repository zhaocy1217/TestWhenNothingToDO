...
[CheatCommand("英雄/属性修改/数值/SetHeroQyality", "设置品质", 0x19), ArgumentDescription(0, typeof(int), "ID", new object[] {  }), ArgumentDescription(1, typeof(int), "品质", new object[] {  }), ArgumentDescription(2, typeof(int), "品阶", new object[] {  })]
