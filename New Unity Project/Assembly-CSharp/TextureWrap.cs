...
public class TextureWrap
{
    ...
    private static int get_anisoLevel(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, luaObject.get_anisoLevel());
        return 1;
    }
    ...
    {
        LuaScriptMgr.Push(L, (Enum) Texture.get_anisotropicFiltering());
        return 1;
    }
    ...
    private static int get_filterMode(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Enum) luaObject.get_filterMode());
        return 1;
    }
    ...
    {
        LuaScriptMgr.Push(L, Texture.get_masterTextureLimit());
        return 1;
    }
    ...
    private static int get_mipMapBias(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, luaObject.get_mipMapBias());
        return 1;
    }
    ...
    private static int get_texelSize(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, luaObject.get_texelSize());
        return 1;
    }
    ...
    private static int set_anisoLevel(IntPtr L)
    {
        ...
        luaObject.set_anisoLevel((int) LuaScriptMgr.GetNumber(L, 3));
        return 0;
    }
    ...
    {
        Texture.set_anisotropicFiltering((AnisotropicFiltering) ((int) LuaScriptMgr.GetNetObject(L, 3, typeof(AnisotropicFiltering))));
        return 0;
    }
    ...
    private static int set_filterMode(IntPtr L)
    {
        ...
        luaObject.set_filterMode((FilterMode) ((int) LuaScriptMgr.GetNetObject(L, 3, typeof(FilterMode))));
        return 0;
    }
    ...
    {
        Texture.set_masterTextureLimit((int) LuaScriptMgr.GetNumber(L, 3));
        return 0;
    }
    ...
    private static int set_mipMapBias(IntPtr L)
    {
        ...
        luaObject.set_mipMapBias((float) LuaScriptMgr.GetNumber(L, 3));
        return 0;
    }
    ...
    private static int set_wrapMode(IntPtr L)
    {
        ...
        luaObject.set_wrapMode((TextureWrapMode) ((int) LuaScriptMgr.GetNetObject(L, 3, typeof(TextureWrapMode))));
        return 0;
    }
    ...
    private static int SetGlobalAnisotropicFilteringLimits(IntPtr L)
    {
        ...
        Texture.SetGlobalAnisotropicFilteringLimits(number, num2);
        return 0;
    }
}
