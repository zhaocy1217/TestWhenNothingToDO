...
{
    private static Type classType = typeof(ThirdSDK);
    ...
    [MonoPInvokeCallback(typeof(LuaCSFunction))]
    private static int buyCallBack(IntPtr L)
    {
        ...
        int j = (int) LuaScriptMgr.GetNumber(L, 4);
        string str2 = LuaScriptMgr.GetLuaString(L, 5);
        dsdk.buyCallBack(luaString, number, j, str2);
        return 0;
    }
