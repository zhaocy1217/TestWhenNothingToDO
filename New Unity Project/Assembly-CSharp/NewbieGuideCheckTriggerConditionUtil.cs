    ...
    public static bool CheckTriggerCondition(uint id, NewbieGuideTriggerConditionItem condition)
    {
        ...
        switch (condition.wType)
        {
            ...
            case 40:
            {
                ...
                info2.m_symbolInfo.CheckAnyWearSymbol(out AvailableSymbolPos, out AvailableSymbolId, 2);
                return (AvailableSymbolPos == condition.Param[0]);
            }
            case 0x29:
            ...
            case 0x2b:
            {
                uint num9 = condition.Param[0];
                CRoleInfo info8 = Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo();
                if (info8 == null)
                {
                    return false;
                }
                return (info8.SymbolCoin >= num9);
            }
            case 0x2c:
            ...
            case 0x34:
            {
                CRoleInfo info11 = Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo();
                if (((info11 == null) || !info11.IsOldPlayer()) || info11.IsOldPlayerGuided())
                {
                    return false;
                }
                return true;
            ...
            case 0x36:
            {
                ...
                if (info12 != null)
                {
                    flag12 = info12.IsGuidedStateSet(0x62);
                }
                return flag12;
            }
            case 0x37:
            ...
            case 0x39:
            {
                ...
                if ((context2 == null) || (context2.m_mapID != condition.Param[0]))
                {
                    return false;
                }
                return true;
