...
[ArgumentDescription(0, typeof(AcntInfoUpdateType), "属性类别", new object[] {  }), ArgumentDescription(1, typeof(int), "数值", new object[] {  }), CheatCommand("英雄/属性/UpAcntInfo", "改变玩家属性", 15)]
