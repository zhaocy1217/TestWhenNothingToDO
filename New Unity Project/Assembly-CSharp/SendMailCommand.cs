...
[ArgumentDescription(0, typeof(GMMailAccessType), "属性类别", new object[] {  }), ArgumentDescription(1, typeof(int), "数值", new object[] {  }), ArgumentDescription(2, typeof(string), "好友名称", new object[] { 0, "心" }), CheatCommand("通用/邮件/SendMail", "送心送钱邮件", 13)]
