...
[CheatCommand("通用/邮件/SendAttachmentMail", "道具邮件附件数量 个数：一个，二个，三个，四个", 13), ArgumentDescription(0, typeof(GMMailAccessCount), "个数", new object[] {  }), ArgumentDescription(1, typeof(int), "Type1", new object[] {  }), ArgumentDescription(2, typeof(int), "ID1", new object[] {  }), ArgumentDescription(3, typeof(int), "Num1", new object[] {  }), ArgumentDescription(4, typeof(int), "Type2", new object[] { 0, "二个|三个|四个" }), ArgumentDescription(5, typeof(int), "ID2", new object[] { 0, "二个|三个|四个" }), ArgumentDescription(12, typeof(int), "Num4", new object[] { 0, "四个" }), ArgumentDescription(6, typeof(int), "Num2", new object[] { 0, "二个|三个|四个" }), ArgumentDescription(11, typeof(int), "ID4", new object[] { 0, "四个" }), ArgumentDescription(7, typeof(int), "Type3", new object[] { 0, "三个|四个" }), ArgumentDescription(10, typeof(int), "Type4", new object[] { 0, "四个" }), ArgumentDescription(8, typeof(int), "ID3", new object[] { 0, "三个|四个" }), ArgumentDescription(9, typeof(int), "Num3", new object[] { 0, "三个|四个" })]
