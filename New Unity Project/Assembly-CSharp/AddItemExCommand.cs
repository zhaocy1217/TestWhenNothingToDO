...
[ArgumentDescription(1, typeof(int), "ID", new object[] {  }), CheatCommand("英雄/属性/AddItemEx", "添加物品旧版", 7), ArgumentDescription(0, typeof(int), "物品类型", new object[] {  }), ArgumentDescription(2, typeof(int), "数量", new object[] {  })]
