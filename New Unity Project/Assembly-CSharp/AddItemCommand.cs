...
[ArgumentDescription(2, typeof(int), "数量", new object[] {  }), ArgumentDescription(0, typeof(EPropTypeType), "物品类型", new object[] {  }), CheatCommand("英雄/属性/AddItem", "添加物品", 7), ArgumentDescription(1, typeof(int), "ID", new object[] {  })]
