    ...
    public class Reconnection : MonoSingleton<Reconnection>, IGameModule
    {
        ...
        private void onReconnectGame(CSPkg msg)
        {
            switch (msg.stPkgData.stReconnGameNtf.bState)
            {
                ...
                case 5:
                    this.g_fBeginReconnectTime = Time.get_time();
        ...
        {
            <ProcessRelaySyncCache>c__IteratorC rc = new <ProcessRelaySyncCache>c__IteratorC();
            rc.<>f__this = this;
            return rc;
        }
        ...
        public void UpdateFrame()
        {
            ...
            if (this.ms_bWaitingRelaySync)
            {
                this.ms_fWaitVideoTimeout -= Time.get_unscaledDeltaTime();
        ...
        [CompilerGenerated]
        private sealed class <ProcessRelaySyncCache>c__IteratorC : IDisposable, IEnumerator, IEnumerator<object>
        {
