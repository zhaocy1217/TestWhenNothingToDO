namespace Assets.Scripts.Framework
{
    ...
    public class GameSettings
    {
        ...
        private static bool m_heroInfoEnable = true;
        private static CMallSortHelper.HeroViewSortType m_heroSelectHeroViewSortType = CMallSortHelper.HeroViewSortType.Name;
        ...
        public static void Init()
        {
            ...
            EnableHeroInfo = PlayerPrefs.GetInt("GameSettings_HeroInfoShowEnable", 1) == 1;
            HeroSelectHeroViewSortType = (CMallSortHelper.HeroViewSortType) PlayerPrefs.GetInt("GameSettingSelectHeroSortType", 1);
            ...
            TheLastHitMode = (LastHitMode) PlayerPrefs.GetInt("GameSetting_LastHitMode", 0);
            ...
            LunPanLockEnemyHeroMode = PlayerPrefs.GetInt("GameSettingEnableLunPanLockEnemyHeroMode", 0) == 1;
            ShowEnemyHeroHeadBtnMode = PlayerPrefs.GetInt("GameSettingEnableShowEnemyHeroHeadBtnMode", 0) == 1;
        }
        ...
        private static void InitResolution()
        {
            if ((DefaultScreenWidth == 0) || (DefaultScreenHeight == 0))
            {
                ...
                DefaultScreenWidth = Mathf.Max(num, num2);
                DefaultScreenHeight = Mathf.Min(num, num2);
            }
        }
        ...
        public static void RefreshResolution()
        {
            ...
            {
                _EnableHDMode = PlayerPrefs.GetInt("GameSettingEnableHDMode_New2", 0) > 0;
            }
            else if (SupportHDMode())
            {
                _EnableHDMode = false;
            }
            else
        ...
        public static void Save()
        {
            ...
            PlayerPrefs.SetInt("GameSettings_HeroInfoShowEnable", !EnableHeroInfo ? 0 : 1);
            PlayerPrefs.SetInt("GameSettingSelectHeroSortType", (int) HeroSelectHeroViewSortType);
            ...
            PlayerPrefs.SetInt("GameSetting_LastHitMode", (int) TheLastHitMode);
            ...
            PlayerPrefs.SetInt("GameSettingEnableHDMode_New2", !_EnableHDMode ? 0 : 1);
            PlayerPrefs.SetInt("GameSettingEnableLunPanLockEnemyHeroMode", !LunPanLockEnemyHeroMode ? 0 : 1);
            PlayerPrefs.SetInt("GameSettingEnableShowEnemyHeroHeadBtnMode", !ShowEnemyHeroHeadBtnMode ? 0 : 1);
            PlayerPrefs.Save();
        }
        ...
        private static void SendPlayerLastHitMode()
        {
            if (!Singleton<WatchController>.GetInstance().IsWatching)
            {
                ...
                command.cmdData.LastHitMode = (byte) _lastHitMode;
                command.Send();
            }
        }
        ...
        public static void SetHDMode(bool enable)
        {
            ...
            if ((defaultScreenWidth != Screen.get_width()) || (defaultScreenHeight != Screen.get_height()))
            {
                Screen.SetResolution(defaultScreenWidth, defaultScreenHeight, true);
                Sprite3D.SetRatio(defaultScreenWidth, defaultScreenHeight);
            }
        }
        ...
        {
            int num = (Screen.get_width() <= Screen.get_height()) ? Screen.get_height() : Screen.get_width();
            int num2 = (Screen.get_width() <= Screen.get_height()) ? Screen.get_width() : Screen.get_height();
        ...
        public static int CameraHeight
        {
            ...
            set
            {
                ...
                {
                    theMinimapSys.MMiniMapCameraFrame_3Dui.SetFrameSize(cameraHeight);
                }
            }
        }
        ...
        public static bool EnableHeroInfo
        {
            get
            {
                return m_heroInfoEnable;
            }
            set
            {
                if (m_heroInfoEnable != value)
                {
                    m_heroInfoEnable = value;
        ...
        public static CMallSortHelper.HeroViewSortType HeroSelectHeroViewSortType
        {
            get
            {
                return m_heroSelectHeroViewSortType;
            }
            set
            {
                m_heroSelectHeroViewSortType = value;
            }
        }
        ...
        public static bool LunPanLockEnemyHeroMode
        {
            get
            {
                return _EnableLockEnemyHeroMode;
            }
            set
            {
                _EnableLockEnemyHeroMode = value;
            }
        }
        ...
        public static bool ShowEnemyHeroHeadBtnMode
        {
            get
            {
                return _EnableShowEnemyHeroMode;
            }
            set
            {
                _EnableShowEnemyHeroMode = value;
            }
        }
