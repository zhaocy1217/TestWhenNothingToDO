namespace Assets.Scripts.Framework
{
    ...
    public class CreateRoleState : BaseState
    {
        ...
        {
            Debug.Log("OnMoviePlayComplete  " + Time.get_realtimeSinceStartup());
        ...
        private void PlayWorldStartMovie()
        {
            ...
            try
            {
                Debug.Log("worldstart exist and play " + Time.get_realtimeSinceStartup());
                flag2 = true;
                Handheld.PlayFullScreenMovie("Video/worldstart.mp4", Color.get_black(), 2, 1);
            }
            catch (Exception)
            {
            ...
            if (flag)
            {
                Debug.Log("bAddFormVisibleTimer  " + Time.get_realtimeSinceStartup());
