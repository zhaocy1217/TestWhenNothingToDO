namespace Assets.Scripts.Framework
{
    ...
    public class GameDataMgr : Singleton<GameDataMgr>, IGameModule
    {
        ...
        public static void GetAllSkinList(ref ListView<ResHeroSkin> list, out int validCount, enHeroJobType job = 0, bool includeDefaultSkin = false, bool onlyAvailableAtShop = false, bool onlyCanBeGift = false)
        {
            ...
            while (enumerator.MoveNext())
            {
                ...
                if (item != null)
                {
                    ...
                    if ((((dataByKey != null) && (includeDefaultSkin || (item.dwSkinID != 0))) && ((((job == enHeroJobType.All) || (((byte) job) == dataByKey.bMainJob)) || (((byte) job) == dataByKey.bMinorJob)) && (!onlyAvailableAtShop || IsSkinAvailableAtShop(item.dwID)))) && (!onlyCanBeGift || (IsSkinCanBuyForFriend(item.dwID) && IsSkinCanBuyNow(item.dwID))))
                    {
                        if (validCount < count)
                        {
                            list[validCount] = item;
            ...
            while (srcBuf.readUInt8(ref dest) == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                switch (cs_res_data_type)
                {
                    ...
                    case CS_RES_DATA_TYPE.CS_RES_DATA_RANDOM_REWARD:
                    {
                        ...
                        randomRewardDB.isAllowUnLoad = false;
                        continue;
                    }
                    ...
                    case CS_RES_DATA_TYPE.CS_RES_DATA_PROP:
                    {
                        ...
                        itemDatabin.isAllowUnLoad = false;
                        continue;
                    }
                    ...
                    {
                        ResRareExchange exchange3 = new ResRareExchange();
                        if (exchange3.unpack(ref srcBuf, 0) != TdrError.ErrorType.TDR_NO_ERROR)
                        {
                            return;
                        }
                        if (!rareExchangeDict.ContainsKey(exchange3.dwID))
                        {
                            rareExchangeDict.Add(exchange3.dwID, exchange3);
                        }
                        continue;
                    }
                    case CS_RES_DATA_TYPE.CS_RES_DATA_WEAL_PARAM:
                    {
                        ...
                        if (param.unpack(ref srcBuf, 0) != TdrError.ErrorType.TDR_NO_ERROR)
                        {
                            return;
                        }
                        if (!resWealParamDict.ContainsKey(param.dwID))
                        {
                            resWealParamDict.Add(param.dwID, param);
                        }
                        continue;
                    }
                    default:
        ...
        {
            skillDatabin.Reload();
            monsterDatabin.Reload();
            organDatabin.Reload();
            skillCombineDatabin.Reload();
            soldierWaveDatabin.Reload();
            levelDatabin.Reload();
            pvpLevelDatabin.Reload();
            battleDynamicPropertyDB.Reload();
            clashAdditionDB.Reload();
            actorLinesDatabin.Reload();
            acntExpDatabin.Reload();
            globalInfoDatabin.Reload();
            randomSkillPassiveDatabin.Reload();
            skillPassiveDatabin.Reload();
            skillMarkDatabin.Reload();
            battleParam.Reload();
            propertyValInfo.Reload();
            signalDatabin.Reload();
            m_equipInBattleDatabin.Reload();
            soulLvlUpDatabin.Reload();
            soulAdditionDatabin.Reload();
            voiceInteractionDatabin.Reload();
            incomeAllocDatabin.Reload();
            specialFunUnlockDatabin.Reload();
            unlockConditionDatabin.Reload();
            symbolInfoDatabin.Reload();
            evaluateCondInfoDatabin.Reload();
            floatTextDatabin.Reload();
            famousMentorDatabin.Reload();
            deadInfoConditionDatabin.Reload();
            deadInfoTextDatabin.Reload();
            inBattleMsgDatabin.Reload();
            inBattleChannelDatabin.Reload();
        }
        ...
        {
            guideTipDatabin.Reload();
            newbieSpecialTipDatabin.Reload();
            newbieWeakMainLineDataBin.Reload();
            newbieWeakDatabin.Reload();
        }
        ...
        public void UnloadAllDataBin()
        {
            ...
            pvpLevelDatabin.Unload();
            cpLevelDatabin.Unload();
            rankLevelDatabin.Unload();
            entertainLevelDatabin.Unload();
            uinionBattleLevelDatabin.Unload();
            guildMatchLevelDatabin.Unload();
            guildLevelDatabin.Unload();
            settleDatabin.Unload();
            heroEnergyDatabin.Unload();
            skillBeanDatabin.Unload();
            skillDatabin.Unload();
            monsterDatabin.Unload();
            organDatabin.Unload();
            skillCombineDatabin.Unload();
            skillFuncDatabin.Unload();
            soldierWaveDatabin.Unload();
            heroLvlUpDatabin.Unload();
            towerHitDatabin.Unload();
            battleDynamicPropertyDB.Unload();
            battleDynamicDifficultyDB.Unload();
            actorLinesDatabin.Unload();
            acntExpDatabin.Unload();
            globalInfoDatabin.Unload();
            chapterInfoDatabin.Unload();
            taskDatabin.Unload();
            ...
            newbieBannerGuideDatabin.Unload();
            soulLvlUpDatabin.Unload();
            incomeAllocDatabin.Unload();
            ...
            symbolInfoDatabin.Unload();
            symbolPosDatabin.Unload();
            heroSymbolLvlDatabin.Unload();
            ...
            talentHero.Unload();
            miShuLib.Unload();
            acntPvpExpDatabin.Unload();
            burnRewrad.Unload();
            burnBuffMap.Unload();
            battleParam.Unload();
            propertyValInfo.Unload();
            ...
            robotSubNameC.Unload();
            arenaRewardDatabin.Unload();
            cdDatabin.Unload();
            signalDatabin.Unload();
            inBattleMsgDatabin.Unload();
            inBattleChannelDatabin.Unload();
            inBattleHeroActDatabin.Unload();
            inBattleDefaultDatabin.Unload();
            iosDianQuanBuyInfo.Unload();
            androidDianQuanBuyInfo.Unload();
            clashAdditionDB.Unload();
            achieveDatabin.Unload();
            addedSkiilDatabin.Unload();
            callMonsterDatabin.Unload();
            trophyDatabin.Unload();
            resVipDianQuan.Unload();
            heroAwakDatabin.Unload();
            resNobeInfoDatabin.Unload();
            m_selectHeroChatDatabin.Unload();
            m_equipInBattleDatabin.Unload();
            m_recommendEquipInBattleDatabin.Unload();
            m_recommendEquipJudge.Unload();
            ...
            banHeroBin.Unload();
            commonRewardDatabin.Unload();
            unionRankRewardDetailDatabin.Unload();
            unionBattleWinCntRewardDatabin.Unload();
            speakerDatabin.Unload();
            creditLevelDatabin.Unload();
            resHonor.Unload();
            floatTextDatabin.Unload();
            recruimentReward.Unload();
            killNotifyDatabin.Unload();
            continuKillDatabin.Unload();
            multiKillDatabin.Unload();
            voiceInteractionDatabin.Unload();
            aiParamConfDataBin.Unload();
            famousMentorDatabin.Unload();
            deadInfoTextDatabin.Unload();
            deadInfoConditionDatabin.Unload();
        }
