namespace Assets.Scripts.Framework
{
    ...
    public class GameTask
    {
        ...
        static GameTask()
        {
            ...
            {
                <>f__am$cache8 = new CompareOperatorFunc(GameTask.<_compareFuncs>m__6);
            }
            funcArray1[0] = <>f__am$cache8;
            if (<>f__am$cache9 == null)
            {
                <>f__am$cache9 = new CompareOperatorFunc(GameTask.<_compareFuncs>m__7);
            }
            funcArray1[1] = <>f__am$cache9;
            if (<>f__am$cacheA == null)
            {
                <>f__am$cacheA = new CompareOperatorFunc(GameTask.<_compareFuncs>m__8);
            }
            funcArray1[2] = <>f__am$cacheA;
            if (<>f__am$cacheB == null)
            {
                <>f__am$cacheB = new CompareOperatorFunc(GameTask.<_compareFuncs>m__9);
            }
            funcArray1[3] = <>f__am$cacheB;
            if (<>f__am$cacheC == null)
            {
                <>f__am$cacheC = new CompareOperatorFunc(GameTask.<_compareFuncs>m__A);
            }
        ...
        [CompilerGenerated]
        private static bool <_compareFuncs>m__9(int l, int r)
        {
            return (l > r);
        }

        [CompilerGenerated]
        private static bool <_compareFuncs>m__A(int l, int r)
        {
            return (l >= r);
        }
