namespace Assets.Scripts.Framework
{
    ...
    public class DetectRenderQuality
    {
        ...
        {
            SGameRenderQuality q = checkGPU_Android(SystemInfo.get_graphicsDeviceName());
        ...
        {
            switch (SystemInfo.get_deviceModel().ToLower())
            {
        ...
        private static SGameRenderQuality checkGPU_Android(string gpuName)
        {
            ...
            if (SystemInfo.get_systemMemorySize() < 0x5dc)
            {
                return SGameRenderQuality.Low;
            }
