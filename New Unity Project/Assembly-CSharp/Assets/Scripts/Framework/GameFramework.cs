namespace Assets.Scripts.Framework
{
    ...
    public class GameFramework : MonoSingleton<GameFramework>
    {
        ...
        {
            <PrepareBaseSystem>c__Iterator0 iterator = new <PrepareBaseSystem>c__Iterator0();
            iterator.delegateOnBaseSystemPrepareComplete = delegateOnBaseSystemPrepareComplete;
            iterator.<$>delegateOnBaseSystemPrepareComplete = delegateOnBaseSystemPrepareComplete;
        ...
        {
            <PrepareGameSystem>c__Iterator1 iterator = new <PrepareGameSystem>c__Iterator1();
            iterator.<>f__this = this;
            return iterator;
        }
        ...
        public void setTargetFrameRate()
        {
            ...
            {
                Application.set_targetFrameRate(unityTargetFrameRate);
                base.StartCoroutine("SGame_WaitForTargetFrameRate");
            }
            else
            {
                base.StopCoroutine("SGame_WaitForTargetFrameRate");
                Application.set_targetFrameRate(c_renderFPS);
            }
        }
        ...
        {
            <SGame_WaitForTargetFrameRate>c__Iterator2 iterator = new <SGame_WaitForTargetFrameRate>c__Iterator2();
            iterator.<>f__this = this;
            return iterator;
        }
        ...
        public virtual void Start()
        {
            ...
            try
            {
                object[] inParameters = new object[] { CVersion.GetAppVersion(), CVersion.GetRevisonNumber(), Application.get_unityVersion() };
            ...
            Screen.set_autorotateToPortrait(false);
            Screen.set_autorotateToPortraitUpsideDown(false);
            ...
            if (class2 != null)
            {
                ...
                class2.CallStatic("EnableInput", objArray2);
                class2.Dispose();
            }
        ...
        private void UpdateElse()
        {
            try
            {
                ...
                if (!this.lockFPS_SGame)
                {
                    float num = Time.get_realtimeSinceStartup() - this.lastUpdateTime;
                    this.accumTime += num;
                    this.accum += 1f / num;
        ...
        private sealed class <SGame_WaitForTargetFrameRate>c__Iterator2 : IDisposable, IEnumerator, IEnumerator<object>
        {
            ...
            public bool MoveNext()
            {
                ...
                switch (num)
                {
                    ...
                    case 1:
                        this.<t>__0 = Time.get_realtimeSinceStartup();
                        ...
                        this.<>f__this.lastRealTime = Time.get_realtimeSinceStartup();
                        this.<fdelta>__4 = Time.get_realtimeSinceStartup() - this.<>f__this.lastUpdateTime;
                        this.<>f__this.accumTime += this.<fdelta>__4;
                        this.<>f__this.accum += 1f / this.<fdelta>__4;
                        this.<>f__this.lastUpdateTime = Time.get_realtimeSinceStartup();
                        this.<>f__this.frames++;
