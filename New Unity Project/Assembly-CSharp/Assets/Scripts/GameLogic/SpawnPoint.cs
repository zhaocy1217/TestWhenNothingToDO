namespace Assets.Scripts.GameLogic
{
    ...
    public class SpawnPoint : FuncRegion
    {
        ...
        {
            DoSpawn(base.get_gameObject(), (VInt3) base.get_gameObject().get_transform().get_position(), (VInt3) base.get_gameObject().get_transform().get_forward(), this.bSequentialMeta, this.TheActorsMeta, this.m_rangePolygon, this.m_rangeDeadPoint, pursuitInfo, this.InitBuffDemand, this.InitRandPassSkillRule, ref this.m_spawnedList);
                    ...
                    if ((current.ConfigId > 0) && (current.ActorType != ActorTypeDef.Invalid))
                    {
                        ...
                        if (actor != 0)
                        {
                            ...
                            if ((pursuitInfo != null) && pursuitInfo.IsVaild())
                            {
                                ...
                                {
                                    actorControl.Pursuit = pursuitInfo;
                                }
                            }
        ...
        {
            Gizmos.set_color(this.PointColor);
            Gizmos.DrawSphere(base.get_transform().get_position(), 0.15f);
        }
