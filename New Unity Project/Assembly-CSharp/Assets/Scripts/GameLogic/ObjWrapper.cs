namespace Assets.Scripts.GameLogic
{
    ...
    public class ObjWrapper : LogicComponent
    {
        ...
        public PoolObjHandle<ActorRoot> m_TargetNeedToBeActtacked = new PoolObjHandle<ActorRoot>();
        [HideInInspector]
        ...
        public ObjWrapper()
        {
            ...
            context.ReviveLife = 0x2710;
            context.ReviveEnergy = 0x2710;
            context.bBaseRevive = true;
        ...
        public void AttackAlongRoute(WaypointsHolder InRoute)
        {
            if (!this.IsDeadState && (InRoute != null))
            {
                ...
                {
                    this.m_curWaypointTargetPosition = new VInt3(this.m_curWaypointTarget.get_transform().get_position());
                }
        ...
        public void BTExMoveCmd()
        {
            if (this.curMoveCommand != null)
            {
                ...
                else if (this.curMoveCommand.cmdType == 0x83)
                {
        ...
        {
            bool noAbilityFlag = base.actor.ActorControl.GetNoAbilityFlag(ObjAbilityType.ObjAbility_DeadControl);
            if (!this.IsDeadState || noAbilityFlag)
            {
                if (noAbilityFlag)
                {
                    base.actor.ActorControl.SetDeadMode(ObjDeadMode.DeadState_Move);
                    this.curMoveCommand = cmd;
        ...
        public void CmdUseSkill(IFrameCommand cmd, ref SkillUseParam param)
        {
            SkillSlot slot = null;
            int num = 0;
            if (((!this.IsDeadState || base.actor.TheStaticData.TheBaseAttribute.DeadControl) && !base.actor.SkillControl.IsDisableSkillSlot(param.SlotType)) && base.actor.SkillControl.TryGetSkillSlot(param.SlotType, out slot))
            {
                ...
                if ((skill == null) || (skill.AppointType == param.AppointType))
                {
                    ...
                    if (slot.IsSkillBeanEnough && (((param.SlotType != SkillSlotType.SLOT_SKILL_9) && (param.SlotType != SkillSlotType.SLOT_SKILL_10)) || (((base.actor.EquipComponent == null) || (skill == null)) || base.actor.EquipComponent.CheckEquipActiveSKillCanUse(param.SlotType, skill.SkillID))))
                    {
                        ...
                        {
                            if (!base.actor.SkillControl.AbortCurUseSkill((SkillAbortType) param.SlotType))
                            {
                                if (base.actor.TheActorMeta.ActorType == ActorTypeDef.Actor_Type_Hero)
                                {
        ...
        public void CommanderNotifyToAttack(uint targetId, int srchR, bool ignoreSrchRange)
        {
            ...
            if (actor != 0)
            {
                COM_PLAYERCAMP actorCamp = base.actor.TheActorMeta.ActorCamp;
        ...
        public VInt3 GetRouteCurWaypointPos()
        {
            ...
            if (nextPoint != null)
            {
                Vector3 vector2 = this.m_curWaypointTarget.get_transform().get_position();
                Vector3 vector3 = nextPoint.get_transform().get_position();
                ...
                vector6.y = 0f;
                if (((vector4.get_sqrMagnitude() < vector5.get_sqrMagnitude()) || (vector4.get_sqrMagnitude() < vector6.get_sqrMagnitude())) || (vector6.get_sqrMagnitude() < 1f))
                {
        ...
        public VInt3 GetRouteCurWaypointPosPre()
        {
            ...
            {
                Vector3 vector2 = this.m_curWaypointTarget.get_transform().get_position();
                Vector3 vector3 = prePoint.get_transform().get_position();
                Vector3 vector4 = vector - vector3;
                vector4.y = 0f;
                Vector3 vector5 = vector2 - vector3;
                vector5.y = 0f;
        ...
        {
            return base.actor.SkillControl.GetSkillSlot(slot);
        }
        ...
        {
            if (((!this.IsDeadState || base.actor.TheStaticData.TheBaseAttribute.DeadControl) && ((base.actor.SkillControl.IsEnableSkillSlot(param.SlotType) && !base.actor.SkillControl.IsDisableSkillSlot(param.SlotType)) && base.actor.SkillControl.IsSkillUseValid(param.SlotType, ref param))) && base.actor.SkillControl.UseSkill(ref param, true))
            {
            }
        }
        ...
        public bool IsPlayingAnimation()
        {
            ...
            {
                return base.actor.ActorMeshAnimation.get_isPlaying();
            }
            Animation component = base.actor.ActorMesh.GetComponent<Animation>();
            return ((component != null) && component.get_isPlaying());
        }
        ...
        public bool IsTargetObjInSearchDistance()
        {
            ...
            maxSearchDistance += this.myTarget.handle.shape.AvgCollisionRadius;
        ...
        protected virtual void OnDead()
        {
            ...
            SkillComponent skillControl = base.actor.SkillControl;
            skillControl.OnDead();
            if (!this.m_reviveContext.bEnable)
            {
            ...
            {
                lastHeroAtker = actorControl.LastHeroAtker;
            }
            GameDeadEventParam prm = new GameDeadEventParam(base.actorPtr, this.myLastAtker, handle, lastHeroAtker, this.m_reviveContext.bEnable, null);
        ...
        protected virtual void OnRevive()
        {
            ...
            if (base.actor.TheStaticData.TheBaseAttribute.DeadControl && this.GetNoAbilityFlag(ObjAbilityType.ObjAbility_DeadControl))
            {
        ...
        public void PlayAnimation(string animationName, float blendTime, int layer, bool loop)
        {
            if (base.actor.ActorMesh != null)
            {
                ...
                if (animControl != null)
                {
                    ...
                    param.layer = layer;
                    param.speed = 1f;
                    param.forceOutOfStack = ((base.actor.TheActorMeta.ActorType == ActorTypeDef.Actor_Type_Hero) && ((this.myBehavior == ObjBehaviMode.State_AutoAI) || (this.myBehavior == ObjBehaviMode.State_OutOfControl))) || (base.actor.TheActorMeta.ActorType == ActorTypeDef.Actor_Type_Monster);
                ...
                else
                {
                    ...
                    if (component != null)
                    {
                        ...
                        AnimationState state = component.get_Item(animationName);
                        if (state != null)
                        {
                            state.set_wrapMode(!loop ? ((WrapMode) 1) : ((WrapMode) 2));
                        }
                    }
                }
            }
        ...
        public void SetAutoAI(bool autoAI)
        {
            if (this.m_isAutoAI != autoAI)
            {
                ...
                if (this.m_isAutoAI && (base.actor.SkillControl.SkillUseCache != null))
                {
        ...
        public void SetInAttack(PoolObjHandle<ActorRoot> inAttackee, bool bExposeAttacker)
        {
            ...
            if (FogOfWar.enable)
            {
                if (inAttackee != 0)
                {
                    base.actor.HorizonMarker.ExposeAndShowAsAttacker(inAttackee.handle.TheActorMeta.ActorCamp, bExposeAttacker);
                }
            }
        ...
        public void SetLockTargetID(uint _targetID)
        {
            if (base.actor.LockTargetAttackModeControl != null)
            {
                base.actor.LockTargetAttackModeControl.SetLockTargetID(_targetID, false);
            }
        }
        ...
        public bool SetSkill(SkillSlotType InSlot, bool bSpecial)
        {
            ...
            if (!bSpecial)
            {
                ...
                {
                    this.curSkillUseInfo = new SkillUseParam();
                    this.curSkillUseInfo.Init(InSlot, this.myTarget.handle.location - base.actor.location, false, this.myTarget.handle.ObjID);
                }
                else
                {
                    this.curSkillUseInfo = new SkillUseParam();
            ...
            {
                this.curSkillUseInfo = new SkillUseParam();
                this.curSkillUseInfo.Init(InSlot, base.actor.forward, true, 0);
            }
            return true;
        }
        ...
        {
            if (this.IsNeedSwitchTarget && (this.m_TargetNeedToBeActtacked != 0))
            {
        ...
        public virtual int TakeDamage(ref HurtDataInfo hurt)
        {
            if (((hurt.atker != 0) && (hurt.target != 0)) && ((hurt.atker.handle.TheActorMeta.ActorCamp != hurt.target.handle.TheActorMeta.ActorCamp) && (hurt.hurtType != HurtTypeDef.Therapic)))
            {
                ...
                if ((orignalActor != 0) && (orignalActor.handle.TheActorMeta.ActorType == ActorTypeDef.Actor_Type_Hero))
                {
            ...
            if (((((hurt.atker != 0) && (hurt.atker.handle.TheActorMeta.ActorType == ActorTypeDef.Actor_Type_Organ)) && (hurt.hurtType != HurtTypeDef.Therapic)) && (((base.actor.ValueComponent.actorHp * 100) < (base.actor.ValueComponent.actorHpTotal * 0x5f)) || ((this.myLastAtker != 0) && !this.myLastAtker.handle.AttackOrderReady))) && (base.actor.ActorAgent != null))
            {
        ...
        public void UseGoHomeSkill()
        {
            if (!this.IsDeadState && (!base.actor.SkillControl.IsDisableSkillSlot(SkillSlotType.SLOT_SKILL_6) && base.actor.SkillControl.CanUseSkill(SkillSlotType.SLOT_SKILL_6)))
            {
                ...
                if (((skill != null) && (skill.cfgData != null)) && (skill.cfgData.bSkillType == 1))
                {
                    ...
                    if (((curUseSkill == null) || (curUseSkill.SlotType != SkillSlotType.SLOT_SKILL_6)) && base.actor.SkillControl.AbortCurUseSkill(SkillAbortType.TYPE_SKILL_6))
                    {
        ...
        public void UseHpRecoverSkillToSelf()
        {
            if (!this.IsDeadState)
            {
                ...
                if (!base.actor.SkillControl.IsDisableSkillSlot(SkillSlotType.SLOT_SKILL_6) && base.actor.SkillControl.CanUseSkill(SkillSlotType.SLOT_SKILL_6))
                {
                    ...
                    if ((((skill2 != null) && (skill2.cfgData != null)) && (skill2.cfgData.bSkillType == 3)) && base.actor.SkillControl.AbortCurUseSkill(SkillAbortType.TYPE_SKILL_6))
                    {
