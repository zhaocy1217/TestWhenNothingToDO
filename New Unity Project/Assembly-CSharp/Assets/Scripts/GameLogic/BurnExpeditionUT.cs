namespace Assets.Scripts.GameLogic
{
    ...
    public class BurnExpeditionUT
    {
        ...
        {
            CSDT_SINGLE_GAME_OF_BURNING csdt_single_game_of_burning = new CSDT_SINGLE_GAME_OF_BURNING();
            csdt_single_game_of_burning.bLevelNo = Singleton<BurnExpeditionController>.GetInstance().model.Get_LevelNo(levelIndex);
            csdt_single_game_of_burning.iLevelID = Singleton<BurnExpeditionController>.GetInstance().model.Get_LevelID(levelIndex);
            return csdt_single_game_of_burning;
        }
