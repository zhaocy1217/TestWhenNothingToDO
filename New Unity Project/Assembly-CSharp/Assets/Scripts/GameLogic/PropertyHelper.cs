namespace Assets.Scripts.GameLogic
{
    ...
    public class PropertyHelper
    {
        ...
        private Assets.Scripts.GameLogic.EnergyType _energyType = Assets.Scripts.GameLogic.EnergyType.NoneResource;
        ...
        private ValueDataInfo[] mActorValue = new ValueDataInfo[0x25];
        ...
        public int DynamicAdjustorForMgcEffect(ValueDataInfo vd, ValueDataType type)
        {
            if (type == ValueDataType.TYPE_TOTAL)
            {
                return (this.GenericCalculator(vd, DynamicProperty.Adjustor(vd)) + vd.totalEftValueByMgc);
            }
            return this.GenericBaseCalculator(vd, DynamicProperty.Adjustor(vd));
        }
        ...
        public void Init(COMDT_HEROINFO svrInfo)
        {
            ...
            meta2.ConfigId = (int) svrInfo.stCommonInfo.dwHeroID;
        ...
        public void InitValueDataArr(ref ActorMeta theActorMeta, bool bLobby)
        {
            ...
            this.EnergyType = (Assets.Scripts.GameLogic.EnergyType) actorData.TheBaseAttribute.EpType;
            ...
            this.mActorValue[0x24] = new ValueDataInfo(RES_FUNCEFT_TYPE.RES_PROPERTY_RECOVERYGAINEFFECT, 0, 0, null, 0, this.GetPropMaxValueLimit(RES_FUNCEFT_TYPE.RES_PROPERTY_RECOVERYGAINEFFECT, bPvpMode));
        }
        ...
        public int actorStar
        {
            ...
            set
            {
                ...
                if (value > 1)
                {
                    ...
                    meta.ConfigId = this.m_theActorMeta.ConfigId;
        ...
        public Assets.Scripts.GameLogic.EnergyType EnergyType
        {
            get
            {
