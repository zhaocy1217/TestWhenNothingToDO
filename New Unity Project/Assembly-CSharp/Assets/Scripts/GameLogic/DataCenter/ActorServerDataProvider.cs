namespace Assets.Scripts.GameLogic.DataCenter
{
    ...
    internal class ActorServerDataProvider : ActorDataProviderBase
    {
        ...
        {
            <GetActorServerCommonSkillData>c__AnonStorey42 storey = new <GetActorServerCommonSkillData>c__AnonStorey42();
            skillID = 0;
            ListView<COMDT_CHOICEHERO> view = null;
            if (this._serverCachedInfo.TryGetValue(actorMeta.PlayerId, out view))
            {
                storey.configId = actorMeta.ConfigId;
                COMDT_CHOICEHERO comdt_choicehero = this.Find(view, new Predicate<COMDT_CHOICEHERO>(storey.<>m__13));
        ...
        {
            <GetActorServerData>c__AnonStorey40 storey = new <GetActorServerData>c__AnonStorey40();
            ...
            storey.configId = actorMeta.ConfigId;
            this.ConvertServerHeroInfo(ref actorData, this.Find(view, new Predicate<COMDT_CHOICEHERO>(storey.<>m__11)));
            return true;
        }
        ...
        {
            <GetActorServerEquipData>c__AnonStorey43 storey = new <GetActorServerEquipData>c__AnonStorey43();
            ...
            storey.configId = actorMeta.ConfigId;
            return this.ConvertServerHeroEquipInfo(ref equipData, equipSlot, this.Find(view, new Predicate<COMDT_CHOICEHERO>(storey.<>m__14)));
        }
        ...
        {
            <GetActorServerRuneData>c__AnonStorey44 storey = new <GetActorServerRuneData>c__AnonStorey44();
            ...
            storey.configId = actorMeta.ConfigId;
            return this.ConvertServerHeroRuneInfo(ref runeData, runeSlot, this.Find(view, new Predicate<COMDT_CHOICEHERO>(storey.<>m__15)));
        }
        ...
        {
            <GetActorServerSkillData>c__AnonStorey41 storey = new <GetActorServerSkillData>c__AnonStorey41();
            ...
            storey.configId = actorMeta.ConfigId;
            return this.ConvertServerHeroSkillInfo(ref skillData, skillSlot, this.Find(view, new Predicate<COMDT_CHOICEHERO>(storey.<>m__12)));
        }

        [CompilerGenerated]
        private sealed class <GetActorServerCommonSkillData>c__AnonStorey42
        {
            internal int configId;

            internal bool <>m__13(COMDT_CHOICEHERO hero)
            {
        ...
        [CompilerGenerated]
        private sealed class <GetActorServerData>c__AnonStorey40
        {
            internal int configId;
        ...
        [CompilerGenerated]
        private sealed class <GetActorServerEquipData>c__AnonStorey43
        {
            internal int configId;

            internal bool <>m__14(COMDT_CHOICEHERO hero)
            {
                return (hero.stBaseInfo.stCommonInfo.dwHeroID == this.configId);
            }
        }
        ...
        [CompilerGenerated]
        private sealed class <GetActorServerRuneData>c__AnonStorey44
        {
            internal int configId;

            internal bool <>m__15(COMDT_CHOICEHERO hero)
            {
                return (hero.stBaseInfo.stCommonInfo.dwHeroID == this.configId);
            }
        }
        ...
        [CompilerGenerated]
        private sealed class <GetActorServerSkillData>c__AnonStorey41
        {
            internal int configId;

            internal bool <>m__12(COMDT_CHOICEHERO hero)
            {
                return (hero.stBaseInfo.stCommonInfo.dwHeroID == this.configId);
            }
        }
