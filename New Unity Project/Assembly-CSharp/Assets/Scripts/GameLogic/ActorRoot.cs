namespace Assets.Scripts.GameLogic
{
    ...
    public class ActorRoot : PooledClassObject, IUpdateLogic
    {
        ...
        [NonSerialized, HideInInspector]
        private Quaternion _rotation = Quaternion.get_identity();
        [CompilerGenerated]
        private GameObject <ActorMesh>k__BackingField;
        [CompilerGenerated]
        private Animation <ActorMeshAnimation>k__BackingField;
        [NonSerialized, HideInInspector]
        ...
        {
            ActorRootSlot item = new ActorRootSlot(_child, _parentPos, _trans);
        ...
        public void LateUpdate()
        {
            ...
            int delta = (int) (Time.get_deltaTime() * 1000f);
            if (this.HudControl != null)
            {
            ...
            if (this.PetControl != null)
            {
                this.PetControl.LateUpdate(delta);
            }
        }
        ...
        public override void OnUse()
        {
            ...
            this._rotation = Quaternion.get_identity();
            this.groundY = 0;
        ...
        {
            VInt num;
            this.myTransform.set_position((Vector3) pos);
            this.myTransform.set_rotation(Quaternion.LookRotation((Vector3) dir));
            this.myTransform.set_parent(MonoSingleton<SceneMgr>.GetInstance().GetRoot((SceneObjType) this.TheActorMeta.ActorType).get_transform());
            this.location = pos;
            this.forward = dir;
            this.rotation = this.myTransform.get_rotation();
        ...
        public GameObject ActorMesh
        {
            ...
            get
            {
                return this.<ActorMesh>k__BackingField;
            }
            [CompilerGenerated]
            protected set
            {
                this.<ActorMesh>k__BackingField = value;
            }
        }
        ...
        public Animation ActorMeshAnimation
        {
            ...
            get
            {
                return this.<ActorMeshAnimation>k__BackingField;
            }
            [CompilerGenerated]
            protected set
            {
                this.<ActorMeshAnimation>k__BackingField = value;
            }
        }
        ...
        private bool bActive
        {
            get
            {
                return this.gameObject.get_activeSelf();
            }
        }
        ...
        public GameObject gameObject
        {
            get
            {
                return ((this.ObjLinker == null) ? null : this.ObjLinker.get_gameObject());
            }
        }
