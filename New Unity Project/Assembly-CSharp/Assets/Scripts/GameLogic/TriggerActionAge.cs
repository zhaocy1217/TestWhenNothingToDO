namespace Assets.Scripts.GameLogic
{
    ...
    public class TriggerActionAge : TriggerActionBase
    {
        ...
        {
            return this.PlayAgeActionShared(inTiming, base.TimingActionsInter, new ActionStopDelegate(this.OnActionStopedPrivate), this.m_duraActsPrivate, inSrc, inAtker);
        }
        ...
        protected static Action PlayAgeActionShared(string inActionName, string inHelperName, GameObject inSrc, GameObject inAtker, int inHelperIndex = -1, ActionStopDelegate inCallback = new ActionStopDelegate())
        {
