namespace Assets.Scripts.GameLogic
{
    ...
    [StructLayout(LayoutKind.Sequential), FrameSCSYNCCommandClass(SC_FRAME_CMD_ID_DEF.SC_FRAME_CMD_PLAYERDISCONNECT)]
        ...
        public void ExecCommand(IFrameCommand cmd)
        {
            ...
            if ((player != null) && (player.Captain != 0))
            {
                if (ActorHelper.IsHostCampActor(ref player.Captain))
                {
                    ...
                    info.bSelfCamp = true;
                    info.Type = KillDetailInfoType.Info_Type_Disconnect;
