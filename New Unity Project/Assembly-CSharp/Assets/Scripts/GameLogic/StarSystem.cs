namespace Assets.Scripts.GameLogic
{
    ...
    public class StarSystem : Singleton<StarSystem>
    {
        ...
        public void EndGame()
        {
            ...
            StarSystem local2 = Singleton<StarSystem>.instance;
            local2.OnEvaluationChanged = (OnEvaluationChangedDelegate) Delegate.Remove(local2.OnEvaluationChanged, new OnEvaluationChangedDelegate(BattleLogic.OnStarSystemChanged));
        }
        ...
        public void StartFight()
        {
            ...
            if (((curLvelContext != null) && !Singleton<LobbyLogic>.instance.inMultiGame) && !curLvelContext.IsMobaMode())
            {
                ...
                StarSystem local2 = Singleton<StarSystem>.instance;
                local2.OnFailureEvaluationChanged = (OnEvaluationChangedDelegate) Delegate.Combine(local2.OnFailureEvaluationChanged, new OnEvaluationChangedDelegate(BattleLogic.OnFailureEvaluationChanged));
