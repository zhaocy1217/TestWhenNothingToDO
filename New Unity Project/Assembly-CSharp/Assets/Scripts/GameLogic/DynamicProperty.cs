namespace Assets.Scripts.GameLogic
{
    ...
    public class DynamicProperty : IComparer<object>
    {
        ...
        [CompilerGenerated]
        private uint <m_frameTimer>k__BackingField;
        ...
        private void OnVisit(ResBattleDynamicProperty InProperty)
        {
            ...
            else if (InProperty.bVarType == 2)
            {
                ...
                else
                {
                    ...
                    list2.deltaTime = 0;
                    list2.propertyList = new List<object>();
        ...
        public void UpdateActorProperty(ref ResBattleDynamicProperty _property)
        {
            ...
            for (int i = 0; i < heroActors.Count; i++)
            {
                ...
                if ((_property.iSoulExp != 0) && (handle != 0))
                {
                    ...
                    handle.handle.ValueComponent.ChangeGoldCoinInBattle(_property.bGoldCoinInBattleAutoIncreaseValue, true, false, position, false, target);
                }
            }
        }
        ...
        public uint m_frameTimer
        {
            ...
            get
            {
                return this.<m_frameTimer>k__BackingField;
            }
            [CompilerGenerated]
            private set
            {
                this.<m_frameTimer>k__BackingField = value;
            }
        }
