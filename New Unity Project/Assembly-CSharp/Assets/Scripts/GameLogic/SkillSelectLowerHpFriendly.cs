namespace Assets.Scripts.GameLogic
{
    ...
    public class SkillSelectLowerHpFriendly : SkillBaseSelectTarget
    {
        ...
        {
            ActorRoot root = Singleton<TargetSearcher>.GetInstance().GetLowestHpTarget(UseSlot.Actor.handle, UseSlot.SkillObj.GetMaxSearchDistance(UseSlot.GetSkillLevel()), TargetPriority.TargetPriority_Hero, UseSlot.SkillObj.cfgData.dwSkillTargetFilter, false, true);
            if (root != null)
            {
