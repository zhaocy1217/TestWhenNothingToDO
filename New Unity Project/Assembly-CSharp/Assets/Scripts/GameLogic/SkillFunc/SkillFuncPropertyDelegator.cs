namespace Assets.Scripts.GameLogic.SkillFunc
{
    ...
    internal class SkillFuncPropertyDelegator
    {
        ...
        {
            if ((inContext.inTargetObj != 0) && inContext.inTargetObj.handle.ValueComponent.IsEnergyType(EnergyType.MagicResource))
            {
        ...
        {
            if (inContext.inSkillFunc.bSkillFuncType == 0x11)
            {
        ...
        {
            if (inContext.inSkillFunc.bSkillFuncType == 0x13)
            {
        ...
        {
            if (inContext.inSkillFunc.bSkillFuncType == 0x17)
            {
        ...
        [SkillFuncHandler(0x4c, new int[] {  })]
        public static bool OnSkillFuncChangeHeroEnergyEp(ref SSkillFuncContext inContext)
        {
            if ((inContext.inTargetObj != 0) && inContext.inTargetObj.handle.ValueComponent.IsEnergyType(EnergyType.EnergyResource))
            {
                OnSKillFuncChangeEpValue(ref inContext, true);
                return true;
            }
        ...
        [SkillFuncHandler(0x4d, new int[] {  })]
        public static bool OnSkillFuncChangeHeroFuryEp(ref SSkillFuncContext inContext)
        {
            if ((inContext.inTargetObj != 0) && inContext.inTargetObj.handle.ValueComponent.IsEnergyType(EnergyType.FuryResource))
            {
                OnSKillFuncChangeEpValue(ref inContext, true);
                return true;
            }
        ...
        {
            if ((inContext.inTargetObj != 0) && inContext.inTargetObj.handle.ValueComponent.IsEnergyType(EnergyType.MadnessResource))
            {
                OnSKillFuncChangeEpValue(ref inContext, true);
                return true;
            }
        ...
        public static bool OnSkillFuncChangeMaxHp(ref SSkillFuncContext inContext)
        {
            ...
            if (inContext.inSkillFunc.bSkillFuncType == 0x15)
            {
        ...
        public static bool OnSkillFuncChangeMgcEffect(ref SSkillFuncContext inContext)
        {
            ...
            else if (inContext.inStage == ESkillFuncStage.Leave)
            {
                ...
                if ((inContext.inTargetObj != 0) && (inContext.inTargetObj.handle.ValueComponent != null))
                {
                    ValueProperty property2 = inContext.inTargetObj.handle.ValueComponent;
                    inContext.inTargetObj.handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_MGCATKPT].ChangeEvent -= new ValueChangeDelegate(property2.OnValuePropertyChangeByMgcEffect);
                }
            }
            return true;
        }
        ...
        {
            if (inContext.inSkillFunc.bSkillFuncType == 0x19)
            {
        ...
        public static bool OnSkillFuncIncAtkWithDeffend(ref SSkillFuncContext inContext)
        {
            ...
            {
                ValueDataInfo info1 = inContext.inTargetObj.handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_PHYATKPT];
                info1.convertRatioByDefence += skillFuncParam;
            ...
            {
                ValueDataInfo info2 = inContext.inTargetObj.handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_PHYATKPT];
                info2.convertRatioByDefence -= skillFuncParam;
                inContext.inTargetObj.handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_PHYDEFPT].ChangeEvent -= new ValueChangeDelegate(inContext.inTargetObj.handle.ValueComponent.ChangePhyAtkByPhyDefence);
                inContext.inTargetObj.handle.ValueComponent.ChangePhyAtkByPhyDefence();
            }
            return true;
        ...
        public static bool OnSkillFuncRecoveryEffect(ref SSkillFuncContext inContext)
        {
            ...
            if (inContext.inStage == ESkillFuncStage.Enter)
            {
                if (skillFuncParam == 0)
                {
                    info = inTargetObj.handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_PHYVAMP] + num3;
                    info = inTargetObj.handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_MGCVAMP] + num3;
                    info = inTargetObj.handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_PROPERTY_RECOVERYGAINEFFECT] + num2;
                }
                else
                {
                    info = inTargetObj.handle.ValueComponent.mActorValue[9] << num3;
                    info = inTargetObj.handle.ValueComponent.mActorValue[10] << num3;
                    info = inTargetObj.handle.ValueComponent.mActorValue[0x24] << num2;
                }
            }
            else if (inContext.inStage == ESkillFuncStage.Leave)
            {
