namespace Assets.Scripts.GameLogic
{
    ...
    {
        [CompilerGenerated]
        private bool <bIsLastAtkUseSkill>k__BackingField;
        [CompilerGenerated]
        private bool <bZeroCd>k__BackingField;
        [CompilerGenerated]
        private TalentSystem <talentSystem>k__BackingField;
        ...
        {
            SkillSlot slot2;
            if ((this.TryGetSkillSlot(slot, out slot2) && (slot2 != null)) && (slot2.skillIndicator != null))
            {
                return slot2.skillIndicator.effectPrefab;
            }
            return null;
        }
            ...
            if (this.stSkillStat != null)
            {
                ...
                Label_00EB:
                    ...
                    if (actorDataProvider.GetActorStaticSkillData(ref base.actor.TheActorMeta, (ActorSkillSlot) i, ref skillData))
                    {
                        ...
                        if (((i > 3) || (i < 1)) || (!Singleton<BattleLogic>.GetInstance().m_LevelContext.IsSoulGrow() || (base.actor.TheActorMeta.ActorType != ActorTypeDef.Actor_Type_Hero)))
                        {
        ...
        {
            int index = (int) _type;
            if (this.IsIngnoreDisableSkill(_type) && (this.ForceDisableSkill[(int) _type] == 0))
            {
                return false;
            }
        ...
        {
            SkillSlot slot = null;
            if ((this.actorPtr.handle.TheActorMeta.ActorType == ActorTypeDef.Actor_Type_Hero) && ActorHelper.IsHostCtrlActor(ref this.actorPtr))
            {
                for (int i = 0; i < 10; i++)
                {
        ...
        public void ResetSkillLevel()
        {
            ...
            if ((captain == base.actorPtr) && (Singleton<CBattleSystem>.GetInstance().FightForm != null))
            {
                Singleton<CBattleSystem>.instance.FightForm.ResetSkillButtonManager(base.actorPtr, false, SkillSlotType.SLOT_SKILL_COUNT);
            }
            this.m_iSkillPoint = 0;
        }
        ...
        private void SkillInfoStatistic(ref SkillSlot stSkillSlot)
        {
            if (stSkillSlot != null)
            {
                ...
                if ((this.stSkillStat.SkillStatistictInfo[(int) stSkillSlot.SlotType].iSkillCfgID == 0) || (this.stSkillStat.SkillStatistictInfo[(int) stSkillSlot.SlotType].iSkillCfgID == stSkillSlot.SkillObj.cfgData.iCfgID))
                {
                    ...
                    long num = (long) (Time.get_realtimeSinceStartup() * 1000f);
        ...
        public bool SpawnBuff(PoolObjHandle<ActorRoot> inTargetActor, SkillUseContext inContext, int inSkillCombineId, bool bExtraBuff = false)
        {
            ...
            return this.SpawnBuff(inTargetActor, inContext, inSkillCombineId, ref newSkill, bExtraBuff);
        }
        ...
        public PoolObjHandle<BulletSkill> SpawnBullet(SkillUseContext context, string _actionName, bool _bDeadRemove, bool _bAgeImmeExcute = false, int _bulletTypeId = 0, int _bulletUpperLimit = 0)
        {
            ...
            if (context != null)
            {
                ...
                item.Init(_actionName, _bDeadRemove, _bulletTypeId);
        ...
        {
            int index = (int) _type;
            if (((this.SkillSlotArray == null) || (index < 0)) || (index >= 10))
            {
                _slot = null;
                return false;
            }
        ...
        public override void UpdateLogic(int nDelta)
        {
            ...
            int index = 0;
            while (index < this.SpawnedBullets.Count)
            {
                BulletSkill skill = this.SpawnedBullets[index];
                if (skill != null)
                {
        ...
        public bool bIsLastAtkUseSkill
        {
            ...
            get
            {
                return this.<bIsLastAtkUseSkill>k__BackingField;
            }
            [CompilerGenerated]
            private set
            {
                this.<bIsLastAtkUseSkill>k__BackingField = value;
            }
        }
        ...
        public bool bZeroCd
        {
            ...
            get
            {
                return this.<bZeroCd>k__BackingField;
            }
            [CompilerGenerated]
            private set
            {
                this.<bZeroCd>k__BackingField = value;
            }
        }
        ...
        public TalentSystem talentSystem
        {
            ...
            get
            {
                return this.<talentSystem>k__BackingField;
            }
            [CompilerGenerated]
            private set
            {
                this.<talentSystem>k__BackingField = value;
            }
        }
    }
}
