namespace Assets.Scripts.GameLogic
{
    ...
    public class BurnExpeditionController : Singleton<BurnExpeditionController>
    {
        ...
        {
            this.model.curSelect_BoxIndex = BurnExpeditionUT.GetIndex(uievent.m_srcWidget.get_name()) - 1;
            ...
            if (uievent.m_srcWidget.get_transform().FindChild("current_node").get_gameObject().get_activeSelf())
            {
                uint num3;
                uint num4;
        ...
        {
            int index = BurnExpeditionUT.GetIndex(uievent.m_srcWidget.get_name());
        ...
        private void On_Burn_GotoShop(CUIEvent uievent)
        {
            ...
            uiEvent.m_eventID = enUIEventID.Shop_OpenBurningShop;
        ...
        {
            int levelNo = BurnExpeditionUT.GetIndex(uievent.m_srcWidget.get_name()) - 1;
