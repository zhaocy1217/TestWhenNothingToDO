namespace Assets.Scripts.GameLogic
{
    ...
    public class GameTaskOccupy : GameTask
    {
        private void onActorInside(AreaEventTrigger sourceTrigger, object param)
        {
            ...
            {
                if ((this.SubjectType == RES_BATTLE_TASK_SUBJECT.CAMP) && sourceTrigger.HasActorInside(new Func<PoolObjHandle<ActorRoot>, bool>(this, (IntPtr) this.<onActorInside>m__F)))
                {
                    base.Current += (int) param;
                }
                else if ((this.SubjectType == RES_BATTLE_TASK_SUBJECT.ORGAN) && sourceTrigger.HasActorInside(new Func<PoolObjHandle<ActorRoot>, bool>(this, (IntPtr) this.<onActorInside>m__10)))
                {
                    base.Current += (int) param;
                }
            }
