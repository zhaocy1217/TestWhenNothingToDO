namespace Assets.Scripts.GameLogic
{
    ...
    public class DialogueProcessor : MonoSingleton<DialogueProcessor>
    {
        ...
        private PoolObjHandle<Action> m_curAction = new PoolObjHandle<Action>();
        ...
        private void DoNextPageInternal()
        {
            ...
            if (this.m_curUiForm != null)
            {
                ...
                {
                    Transform transform = this.m_curUiForm.get_gameObject().get_transform().FindChild(str);
                    if (transform != null)
                    {
                        this.m_bgGoList.Add(transform.get_gameObject());
                    }
                }
                this.m_curUiForm.get_gameObject().get_transform().Find("Txt_Dialog").get_gameObject().GetComponent<Text>().set_text(node.DialogContent);
                this.m_curUiForm.get_gameObject().get_transform().Find("CharacterName").get_gameObject().GetComponent<Text>().set_text(node.DialogTitle);
                if (node.b3dPortrait)
                {
        ...
        private void EndDialogue()
        {
            ...
            if (this.m_curUiFormPortrait != null)
            {
                Transform transform = this.m_curUiFormPortrait.get_gameObject().get_transform().FindChild("PanelCenter");
                if (transform != null)
                {
                    Transform transform2 = transform.FindChild("3DImage");
                    if (transform2 != null)
                    {
                        transform2.get_gameObject().GetComponent<CUI3DImageScript>().RemoveGameObject(this.m_3dPortraitName);
                    }
                }
            }
        ...
        {
            <NextPageNoTimeScale>c__Iterator10 iterator = new <NextPageNoTimeScale>c__Iterator10();
        ...
        {
            if ((this.m_curUiFormPortrait != null) && (this.m_curUiFormPortrait.get_gameObject().get_transform().FindChild("PanelCenter") != null))
            {
        ...
        public static Action PlayAgeAction(string inActionName, string inHelperName, GameObject inSrc, GameObject inAtker, ActionStopDelegate inCallback = new ActionStopDelegate(), int inHelperIndex = -1)
        {
        ...
        {
            if ((this.m_curAction != 0) && !ActionManager.Instance.IsActionValid((Action) this.m_curAction))
            {
                return false;
            }
            this.m_curAction = new PoolObjHandle<Action>(PlayAgeAction(this.m_ageActName, this.m_ageActName, inSrc, inAtker, new ActionStopDelegate(this.OnActionStoped), -1));
        ...
        {
            <PlayAnimNoTimeScale>c__Iterator11 iterator = new <PlayAnimNoTimeScale>c__Iterator11();
            iterator.animation = animation;
            iterator.clipName = clipName;
            iterator.bLoop = bLoop;
            iterator.onComplete = onComplete;
            iterator.<$>animation = animation;
            iterator.<$>clipName = clipName;
            iterator.<$>bLoop = bLoop;
            iterator.<$>onComplete = onComplete;
        ...
        public void StartDialogue(int inGroupId)
        {
            ...
            if (this.m_actorLinesRaw != null)
            {
                ...
                {
                    this.m_actorLines = new SActorLineNode[this.m_actorLinesRaw.get_Count()];
                    ...
                    if (enumerator.MoveNext())
                    {
                        ...
                        {
                            ResActorLinesInfo inRecord = enumerator.get_Current() as ResActorLinesInfo;
                            SActorLineNode node2 = new SActorLineNode();
                            this.TranslateNodeFromRaw(ref node2, ref inRecord);
        ...
        {
            <StartFadingIn>c__Iterator13 iterator = new <StartFadingIn>c__Iterator13();
            iterator.<>f__this = this;
            return iterator;
        }
        ...
        {
            <StartFadingOut>c__Iterator12 iterator = new <StartFadingOut>c__Iterator12();
            iterator.<>f__this = this;
            return iterator;
        }
        ...
        private void UpdateBgImageAlpha(float inAlpha)
        {
            ...
            while (enumerator.MoveNext())
            {
                if (enumerator.Current != null)
                {
                    ...
                    if (text != null)
                    {
                        Color color2 = text.get_color();
                        text.set_color(new Color(color2.r, color2.g, color2.b, inAlpha));
                    }
                }
            }
        }
            ...
            if (this.m_curUiFormPortrait != null)
            {
                ...
                if (transform != null)
                {
                    ...
                    if (bActive)
                    {
                        ...
                        {
                            CUI3DImageScript component = transform.FindChild("3DImage").get_gameObject().GetComponent<CUI3DImageScript>();
                            this.OnDestroyPortrait(this.m_3dPortraitName);
                            ...
                            if (config != null)
                            {
                                ...
                                if (key != null)
                                {
                                    key.get_transform().set_localScale((Vector3) (key.get_transform().get_localScale() * config.Scale));
                                }
                            }
                            else
                            {
                            ...
                            if (key != null)
                            {
                                ...
                                if (animation != null)
                                {
                                    ...
                                    Coroutine coroutine = base.StartCoroutine(PlayAnimNoTimeScale(animation, clipName, node.bAnimLoop, new Action(this, (IntPtr) this.OnPortrait3dAnimComplete)));
                                    this.Portrait3dAnimCoMap.Add(key, coroutine);
                                }
                            }
                        }
                    ...
                    {
                        CUI3DImageScript script2 = transform.FindChild("3DImage").get_gameObject().GetComponent<CUI3DImageScript>();
                        this.OnDestroyPortrait(this.m_3dPortraitName);
        ...
        private void UpdatePortraitImg(bool bActive, SActorLineNode node, SActorLineNode preNode)
        {
            if (this.m_curUiForm != null)
            {
                Transform transform = this.m_curUiForm.get_gameObject().get_transform().Find("Pic_Npc");
                if (transform != null)
                {
                    transform.get_gameObject().CustomSetActive(bActive);
                    if (bActive)
                    {
                        ...
                        {
                            transform.get_gameObject().GetComponent<Image>().SetSprite(node.PortraitImgPrefab.Object, false);
                        }
                        else
                        {
        ...
        [CompilerGenerated]
        private sealed class <NextPageNoTimeScale>c__Iterator10 : IDisposable, IEnumerator, IEnumerator<object>
        {
            ...
            public bool MoveNext()
            {
                ...
                switch (num)
                {
                    case 0:
                        ...
                        this.<_timeAtLastFrame>__0 = Time.get_realtimeSinceStartup();
                        break;
                ...
                if (this.<>f__this.m_bIsPlayingAutoNext)
                {
                    ...
                    {
                        this.<_timeAtCurrentFrame>__1 = Time.get_realtimeSinceStartup();
        ...
        [CompilerGenerated]
        private sealed class <PlayAnimNoTimeScale>c__Iterator11 : IDisposable, IEnumerator, IEnumerator<object>
        {
            internal object $current;
            internal int $PC;
            ...
            public bool MoveNext()
            {
                ...
                switch (num)
                {
                    case 0:
                        ...
                        this.<_currState>__0 = this.animation.get_Item(this.clipName);
                        if (this.<_currState>__0 == null)
                        {
                            goto Label_01B9;
                        }
                        this.<_currState>__0.set_wrapMode(!this.bLoop ? ((WrapMode) 1) : ((WrapMode) 2));
                        ...
                        this.<_timeAtLastFrame>__3 = Time.get_realtimeSinceStartup();
                        break;
                ...
                {
                    this.<_timeAtCurrentFrame>__4 = Time.get_realtimeSinceStartup();
                    ...
                    this.<_currState>__0.set_normalizedTime(this.<_progressTime>__2 / this.<_currState>__0.get_length());
                    this.animation.Sample();
                    if (this.<_progressTime>__2 >= this.<_currState>__0.get_length())
                    {
                        if (this.<_currState>__0.get_wrapMode() != 2)
                        {
        ...
        [CompilerGenerated]
        private sealed class <StartFadingIn>c__Iterator13 : IDisposable, IEnumerator, IEnumerator<object>
        {
            internal object $current;
            internal int $PC;
            ...
            public bool MoveNext()
            {
                ...
                switch (num)
                {
                    case 0:
                        ...
                        this.<_timeAtLastFrame>__2 = Time.get_realtimeSinceStartup();
                        break;
                ...
                {
                    this.<_timeAtCurrentFrame>__3 = Time.get_realtimeSinceStartup();
        ...
        [CompilerGenerated]
        private sealed class <StartFadingOut>c__Iterator12 : IDisposable, IEnumerator, IEnumerator<object>
        {
            internal object $current;
            internal int $PC;
            internal float <_progressTime>__1;
