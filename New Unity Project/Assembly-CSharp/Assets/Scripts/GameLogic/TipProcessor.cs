        ...
        private void StartDialogue(int inGroupId)
        {
            ...
            if (dataByKey != null)
            {
                ...
                if (this.m_curUiForm != null)
                {
                    ...
                    obj2.get_transform().FindChild(this.m_contentGoName).get_gameObject().GetComponent<Text>().set_text(actorLines.DialogContent);
                    obj2.get_transform().FindChild(this.m_nameGoName).get_gameObject().GetComponent<Text>().set_text(actorLines.DialogTitle);
                    if (actorLines.PortraitImgPrefab.Object != null)
                    {
                        Transform transform = obj2.get_transform().FindChild(this.m_imgGoName);
                        if (transform != null)
                        {
                            transform.get_gameObject().GetComponent<Image>().SetSprite(actorLines.PortraitImgPrefab.Object, false);
                        }
                    }
