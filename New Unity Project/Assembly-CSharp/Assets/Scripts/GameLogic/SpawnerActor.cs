namespace Assets.Scripts.GameLogic
{
    ...
    public class SpawnerActor : SpawnerBase
    {
        ...
        public override object DoSpawn(VInt3 inWorldPos, VInt3 inDir, GameObject inSpawnPoint)
        {
            ...
            SpawnPoint.DoSpawn(inSpawnPoint, inWorldPos, inDir, this.bSequentialMeta, inActorMetaList, this.m_rangePolygon, this.m_rangeDeadPoint, null, this.InitBuffDemand, this.InitRandPassSkillRule, ref inSpawnedList);
