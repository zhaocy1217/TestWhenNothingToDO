namespace Assets.Scripts.GameLogic
{
    ...
    public class DropItem
    {
        ...
        public DropItem(string InPrefab, IDropDownEffect InDropdownEffect, IPickupEffect InPickupEffect)
        {
            ...
            {
                GameObject obj2 = Singleton<DropItemMgr>.instance.FindPrefabObject(this.Prefab);
                if (obj2 != null)
                {
                    this.ItemObject = Object.Instantiate(obj2);
                    this.CachedItemTransform = (this.ItemObject == null) ? null : this.ItemObject.get_transform();
                }
            }
        ...
        public void SetLocation(VInt3 Pos)
        {
            ...
            {
                this.CachedItemTransform.set_position((Vector3) Pos);
            }
        }
