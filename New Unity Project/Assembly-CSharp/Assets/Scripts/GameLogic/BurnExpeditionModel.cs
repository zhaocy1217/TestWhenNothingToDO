namespace Assets.Scripts.GameLogic
{
    ...
    public class BurnExpeditionModel
    {
        ...
        [CompilerGenerated]
        private EDifficultyType <curDifficultyType>k__BackingField;
        ...
        public void Reset_Data()
        {
            ...
            while (enumerator.MoveNext())
            {
                ...
                {
                    KeyValuePair<uint, Dictionary<uint, int>> pair2 = enumerator.Current;
                    pair2.Value.Clear();
                }
            }
            this.curSelect_LevelIndex = -1;
        ...
        public EDifficultyType curDifficultyType
        {
            [CompilerGenerated]
            get
            {
                return this.<curDifficultyType>k__BackingField;
            }
            [CompilerGenerated]
            set
            {
                this.<curDifficultyType>k__BackingField = value;
            }
        }
