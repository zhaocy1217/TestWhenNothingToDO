namespace Assets.Scripts.GameSystem
{
    ...
    internal class CHeroDataFactory
    {
        ...
        public static ListView<IHeroData> GetHostHeroList(bool isIncludeValidExperienceHero, CMallSortHelper.HeroViewSortType sortType = 1)
        {
            ...
            if (masterRoleInfo != null)
            {
                ...
                CHeroOverviewSystem.SortHeroList(ref heroList, sortType, false);
            }
            return heroList;
        }

        public static ListView<IHeroData> GetPvPHeroList(CMallSortHelper.HeroViewSortType sortType = 1)
        {
            ListView<IHeroData> heroList = new ListView<IHeroData>();
            CRoleInfo masterRoleInfo = Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo();
            if (masterRoleInfo != null)
        ...
        public static ListView<IHeroData> GetTrainingHeroList(CMallSortHelper.HeroViewSortType sortType = 1)
        {
            ListView<IHeroData> heroList = new ListView<IHeroData>();
