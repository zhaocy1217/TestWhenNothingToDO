namespace Assets.Scripts.GameSystem
{
    ...
    public class CChatUT
    {
        ...
        public static string Build_4_EntryString(EChatChannel type, ulong ullUid, uint iLogicWorldID, string rawText)
        {
            ...
            if (type == EChatChannel.GuildMatchTeam)
            {
            ...
            if (type == EChatChannel.Settle)
            {
                ...
                {
                    str = string.Format(CChatController.fmt, UT.Bytes2String(comdt_chat_player_info6.szName), rawText);
                }
                return str;
            }
        ...
        public static CChatEntity Build_4_Friend(COMDT_CHAT_MSG_PRIVATE data)
        {
            ...
            entity.ullUid = data.stFrom.ullUid;
            entity.iLogicWorldID = (uint) data.stFrom.iLogicWorldID;
            entity.text = UT.Bytes2String(data.szContent);
            entity.type = EChaterType.Friend;
        ...
        {
            CChatEntity entity = new CChatEntity();
            entity.type = EChaterType.LeaveRoom;
            entity.text = content;
            return entity;
        }
        ...
        public static CChatEntity Build_4_LoudSpeaker(COMDT_CHAT_MSG_HORN data)
        {
            ...
            entity.iLogicWorldID = (uint) data.stFrom.iLogicWorldID;
            entity.text = UT.Bytes2String(data.szContent);
            entity.type = EChaterType.LoudSpeaker;
            GetUser(entity.type, entity.ullUid, entity.iLogicWorldID, out entity.name, out entity.level, out entity.head_url, out entity.stGameVip);
            entity.time = CRoleInfo.GetCurrentUTCTime();
            return entity;
        }
        ...
        {
            CChatEntity entity = new CChatEntity();
            entity.ullUid = data.stChatMsg.stFrom.ullUid;
            entity.iLogicWorldID = (uint) data.stChatMsg.stFrom.iLogicWorldID;
            entity.text = UT.Bytes2String(data.stChatMsg.szContent);
            entity.type = EChaterType.Friend;
            GetUser(entity.type, entity.ullUid, entity.iLogicWorldID, out entity.name, out entity.level, out entity.head_url, out entity.stGameVip);
            return entity;
        }
        ...
        {
            CChatEntity entity = new CChatEntity();
            entity.type = EChaterType.OfflineInfo;
            entity.text = content;
            return entity;
        }
        ...
        {
            CChatEntity entity = new CChatEntity();
            entity.text = !bOffline ? Singleton<CTextManager>.instance.GetText("FriendChat_online_Info") : Singleton<CTextManager>.instance.GetText("FriendChat_Offline_Info");
            entity.type = EChaterType.OfflineInfo;
            return entity;
        }
        ...
        {
            CChatEntity entity = new CChatEntity();
            entity.ullUid = Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo().playerUllUID;
        ...
        public static CChatEntity Build_4_Speaker(COMDT_CHAT_MSG_HORN data)
        {
            ...
            entity.iLogicWorldID = (uint) data.stFrom.iLogicWorldID;
            entity.text = UT.Bytes2String(data.szContent);
            entity.type = EChaterType.Speaker;
            GetUser(entity.type, entity.ullUid, entity.iLogicWorldID, out entity.name, out entity.level, out entity.head_url, out entity.stGameVip);
            entity.time = CRoleInfo.GetCurrentUTCTime();
            return entity;
        }
        ...
        {
            CChatEntity entity = new CChatEntity();
            entity.type = EChaterType.System;
            entity.text = content;
            return entity;
        }
        ...
        {
            Singleton<CChatController>.instance.model.channelMgr.Clear(EChatChannel.GuildMatchTeam, 0L, 0);
