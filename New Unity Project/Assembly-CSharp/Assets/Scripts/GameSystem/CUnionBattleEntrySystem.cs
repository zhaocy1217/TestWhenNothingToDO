    ...
    public class CUnionBattleEntrySystem : Singleton<CUnionBattleEntrySystem>
    {
        ...
        private void initConfirmFormWidget()
        {
            ...
            if (form != null)
            {
                ...
                text3.set_text(string.Format(text3.get_text(), this.m_selectStateInfo.bMatchCnt, this.maxMatchRoundCnt));
                CRoleInfo masterRoleInfo = Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo();
                if (masterRoleInfo != null)
                {
                    GameObject widget = form.GetWidget(3);
                    GameObject obj3 = widget.get_transform().FindChild("lblIconCount").get_gameObject();
                    Text text4 = obj3.GetComponent<Text>();
                    ...
                    text4.set_text(string.Format("x{0}", useableStackCount));
            ...
            if (form != null)
            {
                ...
                if ((widget != null) && (obj3 != null))
                {
                    ...
                    if (CSysDynamicBlock.bLobbyEntryBlocked)
                    {
                        ...
                        Transform transform = form.get_transform().FindChild("panelBottom/ButtonBattleVideo");
                        if (transform != null)
                        {
                            transform.get_gameObject().CustomSetActive(false);
                        }
                        Transform transform2 = form.get_transform().FindChild("panelBottom/ButtonBattleNews");
                        if (transform2 != null)
                        {
        ...
        private void initRewardIntroFormWidget()
        {
            ...
            if (form != null)
            {
                CUIListScript component = form.GetWidget(0).get_transform().GetComponent<CUIListScript>();
                ...
                for (int i = 0; i <= amount; i++)
                {
                    ...
                    {
                        this.refreshOneRewardElement(form, component.GetElemenet(i).get_gameObject(), i);
                    }
                }
            }
        }
        ...
        private void initSecondFormWidget()
        {
            ...
            if (form != null)
            {
                ...
                if (((widget != null) && (btn != null)) && (obj4 != null))
                {
                    ...
                    widget.get_transform().FindChild("Lock").get_gameObject().CustomSetActive(!flagArray[0]);
                    btn.get_transform().FindChild("Lock").get_gameObject().CustomSetActive(!flagArray[1]);
                    this.ShowCountDownTime(widget, flagArray[0]);
                    this.ShowCountDownTime(btn, flagArray[1]);
                    widget.get_transform().FindChild("Desc/MapNameTxt").GetComponent<Text>().set_text(GetUnionBattleMapInfoByMapID(widget.GetComponent<CUIMiniEventScript>().m_onClickEventParams.tagUInt).stLevelCommonInfo.szName);
                    btn.get_transform().FindChild("Desc/MapNameTxt").GetComponent<Text>().set_text(GetUnionBattleMapInfoByMapID(btn.GetComponent<CUIMiniEventScript>().m_onClickEventParams.tagUInt).stLevelCommonInfo.szName);
                    if (CSysDynamicBlock.bLobbyEntryBlocked)
                    {
                        if (obj4 != null)
                        {
                        ...
                        GameObject obj5 = form.get_transform().FindChild("panelBottom/Button").get_gameObject();
                        if (obj5 != null)
                        {
        ...
        private void initThirdFormWidget()
        {
            ...
            {
                Transform transform = form.GetWidget(2).get_transform();
                int bLossCnt = this.m_selectStateInfo.bLossCnt;
                GameObject[] objArray = new GameObject[MAX_LOSE_TIME];
                objArray[0] = transform.FindChild("loseicon_1").get_gameObject();
                objArray[1] = transform.FindChild("loseicon_2").get_gameObject();
                objArray[2] = transform.FindChild("loseicon_3").get_gameObject();
                ...
                {
                    CUICommonSystem.PlayAnimator(form.GetWidget(9).get_gameObject(), "TipsLose_Anim_In_2");
                    form.GetWidget(10).get_transform().FindChild("Text").GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("Union_Battle_Tips20"));
                }
                Transform transform2 = form.GetWidget(0).get_transform();
                ...
                if ((outWinLoseChginfo.winLoseChgType == enLastWinLoseCntChgType.enChgType_Win) && (this.m_selectStateInfo.bWinCnt != 0))
                {
                    ...
                    CUICommonSystem.PlayAnimator(transform2.get_gameObject(), string.Format("VictoryTimes_{0}-{1}", num4.ToString(), this.m_selectStateInfo.bWinCnt.ToString()));
                    SetWinLoseCntChgInfo(this.m_selectMapID, enLastWinLoseCntChgType.enChgType_None);
                    transform2.FindChild("Img_WinCnt").get_gameObject().CustomSetActive(false);
                }
                else
                {
                    GameObject obj3 = transform2.FindChild("Img_WinCnt").get_gameObject();
                    obj3.GetComponent<Image>().SetSprite(string.Format("{0}{1}{2}", "UGUI/Sprite/System/", "UnionBattle/", this.m_selectStateInfo.bWinCnt), form, true, false, false, false);
                    obj3.CustomSetActive(true);
                    SetWinLoseCntChgInfo(this.m_selectMapID, enLastWinLoseCntChgType.enChgType_None);
                }
                if (outWinLoseChginfo.winLoseChgType == enLastWinLoseCntChgType.enChgType_Lose)
                {
                    CUICommonSystem.PlayAnimator(transform.get_gameObject(), string.Format("Lose_Anim_{0}", this.m_selectStateInfo.bLossCnt));
                    SetWinLoseCntChgInfo(this.m_selectMapID, enLastWinLoseCntChgType.enChgType_None);
                }
                ...
                if (info != null)
                {
                    form.GetWidget(1).GetComponent<Text>().set_text(info.szTimeTips);
                }
                ...
                if (masterRoleInfo != null)
                {
                    ...
                    if (this.m_selectMapRes != null)
                    {
                        ...
                        Text component = widget.get_transform().Find("lblIconCount").GetComponent<Text>();
                        CUICommonSystem.SetItemCell(form, widget, itemUseable, true, false, false, false);
                        ...
                        if (bActive)
                        {
                            CUICommonSystem.PlayAnimator(form.GetWidget(9).get_gameObject(), "TipsAward_Anim_In_2");
                            Text text4 = obj7.get_transform().FindChild("Tips/Text").GetComponent<Text>();
                            if (this.m_selectStateInfo.bWinCnt == this.m_selectMapRes.bWinCnt)
                            {
                                text4.set_text(Singleton<CTextManager>.GetInstance().GetText("Union_Battle_Tips18"));
                            }
                            else
                            {
                                text4.set_text(Singleton<CTextManager>.GetInstance().GetText("Union_Battle_Tips19"));
                            }
                        }
                    }
                    if (CSysDynamicBlock.bLobbyEntryBlocked)
                    {
                        Transform transform3 = form.get_transform().FindChild("Root/PanelRight/Btn_award");
                        if (transform3 != null)
                        {
        ...
        private void OnBuyTiketClick(CUIEvent uiEvt)
        {
            ...
            params.tagUInt = this.m_selectMapRes.dwConsumPayItemID;
            params.tag = this.m_selectMapRes.bCoinType;
        ...
        {
            CUICommonSystem.JumpForm(RES_GAME_ENTRANCE_TYPE.RES_GAME_ENTRANCE_NOTICE, 0, 0);
        }
        ...
        private void OnClickGetRewardTips(CUIEvent uiEvt)
        {
            ...
            if (uiEvt.m_srcWidget.get_activeInHierarchy() && (component.m_currentAnimatorStateName != "TipsAward_Anim_Out"))
            {
        ...
        {
            CUIAnimatorScript component = uiEvt.m_srcFormScript.GetWidget(9).GetComponent<CUIAnimatorScript>();
            if (uiEvt.m_srcWidget.get_activeInHierarchy() && (component.m_currentAnimatorStateName != "TipsLose_Anim_Out"))
            {
        ...
        private void Open_BattleEntry(CUIEvent uiEvt)
        {
            ...
            else if (Singleton<CMatchingSystem>.instance.IsInMatching)
            {
        ...
        private void Open_SecondBattleEntry(CUIEvent uiEvt)
        {
            switch (uiEvt.m_eventParams.tag)
            {
                case 0:
                {
                    ...
                    this.initSecondFormWidget();
                    Singleton<CBattleGuideManager>.GetInstance().OpenBannerDlgByBannerGuideId(4, null, false);
                    break;
                }
                case 1:
                    Singleton<CUIManager>.instance.OpenTips("Union_Battle_Tips3", true, 1.5f, null, new object[0]);
        ...
        private void refreshOneRewardElement(CUIFormScript form, GameObject element, int index)
        {
            ...
            {
                int num = index - 1;
                element.get_transform().FindChild("PanelReward").get_gameObject().CustomSetActive(index != 0);
                element.get_transform().FindChild("PanelTitle").get_gameObject().CustomSetActive(index == 0);
                if (index != 0)
                {
                    string[] args = new string[] { num.ToString() };
                    element.get_transform().FindChild("PanelReward/Text").GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("Union_Battle_Tips16", args));
                    CUIListScript component = element.get_transform().FindChild("PanelReward/IconContainer").GetComponent<CUIListScript>();
                    GameObject obj2 = element.get_transform().FindChild("PanelReward/itemBaoXiang").get_gameObject();
                    ...
                    else
                    {
                        ...
                        CUICommonSystem.SetItemCell(form, obj2, itemUseable, true, false, false, false);
                        ...
                        if (info2 != null)
                        {
                            ...
                            if (store != null)
                            {
                                ...
                                for (int j = 0; j < count; j++)
                                {
                                    ...
                                    CUICommonSystem.SetItemCell(form, elemenet.get_gameObject(), view[j], true, false, false, false);
                                    Text text2 = elemenet.get_transform().FindChild("lblIconCount").GetComponent<Text>();
                                    ResDT_RandomRewardInfo info4 = store.astRewardDetail[j];
                                    if (info4.dwLowCnt != info4.dwHighCnt)
                                    {
                                        text2.set_text(string.Format("{0}~{1}", info4.dwLowCnt, info4.dwHighCnt));
                                    }
                                    if ((j + 1) >= count)
                                    {
                                        elemenet.get_gameObject().get_transform().FindChild("Add").get_gameObject().CustomSetActive(false);
                                    }
                                    else
                                    {
                                        elemenet.get_gameObject().get_transform().FindChild("Add").get_gameObject().CustomSetActive(true);
                                    }
                                }
                            }
                        }
        ...
        private void ShowCountDownTime(GameObject Btn, bool bMapOpened)
        {
            if (Btn != null)
            {
                ...
                if (transform2 != null)
                {
                    GameObject obj2 = transform2.FindChild("Text").get_gameObject();
                    GameObject obj3 = transform2.FindChild("Timer").get_gameObject();
                    if (!bMapOpened)
                    {
                        obj3.CustomSetActive(false);
                        obj2.CustomSetActive(false);
                    ...
                    else
                    {
                        ...
                        if ((utilOpenDay == 0) && (utilOpenSec == 0))
                        {
                            obj3.CustomSetActive(false);
                            obj2.CustomSetActive(true);
                            obj2.GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("Union_Battle_Tips6"));
                        }
                        else if (utilOpenSec < SECOND_ONE_DAY)
                        {
                            obj2.CustomSetActive(false);
                            obj3.CustomSetActive(true);
                            CUITimerScript component = obj3.get_transform().FindChild("Text").GetComponent<CUITimerScript>();
                        ...
                        else
                        {
                            ...
                            obj2.GetComponent<Text>().set_text(string.Format(text, num4));
                        }
                    }
                }
            }
