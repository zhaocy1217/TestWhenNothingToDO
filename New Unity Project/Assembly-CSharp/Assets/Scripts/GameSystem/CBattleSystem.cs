namespace Assets.Scripts.GameSystem
{
    ...
    public class CBattleSystem : Singleton<CBattleSystem>
    {
        ...
        [CompilerGenerated]
        private PauseControl <pauseControl>k__BackingField;
        ...
        {
            CUIFormScript script = !Singleton<WatchController>.GetInstance().IsWatching ? this.FightFormScript : this.WatchFormScript;
            if (script != null)
            {
        ...
        {
            if ((Singleton<BattleLogic>.GetInstance().m_LevelContext.IsMobaMode() && ((actor != 0) && ActorHelper.IsHostCtrlActor(ref actor))) && (this.m_battleEquipSystem != null))
            {
        ...
        public PauseControl pauseControl
        {
            ...
            get
            {
                return this.<pauseControl>k__BackingField;
            }
            [CompilerGenerated]
            private set
            {
                this.<pauseControl>k__BackingField = value;
            }
        }
