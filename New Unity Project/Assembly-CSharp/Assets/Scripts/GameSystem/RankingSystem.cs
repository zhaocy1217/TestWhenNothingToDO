namespace Assets.Scripts.GameSystem
{
    ...
    public class RankingSystem : Singleton<RankingSystem>
    {
        ...
        private readonly LocalRankingInfo[] _rankingInfo = new LocalRankingInfo[13];
        ...
        private CSDT_TRANK_TLOG_INFO[] m_uiTlog = new CSDT_TRANK_TLOG_INFO[0x44];
        ...
        protected static COM_APOLLO_TRANK_SCORE_TYPE ConvertRankingServerType(RankingType rankType)
        {
            ...
            switch (rankType)
            {
                ...
                case RankingType.MentorPoint:
                    return COM_APOLLO_TRANK_SCORE_TYPE.COM_APOLLO_TRANK_SCORE_TYPE_MASTERPOINT;
        ...
        public void ImpResRankingDetail(SCPKG_GET_RANKING_ACNT_INFO_RSP rsp)
        {
            ...
            if (this._form != null)
            {
                ...
                this.TryToUnlock();
                this.ReqRankingList(ConvertRankingServerType(RankingType.Achievement), 0);
            }
        }
            ...
            if (this._form != null)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        info2.ListInfo = rsp.stRankingListDetail.stOfSucc;
                        info2.LastRetrieveTime = (uint) CRoleInfo.GetCurrentUTCTime();
                        bool flag = false;
                ...
                Singleton<EventRouter>.GetInstance().BroadCastEvent<RankingType>("Ranking_List_Change", type);
                this.TryToUnlock();
            }
        }
        ...
        public override void Init()
        {
            ...
            Singleton<EventRouter>.GetInstance().AddEventHandler("Rank_Arena_List", new Action(this, (IntPtr) this.OnRankArenaList));
            Singleton<EventRouter>.GetInstance().AddEventHandler("Arena_Fighter_Changed", new Action(this, (IntPtr) this.OnArenaFighterChanged));
            Singleton<EventRouter>.GetInstance().AddEventHandler("Arena_Record_List", new Action(this, (IntPtr) this.OnArenaRecordList));
        ...
        internal void InitWidget(bool isShowAllRankTypeBtn = true)
        {
            ...
            this._animator = this._form.get_gameObject().GetComponent<Animator>();
            ...
            if (elemenet != null)
            {
                ...
                elemenet.get_gameObject().get_transform().FindChild("Text").GetComponent<Text>().set_text(this._allViewName);
            }
            elemenet = this._viewList.GetElemenet(1);
            if (elemenet != null)
            {
                elemenet.get_gameObject().get_transform().FindChild("Text").GetComponent<Text>().set_text(this._friendViewName);
            }
        ...
        private void OnArenaAddFriend(CUIEvent uiEvent)
        {
            ...
            Singleton<CFriendContoller>.instance.Open_Friend_Verify(ullUid, (uint) tag, false, COM_ADD_FRIEND_TYPE.COM_ADD_FRIEND_NULL, -1, true);
        }
        ...
        {
            this.TryToChangeRankType(RankingType.MentorPoint);
            RankingView.HideAllRankMenu();
            COM_APOLLO_TRANK_SCORE_TYPE com_apollo_trank_score_type = ConvertRankingServerType(RankingType.MentorPoint);
            this.m_uiTlog[(int) com_apollo_trank_score_type].dwType = (uint) com_apollo_trank_score_type;
            CSDT_TRANK_TLOG_INFO csdt_trank_tlog_info1 = this.m_uiTlog[(int) com_apollo_trank_score_type];
            csdt_trank_tlog_info1.dwCnt++;
        }
        ...
        protected void OnChangeSubViewTab(CUIEvent uiEvent)
        {
            if (this._curSubViewType != this._viewList.GetSelectedIndex())
            {
                ...
                this._form.m_formWidgets[0x16].CustomSetActive(false);
                this.UpdateTabText();
        ...
        private void OnCoinSent(SCPKG_CMD_DONATE_FRIEND_POINT data)
        {
            ...
            if (form != null)
            {
                ...
                else
                {
                    ...
                    int num4 = -1;
                    if (this._coinSentFriendDic.TryGetValue(key, out num4))
                    {
                    ...
                    if ((this._curRankingType == RankingType.Arena) && (num4 >= 0))
                    {
                        CUIListElementScript elemenet = form.GetWidget(0x11).GetComponent<CUIListScript>().GetElemenet(num4);
                        if (elemenet != null)
                        {
                            CUIEvent uiEvent = new CUIEvent();
                            uiEvent.m_eventID = enUIEventID.Ranking_ArenaElementEnable;
                            uiEvent.m_srcFormScript = form;
                            uiEvent.m_srcWidget = elemenet.get_gameObject();
                            uiEvent.m_srcWidgetIndexInBelongedList = num4;
                            Singleton<CUIEventManager>.GetInstance().DispatchUIEvent(uiEvent);
                        }
                    }
                    else if ((this._curRankingType != RankingType.God) || (num4 < 0))
                    {
                        if ((num4 >= 0) && (this._rankingList != null))
                        {
                            CUIListElementScript script4 = this._rankingList.GetElemenet(num4);
                            if (script4 != null)
                            {
                                CUIEvent event3 = new CUIEvent();
                                event3.m_eventID = enUIEventID.Ranking_ElementEnable;
                                event3.m_srcFormScript = form;
                                event3.m_srcWidget = script4.get_gameObject();
                                event3.m_srcWidgetIndexInBelongedList = num4;
        ...
        private void OnGodDetailTabClick(CUIEvent uiEvent)
        {
            if (this._curRankingType == RankingType.God)
            {
                int selectedIndex = uiEvent.m_srcWidgetScript.GetSelectedIndex();
                LocalRankingInfo localRankingInfo = this.GetLocalRankingInfo(this._curRankingType, this.m_heroMasterId);
        ...
        {
            if (this._form.m_formWidgets[14].get_activeSelf())
            {
                RankingView.HideAllRankMenu();
            }
            else
        ...
        private void SetMenuElementText()
        {
            ...
            if (obj2 != null)
            {
                obj2.get_transform().FindChild("ListElement0").get_gameObject().get_transform().FindChild("Text").GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("ranking_LadderRankName"));
                obj2.get_transform().FindChild("ListElement1").get_gameObject().get_transform().FindChild("Text").GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("ranking_HeroCountRankName"));
                obj2.get_transform().FindChild("ListElement2").get_gameObject().get_transform().FindChild("Text").GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("ranking_SkinCountRankName"));
                obj2.get_transform().FindChild("ListElement3").get_gameObject().get_transform().FindChild("Text").GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("ranking_AchieveRankName"));
                obj2.get_transform().FindChild("ListElement4").get_gameObject().get_transform().FindChild("Text").GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("ranking_WinCountRankName"));
                obj2.get_transform().FindChild("ListElement5").get_gameObject().get_transform().FindChild("Text").GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("ranking_ConWinRankName"));
                obj2.get_transform().FindChild("ListElement6").get_gameObject().get_transform().FindChild("Text").GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("ranking_GameVIPRankName"));
            }
        }
        ...
        protected void TryToChangeRankType(RankingType rankType)
        {
            if (rankType != this._curRankingType)
            {
                ...
                {
                    if ((this._viewList != null) && (this._viewList.get_gameObject() != null))
                    {
                        this._viewList.get_gameObject().CustomSetActive(false);
                ...
                else
                {
                    if ((this._viewList != null) && (this._viewList.get_gameObject() != null))
                    {
                        this._viewList.get_gameObject().CustomSetActive(rankType != RankingType.God);
                    }
        ...
        public override void UnInit()
        {
            ...
            Singleton<EventRouter>.GetInstance().RemoveEventHandler("Rank_Arena_List", new Action(this, (IntPtr) this.OnRankArenaList));
            Singleton<EventRouter>.GetInstance().RemoveEventHandler("Arena_Fighter_Changed", new Action(this, (IntPtr) this.OnArenaFighterChanged));
            Singleton<EventRouter>.GetInstance().RemoveEventHandler("Arena_Record_List", new Action(this, (IntPtr) this.OnArenaRecordList));
        }
            ...
            else
            {
                ...
                if (this._curSubViewType != RankingSubView.All)
                {
                    ...
                    for (int j = 0; j < elementAmount; j++)
                    {
                        ...
                        {
                            this.EmptyOneElement(this._rankingList.GetElemenet(j).get_gameObject(), j);
                        }
                    }
                }
                if (this._curSubViewType == RankingSubView.Friend)
                ...
                for (int i = 0; i < dwItemNum; i++)
                {
                    ...
                    {
                        this.UpdateOneElement(this._rankingList.GetElemenet(i).get_gameObject(), i);
                    }
                }
                this._form.m_formWidgets[0x15].CustomSetActive(false);
                if (this._curRankingType == RankingType.Achievement)
                {
                    this._form.m_formWidgets[15].CustomSetActive(false);
                    this._form.m_formWidgets[0x16].CustomSetActive(dwItemNum == 0);
                }
                else
                {
        ...
        private void UpdateOneElement(GameObject objElement, int viewIndex)
        {
            ...
            if (localRankingInfo.ListInfo != null)
            {
                ...
                if (this._curRankingType == RankingType.Ladder)
                {
                    ...
                    objElement.get_transform().FindChild("Value").get_gameObject().CustomSetActive(false);
                    objElement.get_transform().FindChild("ValueType").get_gameObject().CustomSetActive(false);
                }
                else
                {
                    component.LadderGo.CustomSetActive(false);
                    objElement.get_transform().FindChild("Value").get_gameObject().CustomSetActive(true);
                    objElement.get_transform().FindChild("ValueType").get_gameObject().CustomSetActive(true);
                }
                switch (this._curRankingType)
                {
                    ...
                    case RankingType.Ladder:
                    {
                        ...
                        CLadderView.ShowRankDetail(component.LadderGo, (byte) rankGrade, this.GetRankClass(ullUid), 1, false, true, false, true, true);
                        component.LadderXing.GetComponent<Text>().set_text(string.Format("x{0}", curXingByEloAndRankLv));
                        break;
                    }
                    case RankingType.Achievement:
                    {
                        RankingView.SetGameObjChildText(objElement, "ValueType", Singleton<CTextManager>.GetInstance().GetText("ranking_ItemAchieveName"));
                        CTrophyRewardInfo trophyRewardInfoByPoint = CAchieveInfo2.GetMasterAchieveInfo().GetTrophyRewardInfoByPoint(score);
                ...
                uniq.ullUid = ullUid;
                uniq.dwLogicWorldId = dwLogicWorldID;
                if (this._curSubViewType == RankingSubView.Friend)
                {
                ...
                if (flag2)
                {
                    bool bEnable = Singleton<CFriendContoller>.instance.model.HeartData.BCanSendHeart(uniq);
                    ...
                    if (component.Online != null)
                    {
                        ...
                        {
                            componetInChild.set_text((comdt_friend_info3.bIsOnline == 0) ? Singleton<CTextManager>.GetInstance().GetText("Common_Offline") : string.Format("<color=#00ff00>{0}</color>", Singleton<CTextManager>.instance.GetText("Common_Online")));
                        }
                    }
                }
                else if (flag)
                {
                    bool flag4 = Singleton<CFriendContoller>.instance.model.HeartData.BCanSendHeart(uniq);
                    component.ShowSendButton(flag4);
                    ...
                    if (component.Online != null)
                    {
                        ...
                        if (text2 != null)
                        {
                            text2.set_text((comdt_friend_info2.bIsOnline == 0) ? Singleton<CTextManager>.GetInstance().GetText("Common_Offline") : string.Format("<color=#00ff00>{0}</color>", Singleton<CTextManager>.instance.GetText("Common_Online")));
                        }
                    }
                }
                else
        ...
        protected void UpdateSelfInfo()
        {
            ...
            {
                component.LadderGo.CustomSetActive(true);
                this._myselfInfo.get_transform().FindChild("Value").get_gameObject().CustomSetActive(false);
                this._myselfInfo.get_transform().FindChild("ValueType").get_gameObject().CustomSetActive(false);
            }
            else
            {
                component.LadderGo.CustomSetActive(false);
                this._myselfInfo.get_transform().FindChild("Value").get_gameObject().CustomSetActive(true);
                this._myselfInfo.get_transform().FindChild("ValueType").get_gameObject().CustomSetActive(true);
            }
            switch (this._curRankingType)
            {
                case RankingType.PvpRank:
                ...
                case RankingType.Ladder:
                    ...
                    else
                    {
                        ...
                        CLadderView.ShowRankDetail(component.LadderGo, (byte) num4, Singleton<CRoleInfoManager>.GetInstance().GetSelfRankClass(), 1, false, true, false, true, true);
        ...
        Label_0613:
            ...
            else if (selfInfo.iRankChgNo > 0)
            {
                ...
                component.RankingUpDownIcon.get_transform().set_localEulerAngles(new Vector3(0f, 0f, 0f));
                RankingView.SetGameObjChildText(this._myselfInfo, "ChangeNum", selfInfo.iRankChgNo.ToString(CultureInfo.InvariantCulture));
            }
            else if (selfInfo.iRankChgNo < 0)
            {
                component.RankingUpDownIcon.CustomSetActive(true);
                component.RankingUpDownIcon.get_transform().set_localEulerAngles(new Vector3(0f, 0f, 180f));
                RankingView.SetGameObjChildText(this._myselfInfo, "ChangeNum", -selfInfo.iRankChgNo.ToString(CultureInfo.InvariantCulture));
            }
            ...
            if (elemenet != null)
            {
                ...
                else
                {
                    if (this._curRankingType == RankingType.Arena)
                    {
                        ...
                        elemenet.get_gameObject().get_transform().FindChild("Text").GetComponent<Text>().set_text(text);
                        return;
                    }
                    if (this._curRankingType == RankingType.God)
                    {
                    ...
                    if (this._curRankingType == RankingType.MentorPoint)
                    {
                ...
                switch (this._curSubViewType)
                {
                    case RankingSubView.All:
                        elemenet.get_gameObject().get_transform().FindChild("Text").GetComponent<Text>().set_text(string.Format("{0}{1}", this._allViewName, text));
                        break;

                    case RankingSubView.Friend:
                        elemenet.get_gameObject().get_transform().FindChild("Text").GetComponent<Text>().set_text(string.Format("{0}{1}", this._friendViewName, text));
                        return;
                }
            }
        }
