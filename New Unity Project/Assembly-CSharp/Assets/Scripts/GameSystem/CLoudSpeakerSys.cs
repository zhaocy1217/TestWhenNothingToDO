namespace Assets.Scripts.GameSystem
{
    ...
    public class CLoudSpeakerSys : Singleton<CLoudSpeakerSys>
    {
        ...
        private string GetInputText()
        {
            ...
            {
                return Utility.GetComponetInChild<InputField>(form.get_gameObject(), "pnlBg/Panel_Main/InputField").get_text();
            }
            return string.Empty;
        }
        ...
        private void OnUpdateCharacterLimitText(CUIEvent uiEvent)
        {
            ...
            if ((form != null) && (form.get_gameObject() != null))
            {
                Text componetInChild = Utility.GetComponetInChild<Text>(form.get_gameObject(), "pnlBg/Panel_Main/CharLimitTxt");
                if (componetInChild != null)
                {
                    InputField field = Utility.GetComponetInChild<InputField>(form.get_gameObject(), "pnlBg/Panel_Main/InputField");
                    if (field != null)
                    {
                        int num = ((int) this.m_characterLimit) - field.get_text().Length;
                        if (num < 0)
                        {
                            num = 0;
                        }
                        componetInChild.set_text(string.Format(s_characterLimitString, num));
                    }
                }
            }
        }
                    ...
                    if (useableContainer != null)
                    {
                        ...
                        else
                        {
                            ...
                            if (dataByKey != null)
                            {
                                ...
                                {
                                    GameObject obj2 = Utility.FindChild(script.get_gameObject(), "pnlBg/Title/speakerText");
                                    GameObject obj3 = Utility.FindChild(script.get_gameObject(), "pnlBg/Title/loudSpeakerText");
                                    GameObject obj4 = Utility.FindChild(script.get_gameObject(), "pnlBg/Model/speaker");
                                    GameObject obj5 = Utility.FindChild(script.get_gameObject(), "pnlBg/Model/loudspeaker");
                                    InputField componetInChild = Utility.GetComponetInChild<InputField>(script.get_gameObject(), "pnlBg/Panel_Main/InputField");
                                    Utility.GetComponetInChild<CUITimerScript>(script.get_gameObject(), "Timer").ReStartTimer();
                                    if (itemID == 0x2739)
                                    {
