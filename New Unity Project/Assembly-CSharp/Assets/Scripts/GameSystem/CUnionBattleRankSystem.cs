    ...
    public class CUnionBattleRankSystem : Singleton<CUnionBattleRankSystem>
    {
                ...
                for (int i = 0; i < unionBattleMapCount; i++)
                {
                    ...
                    if (CUICommonSystem.IsMatchOpened(RES_BATTLE_MAP_TYPE.RES_BATTLE_MAP_TYPE_REWARDMATCH, unionBattleMapInfoByIndex.dwMapId))
                    {
                        ...
                        if (elemenet != null)
                        {
                            ...
                            elemenet.get_transform().FindChild("Text").GetComponent<Text>().set_text(unionBattleMapInfoByIndex.szMatchName);
        ...
        private void RefreshAcntInfo()
        {
            ...
            if (form != null)
            {
                ...
                if ((actRankInfo != null) && (masterRoleInfo != null))
                {
                    ...
                    widget.get_transform().FindChild("Value").get_gameObject().CustomSetActive(true);
                    widget.get_transform().FindChild("ValueType").get_gameObject().CustomSetActive(true);
                ...
                CUICommonSystem.SetHostHeadItemCell(widget.get_transform().FindChild("HeadItemCell").get_gameObject());
        ...
        private void RefreshOneWinCntElement(GameObject element, int index)
        {
            ...
            if (((element != null) && (listInfo != null)) && ((num < listInfo.astItemDetail.Length) && (num < listInfo.dwItemNum)))
            {
                ...
                element.get_transform().FindChild("Value").get_gameObject().CustomSetActive(true);
        ...
        private void RefreshWinCntRankList()
        {
            ...
            if (form != null)
            {
                ...
                CSDT_RANKING_LIST_SUCC listInfo = this.m_UnionRankInfo[(int) this.m_CurSelRankType].listInfo;
                Transform transform = widget.get_transform().FindChild("RankingList");
                Transform transform2 = widget.get_transform().FindChild("NoRankTxt");
                ...
                else
                {
                    ...
                    for (int i = 0; i < dwItemNum; i++)
                    {
                        ...
                        {
                            this.RefreshOneWinCntElement(component.GetElemenet(i).get_gameObject(), i);
                        }
                    }
                }
            }
