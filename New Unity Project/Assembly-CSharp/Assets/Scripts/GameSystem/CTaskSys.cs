namespace Assets.Scripts.GameSystem
{
    ...
    public class CTaskSys : Singleton<CTaskSys>
    {
        ...
        [CompilerGenerated]
        private uint <apprenticeTaskID>k__BackingField;
        [CompilerGenerated]
        private uint <masterTaskID>k__BackingField;
        ...
        private void _show_task_award(uint taskid)
        {
            ...
            if (task != null)
            {
                ...
                if (resAward != null)
                {
                    ...
                    Singleton<CUIManager>.GetInstance().OpenAwardTip(items, null, false, enUIEventID.Task_Award_Get_Confirm, false, false, "Form_Award");
                }
            }
        }
        ...
        {
            if ((task != null) && (task.m_resTask.dwTaskType == 0))
            {
        ...
        private void ShowMonthWeekCardExpireTips(CTask task, bool isMonthCard)
        {
            ...
            int num3 = Mathf.CeilToInt(((num <= currentUTCTime) ? 0f : ((float) (num - currentUTCTime))) / 86400f);
            if ((task.m_taskState == 3) && (num3 > 0))
            {
                num3--;
            }
            if (isMonthCard)
            {
                ...
                if (GameDataMgr.svr2CltCfgDict.TryGetValue(0x16, out info))
                {
                    stUIEventParams param = new stUIEventParams();
                    param.tag2 = (int) GameDataMgr.globalInfoDatabin.GetDataByKey((uint) 0x124).dwConfValue;
                    if (num3 == 0)
                    {
            ...
            else
            {
                ...
                if (GameDataMgr.svr2CltCfgDict.TryGetValue(0x17, out info2))
                {
                    stUIEventParams params2 = new stUIEventParams();
                    params2.tag2 = (int) GameDataMgr.globalInfoDatabin.GetDataByKey((uint) 0x125).dwConfValue;
                    if (num3 == 0)
                    {
                        Singleton<CUIManager>.GetInstance().OpenMessageBoxWithCancel(Singleton<CTextManager>.GetInstance().GetText("WeekCardExpireTips2"), enUIEventID.Mall_Open_Factory_Shop_Tab, enUIEventID.None, params2, "立即续费", "暂不续费", false);
                    }
                    else if (num3 <= info2.dwConfValue)
                    {
                        Singleton<CUIManager>.GetInstance().OpenMessageBoxWithCancel(Singleton<CTextManager>.GetInstance().GetText("WeekCardExpireTips1"), enUIEventID.Mall_Open_Factory_Shop_Tab, enUIEventID.None, params2, "立即续费", "暂不续费", false);
                    }
                }
            }
        }
        ...
        public uint apprenticeTaskID
        {
            ...
            get
            {
                return this.<apprenticeTaskID>k__BackingField;
            }
            [CompilerGenerated]
            set
            {
                this.<apprenticeTaskID>k__BackingField = value;
            }
        }
        ...
        public uint masterTaskID
        {
            ...
            get
            {
                return this.<masterTaskID>k__BackingField;
            }
            [CompilerGenerated]
            set
            {
                this.<masterTaskID>k__BackingField = value;
            }
        }
        ...
        public CFriendMentorTaskView.EMentorTaskState MentorTaskState
        {
            get
            {
                ...
                if ((this.apprenticeTaskID == 0) && (this.masterTaskID == 0))
                {
                    CTask task = this.model.GetTask(this.model.maxCfgTudiTaskID);
                    CTask task2 = this.model.GetTask(this.model.maxCfgMasterTaskID);
                    if ((this.model.maxServerTudiTaskID == 0) && (this.model.maxServerMasterTaskID == 0))
                    {
                        return CFriendMentorTaskView.EMentorTaskState.Empty;
                    }
                    if (((this.model.maxCfgTudiTaskID == this.model.maxServerTudiTaskID) && (this.model.maxServerMasterTaskID == 0)) || ((task != null) && (task.m_taskState == 3)))
                    {
