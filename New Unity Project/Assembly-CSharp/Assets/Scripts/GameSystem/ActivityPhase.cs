namespace Assets.Scripts.GameSystem
{
    ...
    public abstract class ActivityPhase
    {
        ...
        {
            if (Time.get_time() >= (_lastDrawTime + 0.75f))
            {
                ...
                msg.stPkgData.stDrawWealReq.dwDrawCnt = (uint) this.GetExchangeCountOnce();
                Singleton<NetworkModule>.GetInstance().SendLobbyMsg(ref msg, true);
                _lastDrawTime = Time.get_time();
            }
        }
        ...
        private ResRandomRewardStore ExtraRewardDrop
        {
            get
            {
                if ((this._extraRewardStore == null) && ((this._extraRewardStore = GameDataMgr.randomRewardDB.GetDataByKey(this.ExtraRewardID)) != null))
                {
                    ...
                    {
                        if ((this._extraRewardStore.astRewardDetail[this._extraRewardCount].bItemType == 0) || (this._extraRewardStore.astRewardDetail[this._extraRewardCount].bItemType >= 0x12))
                        {
                            break;
                        }
        ...
        private ResRandomRewardStore RewardDrop
        {
            get
            {
                if ((this._rewardStore == null) && ((this._rewardStore = GameDataMgr.randomRewardDB.GetDataByKey(this.RewardID)) != null))
                {
                    ...
                    {
                        if ((this._rewardStore.astRewardDetail[this._rewardCount].bItemType == 0) || (this._rewardStore.astRewardDetail[this._rewardCount].bItemType >= 0x12))
                        {
                            break;
                        }
                        this._rewardCount++;
