    ...
    internal class PvpAchievementForm
    {
                ...
                if (obj3 != null)
                {
                    ...
                    if (component != null)
                    {
                        ...
                        for (int i = 0; i < this.barrageList.Count; i++)
                        {
                            ...
                            {
                                this.UpdateOneBarrageElement(component.GetElemenet(i).get_gameObject(), i, false);
                            }
                        }
            ...
            if (form != null)
            {
                ...
                if (widget != null)
                {
                    ...
                    if (obj3 != null)
                    {
                        ...
                        {
                            obj4.GetComponent<Text>().set_text(this.barrageList[selectedIndex]);
                        }
                    }
                }
            }
        ...
        public void ShowDefeat()
        {
            if ((this.m_allAchievements != null) && (this.m_allAchievements.Length == 8))
            {
                ...
                if (form != null)
                {
                    Transform imageTransform = form.get_transform().Find("ShareFrame/Image");
                    if (imageTransform != null)
                    {
                        MonoSingleton<ShareSys>.GetInstance().SetShareDefeatImage(imageTransform, form);
                    }
        ...
        public void ShowVictory()
        {
            if ((this.m_allAchievements != null) && (this.m_allAchievements.Length == 8))
            {
                ...
                if (script != null)
                {
                    ...
                    {
                        Transform transform = script.get_transform().Find("AchievementRoot/ButtonGrid/Button_Share");
                        if (transform != null)
                        {
        ...
        private void SwitchAchievement(RES_SHOW_ACHIEVEMENT_TYPE achievement)
        {
            ...
            if (form != null)
            {
                ...
                Utility.FindChild(widget.get_gameObject(), "Title/Text").GetComponent<Text>().set_text(Singleton<CTextManager>.instance.GetText("Share_PvpAchievement_Title" + ((int) achievement)));
                Utility.FindChild(widget.get_gameObject(), "Grid").CustomSetActive(this.GetAchievementCount() > 1);
                if (this.IsVictoryStreak(achievement))
                {
                    CUIUtility.SetImageSprite(form.GetWidget(1).GetComponent<Image>(), s_imageSharePVPBadge + 0 + ".prefab", form, true, false, false, false);
                }
                else
                {
                    CUIUtility.SetImageSprite(form.GetWidget(1).GetComponent<Image>(), s_imageSharePVPBadge + ((int) achievement) + ".prefab", form, true, false, false, false);
                }
                GameObject p = form.GetWidget(2).get_gameObject();
                if (p != null)
                {
                    int achievementCount = this.GetAchievementCount(achievement);
                    if (achievementCount != 0)
                    {
                        Utility.FindChild(p, "Number").GetComponent<Text>().set_text(achievementCount.ToString());
                        Utility.FindChild(p, "Text").GetComponent<Text>().set_text(Singleton<CTextManager>.instance.GetText("Share_PvpAchievement_Desc_" + ((int) achievement)));
                    }
                    p.CustomSetActive(achievementCount != 0);
                }
            }
        }
