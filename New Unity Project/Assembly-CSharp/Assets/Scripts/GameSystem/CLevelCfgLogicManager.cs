namespace Assets.Scripts.GameSystem
{
    ...
    public class CLevelCfgLogicManager
    {
        ...
        public static ResDT_LevelCommonInfo GetPvpMapCommonInfo(byte mapType, uint mapId)
        {
            ...
            {
                ResGuildMatchLevelInfo info6 = GameDataMgr.guildMatchLevelDatabin.GetDataByKey(mapId);
                DebugHelper.Assert(info6 != null);
                stLevelCommonInfo = info6.stLevelCommonInfo;
            }
            else if (mapType == 2)
            {
                ResCounterPartLevelInfo info7 = GameDataMgr.cpLevelDatabin.GetDataByKey(mapId);
                DebugHelper.Assert(info7 != null);
                stLevelCommonInfo = info7.stLevelCommonInfo;
            }
