namespace Assets.Scripts.GameSystem
{
    ...
    internal class CBuyCoinInfoPanel
    {
        ...
        {
            Transform transform = this.m_InfoPanel.get_transform().Find("List");
            ...
            if (script != null)
            {
                ...
                {
                    script.GetElemenet(i).get_transform().Find("Describe").GetComponent<Text>().set_text(this.GetDescribeStr(this.m_stInfos[i]));
                }
                if (flag)
                {
