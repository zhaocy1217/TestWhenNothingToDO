            ...
            if (script != null)
            {
                ...
                if (widget != null)
                {
                    ...
                    if (component != null)
                    {
                        ...
                        {
                            Transform transform = component.GetElemenet(i).get_gameObject().get_transform().Find("Label");
                            if (transform != null)
                            {
                                Text text = transform.get_gameObject().GetComponent<Text>();
                                if (text != null)
                                {
                                    text.set_text(s_tversionServerTypeName[i]);
                                    if (i == 8)
                                    {
                                        text.set_color(new Color(1f, 0f, 0f, 1f));
                                    }
                                }
                            }
                        }
                ...
                if (obj3 != null)
                {
                    ...
                    if (script4 != null)
                    {
                        ...
                        {
                            Transform transform2 = script4.GetElemenet(j).get_gameObject().get_transform().Find("Label");
                            if (transform2 != null)
                            {
                                Text text2 = transform2.get_gameObject().GetComponent<Text>();
                                if (text2 != null)
                                {
                                    text2.set_text(s_TDirServerTypeName[j]);
                                    if (j == 0)
                                    {
                                        text2.set_color(new Color(1f, 0f, 0f, 1f));
                                    }
                                }
                            }
                        }
                ...
                if (obj4 != null)
                {
                    ...
                    if (script6 != null)
                    {
                        ...
                        {
                            Transform transform3 = script6.GetElemenet(k).get_gameObject().get_transform().Find("Label");
                            if (transform3 != null)
                            {
                                Text text3 = transform3.get_gameObject().GetComponent<Text>();
                                if (text3 != null)
                                {
                                    text3.set_text(s_errorLogFlagName[k]);
                                }
                            }
                        }
                ...
                if (obj5 != null)
                {
                    ...
                    if (script8 != null)
                    {
                        ...
                        {
                            Transform transform4 = script8.GetElemenet(n).get_gameObject().get_transform().Find("Label");
                            if (transform4 != null)
                            {
                                Text text4 = transform4.get_gameObject().GetComponent<Text>();
                                if (text4 != null)
                                {
                                    text4.set_text(s_ignoreMaintainName[n]);
                                }
                            }
                        }
                ...
                if (obj6 != null)
                {
                    ...
                    if (script10 != null)
                    {
                        ...
                        {
                            Transform transform5 = script10.GetElemenet(num6).get_gameObject().get_transform().Find("Label");
                            if (transform5 != null)
                            {
                                Text text5 = transform5.get_gameObject().GetComponent<Text>();
                                if (text5 != null)
                                {
                                    text5.set_text(s_joystickConfigNames[num6]);
                                }
                            }
                            if (num6 == 0)
                            {
