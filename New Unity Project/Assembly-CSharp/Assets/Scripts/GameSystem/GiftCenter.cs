    ...
    public class GiftCenter
    {
        ...
        private void InitMenuAndSubMenu()
        {
            if ((this._heroTotalNum > 0) && (this._skinTotalNum > 0))
            {
                ...
                if (elemenet != null)
                {
                    elemenet.get_gameObject().get_transform().FindChild("Text").get_gameObject().GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("Mall_Skin_Buy_Tab"));
                }
                elemenet = this._menuList.GetElemenet(0);
                if (elemenet != null)
                {
                    elemenet.get_gameObject().get_transform().FindChild("Text").get_gameObject().GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("Mall_Hero_Buy_Tab"));
                }
            }
            else if (this._heroTotalNum > 0)
            {
                ...
                if (script2 != null)
                {
                    script2.get_gameObject().get_transform().FindChild("Text").get_gameObject().GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("Mall_Hero_Buy_Tab"));
                }
            }
            else
            {
                ...
                if (script3 != null)
                {
                    script3.get_gameObject().get_transform().FindChild("Text").get_gameObject().GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("Mall_Skin_Buy_Tab"));
                }
            }
            ...
            for (int i = 0; i < 7; i++)
            {
                ...
                if (script4 != null)
                {
                    script4.get_gameObject().get_transform().FindChild("Text").get_gameObject().GetComponent<Text>().set_text(this.GetJobName((enHeroJobType) i));
                }
            }
        ...
        private void OnShowGiveFriendSkin(uint heroId, uint skinId, uint price)
        {
            ...
            if (heroSkin != null)
            {
                ...
                script.get_transform().Find("Panel/skinNameText").GetComponent<Text>().set_text(heroSkin.szSkinName);
                GameObject listObj = script.get_transform().Find("Panel/Panel_Prop/List_Prop").get_gameObject();
                ...
                script.get_transform().Find("Panel/pricePanel/priceText").GetComponent<Text>().set_text(price.ToString());
                CUIEventScript component = script.get_transform().Find("Panel/BtnGroup/buyButton").get_gameObject().GetComponent<CUIEventScript>();
                ...
                CUI3DImageScript script3 = script.get_transform().Find("Panel/3DImage").get_gameObject().GetComponent<CUI3DImageScript>();
                ...
                if (model != null)
                {
                    ...
                    DynamicShadow.EnableDynamicShow(script3.get_gameObject(), true);
        ...
        private void OnSortChanged(CUIEvent uiEvent)
        {
            if (this._sortList != null)
            {
                ...
                this.SetCurSortType();
                this._sortList.get_gameObject().CustomSetActive(false);
        ...
        {
            this._sortList.get_gameObject().CustomSetActive(!this._sortList.get_gameObject().get_activeSelf());
        }
                ...
                for (int j = 0; j < payInfoSet.m_payInfoCount; j++)
                {
                    ...
                    switch (oldPriceType)
                    {
                        case CMallItem.OldPriceType.None:
                            ...
                            obj6.SetActive(true);
                            obj6.GetComponent<Text>().set_text(payInfoSet.m_payInfos[j].m_payValue.ToString());
                            obj7.GetComponent<Image>().SetSprite(CMallSystem.GetPayTypeIconPath(payInfoSet.m_payInfos[j].m_payType), this._giftCenterForm, true, false, false, false);
                            return payValue;
                        ...
                        case CMallItem.OldPriceType.FirstOne:
                            ...
                            obj4.SetActive(true);
                            widget.GetComponent<Text>().set_text(payInfoSet.m_payInfos[j].m_oriValue.ToString());
                            obj4.GetComponent<Text>().set_text(payInfoSet.m_payInfos[j].m_payValue.ToString());
                            obj5.GetComponent<Image>().SetSprite(CMallSystem.GetPayTypeIconPath(payInfoSet.m_payInfos[j].m_payType), this._giftCenterForm, true, false, false, false);
                            return payValue;
        ...
        private void SetItemTag(CMallItemWidget itemWidget, ResHeroPromotion heroPromotion, ResSkinPromotion skinPromotion, CUIFormScript form)
        {
            ...
            if (num2 > 0)
            {
                int num4 = (int) Math.Ceiling((double) (((double) num2) / 86400.0));
                if (num4 > 0)
                {
        ...
        Label_01D8:
            if ((itemWidget.m_tagContainer != null) && (!string.IsNullOrEmpty(str) || !string.IsNullOrEmpty(text)))
            {
                ...
                itemWidget.m_tagContainer.GetComponent<Image>().SetSprite(str, form, false, true, true, false);
            ...
            switch (this._curMenuPage)
            {
                case MenuPage.Hero:
                {
                    ...
                    for (int i = 0; i < 5; i++)
                    {
                        if (i != 3)
                        {
                            Text component = this._sortList.GetElemenet(index).get_transform().Find("Text").GetComponent<Text>();
                            if (component != null)
                            {
                                component.set_text(CMallSortHelper.CreateHeroSorter().GetSortTypeName((CMallSortHelper.HeroSortType) i));
                            }
                            index++;
                        }
                    }
                ...
                case MenuPage.Skin:
                    ...
                    for (int j = 0; j < 4; j++)
                    {
                        Text text2 = this._sortList.GetElemenet(j).get_transform().Find("Text").GetComponent<Text>();
                        if (text2 != null)
                        {
                            text2.set_text(CMallSortHelper.CreateSkinSorter().GetSortTypeName((CMallSortHelper.SkinSortType) j));
                        }
                    }
                    goto Label_0110;
            }
