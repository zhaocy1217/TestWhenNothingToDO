namespace Assets.Scripts.GameSystem
{
    ...
    public class CMallSortHelper
    {
        ...
        public static string[] heroViewSortTypeNameKeys = new string[] { "Hero_View_Sort_Type_Default", "Hero_View_Sort_Type_Name", "Hero_View_Sort_Type_Proficiency", "Hero_View_Sort_Type_ReleaseTime" };
