namespace Assets.Scripts.GameSystem
{
    ...
    public class ScoreBoard
    {
        ...
        public void Clear()
        {
            ...
            Singleton<EventRouter>.instance.RemoveEventHandler(EventID.BATTLE_KDA_CHANGED_BY_ACTOR_DEAD, new Action(this, (IntPtr) this.OnBattleKDAChangedByActorDead));
            this._root = null;
        ...
        public void RegiseterEvent()
        {
            ...
            Singleton<EventRouter>.instance.AddEventHandler(EventID.BATTLE_KDA_CHANGED_BY_ACTOR_DEAD, new Action(this, (IntPtr) this.OnBattleKDAChangedByActorDead));
        }
