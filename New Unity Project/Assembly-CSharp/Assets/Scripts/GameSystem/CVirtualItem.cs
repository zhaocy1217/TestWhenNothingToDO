namespace Assets.Scripts.GameSystem
{
    ...
    public class CVirtualItem : CUseable
    {
        ...
        public CVirtualItem(enVirtualItemType bType, int bCount)
        {
            ...
            {
                base.m_name = Singleton<CTextManager>.GetInstance().GetText("MingShiDianName");
                base.m_description = Singleton<CTextManager>.GetInstance().GetText("MingShiDianDesc");
                base.m_grade = 3;
            }
        }
        ...
        public override string GetIconPath()
        {
            ...
            switch (this.m_virtualType)
            {
                ...
                case enVirtualItemType.enMentorPoint:
                    return (CUIUtility.s_Sprite_Dynamic_Icon_Dir + 0x15f9e);
            }
            return str;
        }
