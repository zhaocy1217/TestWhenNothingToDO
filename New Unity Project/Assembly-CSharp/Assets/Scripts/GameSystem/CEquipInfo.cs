    ...
    public class CEquipInfo : IComparable
    {
        ...
        public CEquipInfo(ushort equipID)
        {
            ...
            if (this.m_resEquipInBattle != null)
            {
                ...
                string str = StringHelper.UTF8BytesToString(ref this.m_resEquipInBattle.szActiveSkillDes);
                for (int i = 0; i < 3; i++)
                {
                ...
                string str5 = equipPassiveSkillDesc + equipPassiveEftDesc;
                if (!string.IsNullOrEmpty(str5))
                {
                    this.m_equipPropertyDesc = this.m_equipPropertyDesc + str5;
                }
                if (!string.IsNullOrEmpty(str))
                {
                    this.m_equipPropertyDesc = this.m_equipPropertyDesc + str;
                }
            }
        }
