    ...
    public class CBuyDiamondView
    {
        ...
        public void Draw()
        {
            ...
            for (byte i = 0; i < numArray.Length; i = (byte) (i + 1))
            {
                ...
                CUIEventScript script3 = elemenet.get_gameObject().GetComponent<CUIEventScript>();
                if (script3 == null)
                {
                    script3 = elemenet.get_gameObject().AddComponent<CUIEventScript>();
                ...
                Text text = elemenet.get_gameObject().get_transform().Find("pnlPrice/txtQuantity").GetComponent<Text>();
                Text text2 = elemenet.get_gameObject().get_transform().Find("pnlPrice/txtPrice").GetComponent<Text>();
                text.set_text(numArray[i].ToString());
                text2.set_text(num2.ToString());
            }
        }
