namespace Assets.Scripts.GameSystem
{
    ...
    public class CFriendReCallData
    {
        ...
        public static bool BLose(COMDT_ACNT_UNIQ uniq, COM_FRIEND_TYPE friendType)
        {
            ...
            {
                comdt_friend_info = Singleton<CFriendContoller>.instance.model.getFriendByUid(uniq.ullUid, CFriendModel.FriendType.GameFriend, 0);
            }
            else if (friendType == COM_FRIEND_TYPE.COM_FRIEND_TYPE_SNS)
            {
                comdt_friend_info = Singleton<CFriendContoller>.instance.model.getFriendByUid(uniq.ullUid, CFriendModel.FriendType.SNS, 0);
            }
