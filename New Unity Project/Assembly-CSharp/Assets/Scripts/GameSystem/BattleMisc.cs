namespace Assets.Scripts.GameSystem
{
    ...
    public class BattleMisc
    {
            ...
            else
            {
                ...
                if (hostPlayer.Captain.handle.ActorControl.IsDeadState || (hostPlayer.Captain.handle.ValueComponent.actorHp <= 0))
                {
                    ...
                    if (this.animationScript != null)
                    {
                        ...
                        this.animationScript.get_gameObject().CustomSetActive(false);
                    }
                }
                else if (roundInt > 30)
                {
                ...
                else if (roundInt <= 10)
                {
                    if (!this.bIn10)
                    {
                        ...
                        if (this.animationScript != null)
                        {
                            this.animationScript.get_gameObject().CustomSetActive(true);
        ...
        public void Init(GameObject node, CUIFormScript formScript)
        {
            ...
            Transform transform = formScript.get_transform().Find("Flashing_RedHud");
            if (transform != null)
            {
        ...
        private void SetHp(float a)
        {
            ...
            RectTransform transform = this.blood_eft.get_transform() as RectTransform;
            transform.set_anchoredPosition(new Vector2(a * (this.bloodImage.get_transform() as RectTransform).get_sizeDelta().x, transform.get_anchoredPosition().y));
        }
        ...
        public void Show_BuffCD(int icon, int tsecond)
        {
            ...
            if (tsecond >= 0)
            {
                if (tsecond == 0)
                {
                    ...
                    if (this.buff_cd_text != null)
                    {
                        this.buff_cd_text.get_gameObject().CustomSetActive(false);
                    }
                }
                else
                {
                    ...
                    {
                        this.buff_cd_text.set_text(this.total_second.ToString());
                        this.buff_cd_text.get_gameObject().CustomSetActive(true);
                    }
                    if (this.total_second > 0)
                    {
