            ...
            if (this.selectHeroTemplateList.Count == 0)
            {
                ...
                if (selectHeroChatDatabin != null)
                {
                    ...
                    while (enumerator.MoveNext())
                    {
                        ...
                        item.dwID = (int) data.dwID;
                        item.dwGroupID = (int) data.dwGroupID;
                        item.dwTag = (int) data.dwTag;
                        item.templateString = StringHelper.UTF8BytesToString(ref data.szContent);
