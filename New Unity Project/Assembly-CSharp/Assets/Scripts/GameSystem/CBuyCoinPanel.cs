namespace Assets.Scripts.GameSystem
{
    ...
    internal class CBuyCoinPanel : CBuyPanelBase
    {
        ...
        {
            base.initPanel(form);
            this.m_TitleText = base.m_FormScript.get_transform().Find("Bg/Bg1/Title").GetComponent<Text>();
            base.m_Buttons = new GameObject[] { base.m_FormScript.get_transform().Find("Bg/Bg1/ButtonGroup/Button_BuyOne").get_gameObject(), base.m_FormScript.get_transform().Find("Bg/Bg1/ButtonGroup/Button_BuyTen").get_gameObject() };
            base.m_CheckRightButton = base.m_FormScript.get_transform().Find("Bg/Bg1/ButtonGroup/Button_CheckRight").get_gameObject();
            this.m_CostDiamondText = base.m_FormScript.get_transform().Find("Bg/Bg1/pnlAction/DiamondNum").GetComponent<Text>();
            this.m_GainCoinText = base.m_FormScript.get_transform().Find("Bg/Bg1/pnlAction/CoinNum").GetComponent<Text>();
            this.m_InfoPanel.initInfoPanel(base.m_FormScript.get_transform().Find("Bg/Bg2").get_gameObject());
            this.RefreshUI();
        ...
        private void refreshButtonState(int timeToBuy)
        {
            ...
            {
                GameObject obj2 = base.m_FormScript.get_transform().Find("Bg/Bg1/ButtonGroup/Button_BuyTen").get_gameObject();
                ...
                {
                    obj2.GetComponent<Image>().set_color(new Color(1f, 1f, 1f, 1f));
                    eventParams.tag = 1;
                }
                else
                {
                    obj2.GetComponent<Image>().set_color(new Color(0f, 1f, 1f, 1f));
                    eventParams.tag = 0;
                }
