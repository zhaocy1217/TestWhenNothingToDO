namespace Assets.Scripts.GameSystem
{
    ...
    public class CShopSystem : Singleton<CShopSystem>
    {
        ...
        {
            <GetCost>c__AnonStorey71 storey = new <GetCost>c__AnonStorey71();
            storey.shopType = shopType;
            storey.refreshCnt = refreshCnt;
            return GameDataMgr.shopRefreshCostDatabin.FindIf(new Func<ResShopRefreshCost, bool>(storey, (IntPtr) this.<>m__81));
        }
        ...
        {
            GameObject obj2 = this.m_ShopForm.get_transform().Find("pnlTipContainer").get_gameObject();
            ...
            else
            {
                ...
                {
                    GameObject obj3 = obj2.get_transform().Find("pnlTip/pnlItems/List").get_gameObject();
                    Text component = obj2.get_transform().Find("pnlTip/pnlContainer/pnlPrice/txtCnt").GetComponent<Text>();
                    ...
                    component.set_text(num3.ToString());
            ...
            if ((this.m_ShopForm != null) && this.m_IsShopFormOpen)
            {
                ...
                if (component != null)
                {
                    ...
                    for (int j = 0; j < component.m_elementAmount; j++)
                    {
                        ...
                        elemenet.get_gameObject().get_transform().Find("txtTab").GetComponent<Text>().set_text(list[j]);
                        int num4 = list2[j];
                        elemenet.get_gameObject().get_transform().Find("txtShopTypeData").GetComponent<Text>().set_text(num4.ToString());
        ...
        private void OnShop_BuyItemConfirm(CUIEvent uiEvent)
        {
            ...
            cspkg_cmd_itembuy.iRefreshTime = dwMaxRefreshTime;
        ...
        private void OnShop_PageDown(CUIEvent uiEvent)
        {
            if (this.m_IsShopFormOpen)
            {
                CUIListScript component = this.m_ShopForm.GetWidget(1).get_transform().FindChild("List").GetComponent<CUIListScript>();
        ...
        public void OnShop_SaleTipConfirm(CUIEvent uiEvent)
        {
            ...
            for (int i = 0; i < this.m_saleItemsCnt; i++)
            {
                ...
                if (useable != null)
                {
                    ...
                    item.ullUniqueID = useable.m_objID;
                    item.iItemCnt = (ushort) useable.m_stackCount;
                    inList.Add(item);
                }
            }
            if (inList.Count > 0)
            {
                ...
                csdt_item_dellist.wItemCnt = (ushort) inList.Count;
                csdt_item_dellist.astItemList = LinqS.ToArray<CSDT_ITEM_DELINFO>(inList);
        ...
        private void OnShop_Tab_Change(CUIEvent uiEvent)
        {
            ...
            {
                int num;
                Text text = component.GetSelectedElement().get_transform().Find("txtShopTypeData").GetComponent<Text>();
                if (!int.TryParse(text.get_text(), out num))
                {
                    object[] inParameters = new object[] { text.get_text() };
        ...
        public static void ReceiveShopItems(CSPkg msg)
        {
            ...
            CShopSystem instance = Singleton<CShopSystem>.GetInstance();
            stShopInfo info = new stShopInfo();
            info.enShopType = wShopType;
            info.dwAutoRefreshTime = stShopInfo.iAutoRefreshTime;
            info.dwManualRefreshTime = stShopInfo.iManualRefreshTime;
            info.dwApRefreshTime = stShopInfo.iAPRefreshTime;
            info.dwManualRefreshCnt = stShopInfo.iManualRefreshCnt + 1;
            ...
            for (byte i = 0; i < stItemList.bItemCnt; i = (byte) (i + 1))
            {
                ...
                info2.dwItemId = comdt_shop_iteminfo.dwItemID;
                info2.wItemCnt = comdt_shop_iteminfo.wItemCnt;
                info2.enItemType = (COM_ITEM_TYPE) comdt_shop_iteminfo.wItemType;
                info2.enCostType = (RES_SHOPBUY_COINTYPE) comdt_shop_iteminfo.bCostType;
                info2.wSaleDiscount = comdt_shop_iteminfo.wSaleDiscout;
        ...
        private void RefreshBuyPnl()
        {
            ...
            GameObject itemCell = Utility.FindChild(form.get_gameObject(), "Panel_Left/pnlItem/itemCell");
            GameObject obj3 = Utility.FindChild(form.get_gameObject(), "Panel_Left/pnlBuy/pnlPrice/imgCoin");
            GameObject obj4 = Utility.FindChild(form.get_gameObject(), "Panel_Left/pnlBuy/pnlPrice/imgGold");
            GameObject obj5 = Utility.FindChild(form.get_gameObject(), "Panel_Left/pnlBuy/pnlPrice/imgPvp");
            GameObject obj6 = Utility.FindChild(form.get_gameObject(), "Panel_Left/pnlBuy/pnlPrice/imgBurning");
            GameObject obj7 = Utility.FindChild(form.get_gameObject(), "Panel_Left/pnlBuy/pnlPrice/imgArena");
            GameObject obj8 = Utility.FindChild(form.get_gameObject(), "Panel_Left/pnlBuy/pnlPrice/imgGuild");
            Text componetInChild = Utility.GetComponetInChild<Text>(form.get_gameObject(), "Panel_Left/pnlItem/pnlTitle/lblName");
            Text text2 = Utility.GetComponetInChild<Text>(form.get_gameObject(), "Panel_Left/pnlItem/pnlStatus/lblCount");
            Text text3 = Utility.GetComponetInChild<Text>(form.get_gameObject(), "Panel_Left/pnlItem/pnlStatus/lblCountTitleSuffix");
            Text text4 = Utility.GetComponetInChild<Text>(form.get_gameObject(), "Panel_Left/pnlBuy/pnlPrice/txtPrice");
            Text text5 = Utility.GetComponetInChild<Text>(form.get_gameObject(), "Panel_Left/pnlMemo/pnlDes/Text");
            Text text6 = Utility.GetComponetInChild<Text>(form.get_gameObject(), "Panel_Left/pnlBuy/pnlPrice/txtCnt");
            ...
            switch (info.enCostType)
            {
                case RES_SHOPBUY_COINTYPE.RES_SHOPBUY_TYPE_COUPONS:
                    if (text4 != null)
                    {
                        ...
                        {
                            text4.set_color(new Color(1f, 0.91f, 0.45f, 1f));
                            break;
                        }
                        text4.set_color(new Color(1f, 0.4f, 0.4f, 1f));
                    }
                    break;
        ...
        Label_04C2:
            ...
            if (text2 != null)
            {
                text2.set_text(useableStackCount.ToString());
            }
            if (text3 != null)
            {
                text3.set_text(Singleton<CTextManager>.GetInstance().GetText("Shop_Item_Buy_Status_Unit"));
            }
            if (componetInChild != null)
            {
                componetInChild.set_text(itemUseable.m_name);
            }
            if (text4 != null)
            {
                text4.set_text(info.fPrice.ToString());
            }
            if (text5 != null)
            {
                text5.set_text(itemUseable.m_description);
            }
            ...
            if (text6 != null)
            {
                text6.set_text(info.wItemCnt + Singleton<CTextManager>.GetInstance().GetText("Shop_Item_Buy_Status_Unit"));
            }
            if (itemCell != null)
            {
                CUICommonSystem.SetItemCell(form, itemCell, itemUseable, false, false, false, false);
            }
        }
        ...
        public void RefreshInfoPanel()
        {
            switch (this.m_CurShopType)
            {
                ...
                case RES_SHOP_TYPE.RES_SHOPTYPE_GUILD_HEAD_IMAGE:
                {
                    ...
                    GameObject obj3 = widget.get_transform().Find("pnlAutoRefresh/pnlRefreshTime/Text").get_gameObject();
                    GameObject obj4 = widget.get_transform().Find("pnlManualRefresh/btnRefresh").get_gameObject();
                    DateTime time2 = new DateTime(0x7b2, 1, 1, 0, 0, 0, DateTimeKind.Utc).AddSeconds((double) CRoleInfo.GetCurrentUTCTime());
                    Text text = obj3.GetComponent<Text>();
                    CUITimerScript script = widget.get_transform().Find("pnlAutoRefresh/timerAutoRefresh/timer").GetComponent<CUITimerScript>();
                    ...
                    if (!(nextAutoRefreshTime == DateTime.MinValue))
                    {
                        ...
                        script.StartTimer();
                        text.set_text(Singleton<CTextManager>.GetInstance().GetText("Shop_Next_Refresh_Time_Prefix") + " <color=#f5be17>" + nextAutoRefreshTime.ToString("HH:mm") + "</color>");
                ...
                {
                    GameObject obj5 = this.m_ShopForm.get_transform().Find("pnlShop/pnlInfo/timerMisteryAvailable").get_gameObject();
                    CUITimerScript script2 = obj5.get_transform().Find("timer").get_gameObject().GetComponent<CUITimerScript>();
            ...
            component.set_text(Singleton<CTextManager>.GetInstance().GetText("Shop_Today_Left_Cnt", args));
        }
        ...
        private void RefreshReturnToShopEntry()
        {
            if (this.m_CurShopType == RES_SHOP_TYPE.RES_SHOPTYPE_MYSTERY)
            {
                ...
                {
                    this.m_ShopForm.get_transform().Find("pnlShop/imgReturnToShop").get_gameObject().CustomSetActive(true);
                }
                else
                {
                    this.m_ShopForm.get_transform().Find("pnlShop/imgReturnToShop").get_gameObject().CustomSetActive(false);
                }
            }
        }
        ...
        public void RefreshShopItemsPanel()
        {
            if ((this.m_ShopForm != null) && this.m_IsShopFormOpen)
            {
                ...
                if (widget != null)
                {
                    CUIListScript component = widget.get_transform().FindChild("List").GetComponent<CUIListScript>();
                    if (component != null)
                    {
                        CUIListElementScript listElementScript = null;
                        byte amount = 0;
                        ...
                        {
                            amount = Convert.ToByte(Math.Ceiling((double) (((double) this.m_ShopItems[(uint) this.m_CurShopType].Length) / 6.0)));
                        }
                        if (amount <= 1)
                        {
                            GameObject obj3 = component.get_transform().FindChild("Scrollbar").get_gameObject();
                            if (obj3 != null)
                            {
                                obj3.CustomSetActive(false);
                            }
                        ...
                        {
                            GameObject obj4 = component.get_transform().FindChild("Scrollbar").get_gameObject();
                            if (obj4 != null)
                            {
                                obj4.CustomSetActive(true);
                            }
        ...
        public void RefreshTopBar()
        {
            if (this.m_ShopForm != null)
            {
                ...
                if (widget != null)
                {
                    ...
                    GameObject obj3 = transform.FindChild("Coin").get_gameObject();
                    GameObject obj4 = transform.FindChild("Gold").get_gameObject();
                    GameObject obj5 = transform.FindChild("PvpCoin").get_gameObject();
                    GameObject obj6 = transform.FindChild("BurningCoin").get_gameObject();
                    GameObject obj7 = transform.FindChild("ArenaCoin").get_gameObject();
                    GameObject obj8 = transform.FindChild("GuildConstruct").get_gameObject();
                    Text component = null;
                    switch (this.m_CurShopType)
                    {
                        case RES_SHOP_TYPE.RES_SHOPTYPE_FIXED:
                        case RES_SHOP_TYPE.RES_SHOPTYPE_MYSTERY:
                            widget.CustomSetActive(true);
                            obj3.CustomSetActive(true);
                            component = obj3.get_transform().FindChild("Text").GetComponent<Text>();
                            if (component != null)
                            {
                                component.set_text(this.GetCoinString(Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo().GoldCoin));
                            }
                            obj4.CustomSetActive(true);
                            component = obj4.get_transform().FindChild("Text").GetComponent<Text>();
                            if (component != null)
                            {
                                component.set_text(this.GetCoinString(Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo().GoldCoin));
                            }
                            obj5.CustomSetActive(true);
                            component = obj5.get_transform().FindChild("Text").GetComponent<Text>();
                            if (component != null)
                            {
                                component.set_text(this.GetCoinString(Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo().GoldCoin));
                            }
                        ...
                        case RES_SHOP_TYPE.RES_SHOPTYPE_BURNING:
                            ...
                            obj5.CustomSetActive(false);
                            obj6.CustomSetActive(true);
                            component = obj6.get_transform().FindChild("Text").GetComponent<Text>();
                            if (component != null)
                            {
                                component.set_text(this.GetCoinString(Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo().BurningCoin));
                            }
                            obj7.CustomSetActive(false);
                            obj8.CustomSetActive(false);
                            break;
                        ...
                        case RES_SHOP_TYPE.RES_SHOPTYPE_ARENA:
                            ...
                            obj6.CustomSetActive(false);
                            obj7.CustomSetActive(true);
                            component = obj7.get_transform().FindChild("Text").GetComponent<Text>();
                            if (component != null)
                            {
                                component.set_text(this.GetCoinString(Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo().ArenaCoin));
                            }
                            obj8.CustomSetActive(false);
                            break;
                        ...
                        case RES_SHOP_TYPE.RES_SHOPTYPE_GUILD_HEAD_IMAGE:
                            ...
                            obj7.CustomSetActive(false);
                            obj8.CustomSetActive(true);
                            component = obj8.get_transform().FindChild("Text").GetComponent<Text>();
                            if (component != null)
                            {
                                component.set_text(this.GetCoinString(CGuildHelper.GetPlayerGuildConstruct()));
                            }
                            break;
                    }
                }
        ...
        private void SetItemInfo(GameObject item, ref stShopItemInfo info, int slotOffset)
        {
            ...
            GameObject obj2 = transform.Find("itemCell").get_gameObject();
            GameObject obj3 = transform.Find("txtName").get_gameObject();
            GameObject obj4 = transform.Find("pnlPrice").get_gameObject();
            Transform transform2 = obj4.get_transform();
            GameObject obj5 = transform.Find("pnlLock").get_gameObject();
            GameObject obj6 = transform2.Find("imgCoin").get_gameObject();
            GameObject obj7 = transform2.Find("imgGold").get_gameObject();
            GameObject obj8 = transform2.Find("imgPvp").get_gameObject();
            GameObject obj9 = transform2.Find("imgBurning").get_gameObject();
            GameObject obj10 = transform2.Find("imgArena").get_gameObject();
            GameObject obj11 = transform2.Find("imgGuild").get_gameObject();
            GameObject obj12 = transform.Find("pnlDiscount").get_gameObject();
            GameObject obj13 = transform.Find("imgNormal").get_gameObject();
            GameObject obj14 = transform.Find("imgGray").get_gameObject();
            GameObject obj15 = transform.Find("imgSoldOut").get_gameObject();
            GameObject obj16 = transform.Find("pnlStatus").get_gameObject();
            Transform transform3 = obj12.get_transform();
            CRoleInfo masterRoleInfo = Singleton<CRoleInfoManager>.instance.GetMasterRoleInfo();
            ...
            if (itemUseable != null)
            {
                ...
                info.sName = name;
                text3.set_text(info.fPrice.ToString("N0"));
                switch (info.enCostType)
                {
                    case RES_SHOPBUY_COINTYPE.RES_SHOPBUY_TYPE_COUPONS:
                        if (masterRoleInfo.DianQuan >= info.fPrice)
                        {
                            text3.set_color(new Color(1f, 0.91f, 0.45f, 1f));
                            break;
                        }
                        text3.set_color(new Color(1f, 0.4f, 0.4f, 1f));
                        break;
                ...
                if (info.isSoldOut)
                {
                    text3.set_color(new Color(0.7176f, 0.7176f, 0.7176f, 1f));
                ...
                else
                {
                    ...
                    obj2.CustomSetActive(true);
                    obj3.CustomSetActive(true);
                    CUICommonSystem.SetItemCell(item.GetComponent<CUIEventScript>().m_belongedFormScript, obj2, itemUseable, false, false, false, false);
                }
                if (info.wSaleDiscount != 100)
                {
                    obj12.CustomSetActive(true);
                    text2.set_text(((((float) info.wSaleDiscount) / 10f)).ToString("F1") + Singleton<CTextManager>.GetInstance().GetText("Shop_Discount"));
                }
                else
                {
        ...
        {
            Text component = lockPanel.get_transform().Find("txtUnlockTip").GetComponent<Text>();
            if (this.m_CurShopType == RES_SHOP_TYPE.RES_SHOPTYPE_GUILD)
            {
                ...
                component.set_text(Singleton<CTextManager>.GetInstance().GetText("Shop_Guild_Item_Shop_Unlock_Tip", args));
            }
            else if (this.m_CurShopType == RES_SHOP_TYPE.RES_SHOPTYPE_GUILD_HEAD_IMAGE)
            {
                ...
                component.set_text(Singleton<CTextManager>.GetInstance().GetText("Shop_Guild_Head_Image_Shop_Unlock_Tip", textArray2));
            }
        }
        ...
        private void SetPageItems(CUIListElementScript listElementScript, byte page)
        {
            ...
            GameObject obj2 = listElementScript.get_gameObject();
            byte num3 = 0;
            while (slotOffset < num2)
            {
                Transform transform = obj2.get_transform().FindChild("pnlItem" + num3);
        ...
        {
            Transform transform = listElementScript.get_gameObject().get_transform();
            GameObject itemCell = transform.Find("itemCell").get_gameObject();
            Text component = transform.Find("txtName").GetComponent<Text>();
            ...
            if (itemUseable != null)
            {
                ...
                text2.set_text("\x00d7" + info.wItemCnt);
                uint num2 = 0;
                num2 = info.wItemCnt * dwCoinSale;
                info.fPrice = num2;
                CUICommonSystem.SetItemCell(listElementScript.m_belongedFormScript, itemCell, itemUseable, false, false, false, false);
            }
        }
        ...
        [CompilerGenerated]
        private sealed class <GetCost>c__AnonStorey71
        {
            internal int refreshCnt;
            internal RES_SHOP_TYPE shopType;

            internal bool <>m__81(ResShopRefreshCost x)
            {
