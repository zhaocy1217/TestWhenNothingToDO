namespace Assets.Scripts.GameSystem
{
    ...
    public class SkillButton
    {
        ...
        public Vector3 m_skillIndicatorFixedPosition = Vector3.get_zero();
        ...
        public GameObject GetAnimationCD()
        {
            ...
            Transform transform = this.m_button.get_transform().Find("Present/Panel_CD");
        ...
        public GameObject GetAnimationPresent()
        {
            ...
            Transform transform = this.m_button.get_transform().Find("Present");
        ...
        public GameObject GetDisableButton()
        {
            ...
            Transform transform = this.m_button.get_transform().Find("disable");
        ...
        public GameObject GetLearnSkillButton()
        {
            ...
            Transform transform = this.m_button.get_transform().Find("LearnBtn");
        ...
        public GameObject GetSkillFrameImg()
        {
            ...
            string str = "Present/SkillFrame";
            Transform transform = this.m_button.get_transform().Find(str);
        ...
        public GameObject GetSkillLvlImg(int iSkillLvl)
        {
            ...
            Transform transform = animationPresent.get_transform().Find(skillLvlImgName[iSkillLvl - 1]);
            DebugHelper.Assert(transform != null, "GetSkillLvlImg failed GetDisableButton");
            return ((transform == null) ? null : transform.get_gameObject());
        }
    }
