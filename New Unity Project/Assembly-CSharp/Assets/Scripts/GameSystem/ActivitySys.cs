namespace Assets.Scripts.GameSystem
{
    ...
    public class ActivitySys : Singleton<ActivitySys>
    {
        ...
        public override void Init()
        {
            ...
            Singleton<EventRouter>.GetInstance().AddEventHandler(EventID.GLOBAL_REFRESH_TIME, new Action(null, (IntPtr) OnResetAllExchangeCount));
            for (int i = 0; i < 3; i++)
            {
        ...
        public static bool NeedShowWhenLogin()
        {
            ...
            {
                string str = string.Format("{0}_{1}", "TODAY_LOGIN_SHOW_ACTIVITY_CNT", masterRoleInfo.playerUllUID);
                if (masterRoleInfo.bFirstLoginToday)
                {
                    PlayerPrefs.SetInt(str, 0);
                }
                uint @int = (uint) PlayerPrefs.GetInt(str, 0);
        ...
        public static void OnResetAllExchangeCount()
        {
            ...
            {
                <>f__am$cacheE = new Func<Activity, bool>(null, (IntPtr) <OnResetAllExchangeCount>m__2A);
            }
            ListView<Activity> activityList = Singleton<ActivitySys>.GetInstance().GetActivityList(<>f__am$cacheE);
            ...
            {
                <>f__am$cacheF = new Func<Activity, bool>(null, (IntPtr) <OnResetAllExchangeCount>m__2B);
            }
            ListView<Activity> view2 = Singleton<ActivitySys>.GetInstance().GetActivityList(<>f__am$cacheF);
        ...
        public static void OnResExchange(CSPkg msg)
        {
            ...
            if (msg.stPkgData.stWealExchangeRes.dwWealID != 0)
            {
                ...
                if (msg.stPkgData.stWealExchangeRes.bWealType == 4)
                {
                    ...
                    if (activity != null)
                    {
                        activity.IncreaseExchangeCount(msg.stPkgData.stWealExchangeRes.bWealIdx, msg.stPkgData.stWealExchangeRes.dwDrawCnt);
                        activity.UpdateView();
                    }
                }
                else if (msg.stPkgData.stWealExchangeRes.bWealType == 5)
                {
                    ...
                    if (activity2 != null)
                    {
                        activity2.IncreaseExchangeCount(msg.stPkgData.stWealExchangeRes.bWealIdx, msg.stPkgData.stWealExchangeRes.dwDrawCnt);
                        activity2.UpdateView();
                    }
                }
            }
            ...
            if (activity != null)
            {
                if (rspPkg.iResult == 0)
                {
                    ...
                    if (rspPkg.stReward.bNum > 0)
                    {
                        ...
                        {
                            useableListFromReward[i].m_stackMulti = CUseable.GetMultipleValue(rspPkg.stMultipleInfo, 1) / 0x2710;
                        }
        ...
        public void StartTimer()
        {
            ...
            if (this._refreshTimer == 0)
            {
                ...
                DateTime time3 = new DateTime(time2.Year, time2.Month, time2.Day, 0, Random.Range(5, 60), Random.Range(0, 60));
        ...
        public override void UnInit()
        {
            ...
            Singleton<EventRouter>.GetInstance().RemoveEventHandler(EventID.GLOBAL_REFRESH_TIME, new Action(null, (IntPtr) OnResetAllExchangeCount));
        }
        ...
        public static void UpdateLoginShowCnt()
        {
            ...
            if (masterRoleInfo != null)
            {
                string str = string.Format("{0}_{1}", "TODAY_LOGIN_SHOW_ACTIVITY_CNT", masterRoleInfo.playerUllUID);
                uint @int = (uint) PlayerPrefs.GetInt(str, 0);
                PlayerPrefs.SetInt(str, (int) (++@int));
                PlayerPrefs.Save();
            }
        }
