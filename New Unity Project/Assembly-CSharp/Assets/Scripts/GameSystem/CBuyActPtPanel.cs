namespace Assets.Scripts.GameSystem
{
    ...
    internal class CBuyActPtPanel : CBuyPanelBase
    {
        ...
        {
            base.initPanel(form);
            this.m_content = base.m_FormScript.get_transform().Find("Content").GetComponent<Text>();
        ...
        private void RefreshUI()
        {
            if (base.bOpen && !base.bShopping)
            {
                if (!base.bTimesOut)
                {
                    ...
                    this.m_content.set_text(Singleton<CTextManager>.GetInstance().GetText("BuyAct_Confirm", args));
                }
                else
                {
