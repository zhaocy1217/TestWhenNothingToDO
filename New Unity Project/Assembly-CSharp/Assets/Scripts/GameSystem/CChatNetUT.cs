namespace Assets.Scripts.GameSystem
{
    ...
    public class CChatNetUT
    {
        ...
        {
            CSPkg msg = NetworkModule.CreateDefaultCSPKG(0x8f1);
            msg.stPkgData.stGetGuildRecruitReq.dwStartTime = startTime;
        ...
        {
            CSPkg msg = NetworkModule.CreateDefaultCSPKG(0x514);
            msg.stPkgData.stChatReq.stChatMsg.bType = 11;
            msg.stPkgData.stChatReq.stChatMsg.stContent.select(11L);
            msg.stPkgData.stChatReq.stChatMsg.stContent.stGuildTeam.szContent = UT.String2Bytes(text);
            Singleton<NetworkModule>.GetInstance().SendLobbyMsg(ref msg, false);
        }
