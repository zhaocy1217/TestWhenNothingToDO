namespace Assets.Scripts.GameSystem
{
    ...
    public class UrlAction
    {
                ...
                case Action.buy:
                    switch (this.prodType)
                    {
                        ...
                        case COM_ITEM_TYPE.COM_OBJTYPE_HERO:
                        {
                            ...
                            uiEvent.m_eventID = enUIEventID.HeroInfo_OpenBuyHeroForm;
                        ...
                        case COM_ITEM_TYPE.COM_OBJTYPE_HEROSKIN:
                        {
                            ...
                            event3.m_eventID = enUIEventID.HeroSkin_OpenBuySkinForm;
        ...
        public static ListView<UrlAction> ParseFromText(string text, char[] spliter = new char[]())
        {
