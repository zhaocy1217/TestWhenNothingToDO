namespace Assets.Scripts.GameSystem
{
    ...
    internal class CSysDynamicBlock
    {
        ...
        [CompilerGenerated]
        private static bool <bChatPayBlock>k__BackingField;
        [CompilerGenerated]
        private static bool <bDialogBlock>k__BackingField;
        [CompilerGenerated]
        private static bool <bFriendBlocked>k__BackingField;
        [CompilerGenerated]
        private static bool <bJifenHallBlock>k__BackingField;
        [CompilerGenerated]
        private static bool <bLobbyEntryBlocked>k__BackingField;
        [CompilerGenerated]
        private static bool <bOperationBlock>k__BackingField;
        [CompilerGenerated]
        private static bool <bSocialBlocked>k__BackingField;
        [CompilerGenerated]
        private static bool <bUnfinishBlock>k__BackingField;
        [CompilerGenerated]
        private static bool <bVipBlock>k__BackingField;
