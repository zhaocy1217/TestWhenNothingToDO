namespace Assets.Scripts.GameSystem
{
    ...
    public class CMallRecommendController : Singleton<CMallRecommendController>
    {
        ...
        private void HeroSelect_Skill_Down(CUIEvent uiEvent)
        {
            ...
            {
                GameObject p = Utility.FindChild(mallForm.get_gameObject(), "pnlBodyBg/pnlRecommend/heroInfo/Panel_SkillTip");
                if (p != null)
                {
                    ...
                    CUICommonSystem.RefreshSkillLevelUpProperty(Utility.FindChild(p, "SkillPropertyInfo"), ref uiEvent.m_eventParams.skillPropertyDesc, uiEvent.m_eventParams.skillSlotId);
                    ...
                    if (skillEffect != null)
                    {
                        for (int i = 1; i <= 2; i++)
                        {
                            GameObject obj4 = Utility.FindChild(p, string.Format("skillNameText/EffectNode{0}", i));
                            if (obj4 != null)
                            {
        ...
        private void HeroSelect_Skill_Up(CUIEvent uiEvent)
        {
            ...
            if ((mallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
            {
                Utility.FindChild(mallForm.get_gameObject(), "pnlBodyBg/pnlRecommend/heroInfo/Panel_SkillTip").CustomSetActive(false);
            }
        }
        ...
        public void InitElements()
        {
            ...
            if ((mallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
            {
                Utility.FindChild(mallForm.get_gameObject(), "pnlBodyBg/pnlRecommend").CustomSetActive(true);
                Utility.FindChild(mallForm.get_gameObject(), "UIScene_Recommend_HeroInfo").CustomSetActive(true);
            }
        }
            ...
            if (form != null)
            {
                ...
                else
                {
                    ...
                    for (int k = 0; k < strArray.Length; k++)
                    {
                        ...
                        if (elemenet != null)
                        {
                            elemenet.get_gameObject().get_transform().Find("Text").GetComponent<Text>().set_text(strArray[k]);
                        }
                    }
        ...
        private void InitRecommendTab()
        {
            ...
            if ((mallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
            {
                ...
                CUIListScript componetInChild = Utility.GetComponetInChild<CUIListScript>(mallForm.get_gameObject(), "pnlBodyBg/pnlRecommend/Tab");
                if (componetInChild == null)
                {
                    Singleton<CUIManager>.GetInstance().OpenTips("list err", false, 1.5f, null, new object[0]);
                    Singleton<CUIManager>.GetInstance().CloseForm(Singleton<CMallSystem>.GetInstance().sMallFormPath);
        ...
        private void OnItemAdd()
        {
            ...
            if ((mallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
            {
                ...
                {
                    case Tab.Hero:
                        this.UpdateExchangeCouponsInfo(mallForm, mallForm.get_transform().Find("pnlBodyBg/pnlRecommend/rewardBody/Status/GameObject"), enExchangeType.HeroExchangeCoupons);
                        break;

                    case Tab.Skin:
                        this.UpdateExchangeCouponsInfo(mallForm, mallForm.get_transform().Find("pnlBodyBg/pnlRecommend/rewardBody/Status/GameObject"), enExchangeType.SkinExchangeCoupons);
                        goto Label_0079;
                }
            }
        Label_0079:
            script2 = Singleton<CUIManager>.GetInstance().GetForm(sMallHeroExchangeListPath);
            if (script2 != null)
            {
                switch (this.CurListTab)
                {
                    case ListTab.Hero:
                        this.UpdateExchangeCouponsInfo(script2, script2.get_transform().Find("Panel/pnlTotalMoney"), enExchangeType.HeroExchangeCoupons);
                        break;

                    case ListTab.Skin:
                        this.UpdateExchangeCouponsInfo(script2, script2.get_transform().Find("Panel/pnlTotalMoney"), enExchangeType.SkinExchangeCoupons);
                        return;
                }
            }
        }
        ...
        private void OnMallTabChange()
        {
            ...
            if ((mallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
            {
                ...
                this.Clear();
                Utility.FindChild(mallForm.get_gameObject(), "UIScene_Recommend_HeroInfo").CustomSetActive(false);
            }
        }
        ...
        Label_00D6:
            event2 = Singleton<CUIEventManager>.GetInstance().GetUIEvent();
            event2.m_eventID = enUIEventID.HeroView_ConfirmBuyHero;
            event2.m_eventParams.heroId = heroId;
        }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            CUICommonSystem.SetHeroItemImage(srcFormScript, transform2.get_gameObject(), StringHelper.UTF8BytesToString(ref this.m_CurrentRecommendHeros[srcWidgetIndexInBelongedList].szImagePath), enHeroHeadType.enBust, false, true);
                            CUICommonSystem.SetHeroJob(srcFormScript, root, (enHeroJobType) info.bMainJob);
                            transform2.Find("heroDataPanel/heroNamePanel/heroNameText").GetComponent<Text>().set_text(StringHelper.UTF8BytesToString(ref info.szName));
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if ((componetInChild != null) && (text3 != null))
                                        {
                                            ...
                                            if (shop != null)
                                            {
                                                text3.set_text(shop.dwBuyItemCnt.ToString());
                                            }
                                            transform3.get_gameObject().CustomSetActive(true);
                                            text2.set_text(Singleton<CTextManager>.GetInstance().GetText("Exchange_Btn"));
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            CUICommonSystem.SetHeroItemImage(srcFormScript, transform2.get_gameObject(), skin.szSkinPicID, enHeroHeadType.enBust, false, true);
                            CUICommonSystem.SetHeroSkinLabelPic(uiEvent.m_srcFormScript, transform2.Find("skinLabelImage").get_gameObject(), skin.dwHeroID, skin.dwSkinID);
                            ResHeroCfgInfo dataByKey = GameDataMgr.heroDatabin.GetDataByKey(skin.dwHeroID);
                            if (dataByKey != null)
                            {
                                component.set_text(dataByKey.szName);
                            }
                            text2.set_text(skin.szSkinName);
                            ...
                            else
                            {
                                ...
                                script3.set_enabled(false);
                                button.set_enabled(false);
                                GameObject obj3 = Utility.FindChild(transform2.get_gameObject(), "heroDataPanel/heroPricePanel");
                                if (obj3 == null)
                                {
                                ...
                                else
                                {
                                    ...
                                    {
                                        obj4.CustomSetActive(masterRoleInfo.IsValidExperienceSkin(skin.dwHeroID, skin.dwSkinID));
                                        ...
                                        else
                                        {
                                            ...
                                            if ((componetInChild != null) && (text4 != null))
                                            {
                                                ...
                                                if (shop != null)
                                                {
                                                    text4.set_text(shop.dwBuyItemCnt.ToString());
                                                }
                                                script3.set_enabled(true);
                                                transform4.get_gameObject().CustomSetActive(true);
                                                text3.set_text(Singleton<CTextManager>.GetInstance().GetText("Exchange_Btn"));
                                                button.set_enabled(true);
                                                stUIEventParams params2 = new stUIEventParams();
                                                params2.tag = 2;
                                                if (shop != null)
        ...
        private void Refresh3DModel(uint heroID, int skinId)
        {
            ...
            if ((mallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
            {
                GameObject obj2 = Utility.FindChild(mallForm.get_gameObject(), "pnlBodyBg/pnlRecommend/heroInfo/3DImage");
        ...
        private void RefreshHeroBaseInfo(ResHeroCfgInfo heroCfg)
        {
            ...
            if ((mallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
            {
                GameObject p = Utility.FindChild(mallForm.get_gameObject(), "pnlBodyBg/pnlRecommend/heroInfo/heroInfoPanel");
                if (p != null)
                {
                    Text component = p.get_transform().Find("heroNameText").GetComponent<Text>();
                    Utility.FindChild(p, "heroTitleText").CustomSetActive(false);
                    GameObject root = p.get_transform().Find("jobImage").get_gameObject();
                    IHeroData data = CHeroDataFactory.CreateHeroData(heroCfg.dwCfgID);
                    if (root != null)
                    {
                        CUICommonSystem.SetHeroJob(mallForm, root, (enHeroJobType) data.heroType);
                    }
                    if (component != null)
                    {
        ...
        private void RefreshHeroPricePnl(ResHeroCfgInfo heroCfg)
        {
            ...
            if ((mallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
            {
                GameObject obj2 = Utility.FindChild(mallForm.get_gameObject(), "pnlBodyBg/pnlRecommend/heroInfo/pricePanel/coinBuy");
                GameObject obj3 = Utility.FindChild(mallForm.get_gameObject(), "pnlBodyBg/pnlRecommend/heroInfo/pricePanel/diamondBuy");
                GameObject obj4 = Utility.FindChild(mallForm.get_gameObject(), "pnlBodyBg/pnlRecommend/heroInfo/pricePanel/couponsBuy");
                GameObject obj5 = Utility.FindChild(mallForm.get_gameObject(), "pnlBodyBg/pnlRecommend/heroInfo/pricePanel/exchangeBuy");
                GameObject obj6 = Utility.FindChild(mallForm.get_gameObject(), "pnlBodyBg/pnlRecommend/heroInfo/pricePanel/linkBtnContainer");
                GameObject obj7 = Utility.FindChild(mallForm.get_gameObject(), "pnlBodyBg/pnlRecommend/heroInfo/pricePanel/owned");
                ...
                else
                {
                    ...
                    for (int i = 0; i < payInfoSetOfGood.m_payInfoCount; i++)
                    {
                        ...
                        if (obj8 != null)
                        {
                            Transform transform = obj8.get_transform().Find("BuyButton");
                            if (transform != null)
                            {
                                stUIEventParams eventParams = new stUIEventParams();
                                eventParams.tag = (int) info.m_payType;
                                eventParams.commonUInt32Param1 = info.m_payValue;
                    ...
                    if (obj5 != null)
                    {
                        ...
                        if (shop != null)
                        {
                            ...
                            Transform transform2 = obj5.get_transform().Find("BuyButton");
                            stUIEventParams params2 = new stUIEventParams();
                            params2.tag = 1;
                            params2.commonUInt32Param1 = exchangeValue;
        ...
        private void RefreshPoolView()
        {
            ...
            GameObject obj2 = Utility.FindChild(mallForm.get_gameObject(), "pnlBodyBg/pnlRecommend/rewardBody/List");
            if (obj2 == null)
            {
                return;
            }
        ...
        Label_00A5:
            ...
            for (int i = 0; i < num; i++)
            {
                ...
                {
                    GameObject itemCell = Utility.FindChild(elemenet.get_gameObject(), "itemCell");
                    if (itemCell != null)
                    {
                        CUICommonSystem.SetItemCell(mallForm, itemCell, itemUseable, false, false, false, false);
            ...
            info2.m_payType = CMallSystem.ResBuyTypeToPayType(info.bCostType);
            info2.m_payValue = info.dwCostPrice;
            Transform transform = mallForm.get_transform().Find("pnlBodyBg/pnlRecommend/rewardBody/BuyButton");
            stUIEventParams eventParams = new stUIEventParams();
        ...
        private void RefreshRecommendList(enExchangeType type)
        {
            ...
            if (form != null)
            {
                ...
                GameObject obj3 = Utility.FindChild(form.get_gameObject(), "Panel/SkinList");
        ...
        {
            <RefreshRecommendListPnl>c__AnonStorey60 storey = new <RefreshRecommendListPnl>c__AnonStorey60();
            CUIFormScript form = Singleton<CUIManager>.GetInstance().GetForm(sMallHeroExchangeListPath);
            if (form != null)
            {
                ...
                if (storey.role != null)
                {
                    ...
                    {
                        case ListTab.Hero:
                            this.m_CurrentRecommendHeros.Sort(new Comparison<ResHeroCfgInfo>(storey.<>m__58));
                            this.RefreshRecommendList(enExchangeType.HeroExchangeCoupons);
                            this.UpdateExchangeCouponsInfo(form, form.get_transform().Find("Panel/pnlTotalMoney"), enExchangeType.HeroExchangeCoupons);
                            break;

                        case ListTab.Skin:
                            this.m_CurrentRecommendSkins.Sort(new Comparison<ResHeroSkin>(storey.<>m__59));
                            this.RefreshRecommendList(enExchangeType.SkinExchangeCoupons);
                            this.UpdateExchangeCouponsInfo(form, form.get_transform().Find("Panel/pnlTotalMoney"), enExchangeType.SkinExchangeCoupons);
                            return;
                    }
                }
            }
        ...
        private void RefreshSkillPanel(ResHeroCfgInfo heroCfg)
        {
            ...
            if ((mallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
            {
                GameObject obj2 = Utility.FindChild(mallForm.get_gameObject(), "pnlBodyBg/pnlRecommend/heroInfo/SkillList");
                obj2.CustomSetActive(true);
                ...
                else
                {
                    ...
                    if (data != null)
                    {
                        ...
                        for (int i = 0; i < (skillArr.Length - 1); i++)
                        {
                            ...
                            GameObject p = component.GetElemenet(i).get_transform().Find("heroSkillItemCell").get_gameObject();
                            if (p != null)
                            {
                                ResSkillCfgInfo skillCfgInfo = CSkillData.GetSkillCfgInfo(skillArr[i].iSkillID);
                                CUIEventScript script4 = p.GetComponent<CUIEventScript>();
                                ...
                                CUIUtility.SetImageSprite(image, prefabPath, elemenet.m_belongedFormScript, false, true, true, false);
                                obj4.CustomSetActive(true);
                                stUIEventParams eventParams = new stUIEventParams();
                                ...
                                eventParams.skillTipParam.skillEnergyCost = (i != 0) ? Singleton<CTextManager>.instance.GetText(EnergyCommon.GetEnergyShowText(heroCfg.dwEnergyType, EnergyShowType.CostValue), new string[] { ((int) skillCfgInfo.iEnergyCost).ToString() }) : string.Empty;
        ...
        private void RefreshSkinBaseInfo(ResHeroSkin skinCfg)
        {
            ...
            if ((mallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
            {
                ...
                if (p != null)
                {
                    ...
                    if (component != null)
                    {
                        component.set_text(string.Format("{0} {1}", data.heroName, StringHelper.UTF8BytesToString(ref skinCfg.szSkinName)));
                    }
                }
            }
        }
        ...
        private void RefreshSkinPricePnl(ResHeroSkin skinCfg)
        {
            ...
            if ((mallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
            {
                ...
                else
                {
                    ...
                    GameObject obj4 = Utility.FindChild(mallForm.get_gameObject(), "pnlBodyBg/pnlRecommend/heroInfo/pricePanel/couponsBuy");
                    GameObject obj5 = Utility.FindChild(mallForm.get_gameObject(), "pnlBodyBg/pnlRecommend/heroInfo/pricePanel/exchangeBuy");
                    GameObject obj6 = Utility.FindChild(mallForm.get_gameObject(), "pnlBodyBg/pnlRecommend/heroInfo/pricePanel/owned");
                    GameObject obj7 = Utility.FindChild(mallForm.get_gameObject(), "pnlBodyBg/pnlRecommend/heroInfo/pricePanel/linkBtnContainer");
                    obj2.CustomSetActive(false);
                    obj3.CustomSetActive(false);
                    obj4.CustomSetActive(false);
                    obj5.CustomSetActive(false);
                    ...
                    else
                    {
                        ...
                        for (int i = 0; i < payInfoSetOfGood.m_payInfoCount; i++)
                        {
                            ...
                            if (obj8 != null)
                            {
                                ...
                                {
                                    stUIEventParams params2 = new stUIEventParams();
                                    params2.tag = (int) info2.m_payType;
                                    params2.commonUInt32Param1 = info2.m_payValue;
                        ...
                        if (obj5 != null)
                        {
                            ...
                            if (shop != null)
                            {
                                ...
                                params3.tag = 2;
                                params3.commonUInt32Param1 = exchangeValue;
        ...
        private void RefreshTimerView(Transform pnlRefreshTrans)
        {
            if (pnlRefreshTrans != null)
            {
                ...
                CUITimerScript componetInChild = Utility.GetComponetInChild<CUITimerScript>(pnlRefreshTrans.get_gameObject(), "refreshTimer");
                int num2 = this.m_MostRecentRecommendRefreshTime - ((int) currentUTCTime);
                if ((num2 > 0) && (componetInChild != null))
                {
                    pnlRefreshTrans.get_gameObject().CustomSetActive(true);
                    componetInChild.SetTotalTime((float) num2);
                    componetInChild.ReStartTimer();
                }
                else
                {
                    pnlRefreshTrans.get_gameObject().CustomSetActive(false);
                }
            }
        }
        ...
        public void SetExchangeButton(CUIFormScript formScript, RectTransform buttonTransform, enExchangeType exchangeType, uint exchangeValue, enUIEventID eventID, ref stUIEventParams eventParams)
        {
            if (((formScript != null) && (buttonTransform != null)) && (exchangeValue != 0))
            {
                ...
                if (transform != null)
                {
                    ...
                    if (image != null)
                    {
                        image.SetSprite(this.GetExchangeTypeIconPath(exchangeType), formScript, true, false, false, false);
                    }
                }
                ...
                if (transform2 != null)
                {
                    ...
                    if (text != null)
                    {
                        text.set_text(exchangeValue.ToString());
                    }
                }
        ...
        private void UpdateExchangeCouponsInfo(CUIFormScript form, Transform container, enExchangeType exchangeType)
        {
            ...
            {
                Image componetInChild = Utility.GetComponetInChild<Image>(container.get_gameObject(), "Image");
                Text text = Utility.GetComponetInChild<Text>(container.get_gameObject(), "Cnt");
                if ((componetInChild != null) && (text != null))
                {
                    ...
                    text.set_text(GetCurrencyValueFromRoleInfo(masterRoleInfo, exchangeType).ToString());
                }
            }
        }
        ...
        private void UpdateSkinView()
        {
            ...
            if ((mallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
            {
                ...
                Utility.FindChild(mallForm.get_gameObject(), "pnlBodyBg/pnlRecommend/heroInfo/SkillList").CustomSetActive(false);
            }
        }
        ...
        [CompilerGenerated]
        private sealed class <RefreshRecommendListPnl>c__AnonStorey60
        {
            internal CRoleInfo role;

            internal int <>m__58(ResHeroCfgInfo l, ResHeroCfgInfo r)
            {
                bool flag = false;
                bool flag2 = false;
            ...
            internal int <>m__59(ResHeroSkin l, ResHeroSkin r)
            {
                bool flag = false;
                bool flag2 = false;
