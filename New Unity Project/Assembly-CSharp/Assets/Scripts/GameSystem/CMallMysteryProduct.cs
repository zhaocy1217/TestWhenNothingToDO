        ...
        private void UpdateItemPricePnl(CUIFormScript form, Transform pricePnlTrans, Transform tagTrans, ref stPayInfoSet payInfoSet)
        {
            ...
            for (int i = 0; i < payInfoSet.m_payInfoCount; i++)
            {
                ...
                if (!Singleton<CMallMysteryShop>.GetInstance().HasGotDiscount)
                {
                    ...
                    text3.set_text("?折");
                    text2.set_text(info.m_payValue.ToString());
                ...
                else
                {
                    ...
                    {
                        int num3 = (int) num2;
                        text3.set_text(string.Format("{0}折", num3.ToString("D")));
                    }
                    else
                    {
                        text3.set_text(string.Format("{0}折", num2.ToString("0.0")));
                    }
                    obj2.CustomSetActive(true);
                    componetInChild.set_text(info.m_oriValue.ToString());
                    text2.set_text(info.m_payValue.ToString());
                    image.SetSprite(CMallSystem.GetPayTypeIconPath(info.m_payType), form, true, false, false);
                }
            }
                                                                        ...
                                                                        switch (this.m_ItemType)
                                                                        {
                                                                                ...
                                                                                if (dataByKey != null)
                                                                                {
                                                                                    ...
                                                                                    else
                                                                                    {
                                                                                        ...
                                                                                        if (lowestPayInfoSetOfGood.m_payInfoCount == 0)
                                                                                        {
                                                                                            ...
                                                                                            if (shop != null)
                                                                                            {
                                                                                                text4.set_text(StringHelper.UTF8BytesToString(ref shop.szObtWay));
                                                                                            }
                                                                                            else
                                                                                            {
                                                                                                text4.set_text(null);
                                                                                            ...
                                                                                            if ((shop != null) && (shop.bObtWayType > 0))
                                                                                            {
                                                                                                ...
                                                                                                eventParams.tag = shop.bObtWayType;
                                                                                        ...
                                                                                        else
                                                                                        {
                                                                                            ...
                                                                                            this.UpdateItemPricePnl(srcFormScript, obj9.get_transform(), obj5.get_transform(), ref lowestPayInfoSetOfGood);
                                                                                            stUIEventParams params2 = new stUIEventParams();
                                                                                            params2.tag = uiEvent.m_srcWidgetIndexInBelongedList;
                                                                            ...
                                                                            case COM_ITEM_TYPE.COM_OBJTYPE_HEROSKIN:
                                                                            {
                                                                                ...
                                                                                if (heroSkin != null)
                                                                                {
                                                                                    ...
                                                                                    CUICommonSystem.SetHeroItemImage(uiEvent.m_srcFormScript, p.get_gameObject(), heroSkin.szSkinPicID, enHeroHeadType.enBust, false);
                                                                                    ...
                                                                                    else
                                                                                    {
                                                                                        ...
                                                                                        if (payInfoSet.m_payInfoCount == 0)
                                                                                        {
                                                                                            ...
                                                                                            if (shop2 != null)
                                                                                            {
                                                                                                text4.set_text(StringHelper.UTF8BytesToString(ref shop2.szGetPath));
                                                                                            }
                                                                                        }
                                                                                        else
                                                                                        {
                                                                                            obj11.CustomSetActive(false);
                                                                                            this.UpdateItemPricePnl(srcFormScript, obj9.get_transform(), obj5.get_transform(), ref payInfoSet);
                                                                                        }
                                                                                        if (masterRoleInfo.IsCanBuySkinButNotHaveHero(heroSkin.dwHeroID, heroSkin.dwSkinID))
                                                                                        {
                                                                                            obj10.CustomSetActive(true);
                                                                                        ...
                                                                                        else
                                                                                        {
                                                                                            ...
                                                                                            params4.tag = uiEvent.m_srcWidgetIndexInBelongedList;
