namespace Assets.Scripts.GameSystem
{
    ...
    public class PVEReviveHeros : Singleton<PVEReviveHeros>
    {
        ...
        private void InitBuffItem(CUIFormScript formScript, SLevelContext curLevelContext)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                string str = "buffInfoPanel/buffItem" + i;
                GameObject obj2 = this.m_form.get_transform().Find(str).get_gameObject();
                ...
                if (dataByKey != null)
                {
                    ...
                    {
                        Image component = obj2.get_transform().Find("imageIcon").GetComponent<Image>();
                    ...
                    obj2.get_transform().Find("buffNameText").GetComponent<Text>().set_text(StringHelper.UTF8BytesToString(ref dataByKey.szSkillCombineDesc));
                }
            }
        }
        ...
        private void InitFromView(CUIFormScript formScript)
        {
            ...
            if (obj3 != null)
            {
                ...
                if (image != null)
                {
                    image.SetSprite(CMallSystem.GetPayTypeIconPath(this.m_relivePayType), formScript, true, false, false, false);
                }
            }
            ...
            if (obj4 != null)
            {
                ...
                if (text2 != null)
                {
                    text2.set_text(this.m_relivePayValue.ToString());
                }
            }
            GameObject obj5 = this.m_form.get_transform().Find("buffInfoPanel").get_gameObject();
            if (obj5 != null)
            {
                GameObject obj6 = obj5.get_transform().Find("ReviveText/NumText").get_gameObject();
                if (obj6 != null)
                {
                    obj6.GetComponent<Text>().set_text(m_iRemainReviveNum.ToString());
                    CUITimerScript script = obj5.get_transform().Find("Timer").GetComponent<CUITimerScript>();
        ...
        private void OnClickReviveBtn(CUIEvent uiEvent)
        {
            ...
            confirmEventParams.commonUInt32Param1 = (uint) m_iRemainReviveNum;
        ...
        private void UpdateBuffItemChooseStat(int iItemIndex, bool bChoose)
        {
            ...
            {
                string str = "buffInfoPanel/buffItem" + iItemIndex;
                this.m_form.get_transform().Find(str).get_gameObject().get_transform().Find("chooseImage").get_gameObject().CustomSetActive(bChoose);
            }
        }
