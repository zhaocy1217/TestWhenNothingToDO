namespace Assets.Scripts.GameSystem
{
    ...
    public class CVersionUpdateSystem : MonoSingleton<CVersionUpdateSystem>
    {
        ...
        static CVersionUpdateSystem()
        {
            ...
            textArrayArray1[3] = new string[] { "tcp://exp.mtcls.qq.com:10001", "tcp://61.151.234.47:10001", "tcp://182.254.42.103:10001", "tcp://140.207.62.111:10001", "tcp://140.207.123.164:10001", "tcp://117.144.242.28:10001", "tcp://117.144.243.174:10001", "tcp://103.7.30.91:10001", "tcp://101.227.130.79:10001" };
            ...
            textArrayArray1[6] = new string[] { "exp.mtcls.qq.com:10011", "61.151.234.47:10011", "182.254.42.103:10011", "140.207.62.111:10011", "140.207.123.164:10011", "117.144.242.28:10011", "117.144.243.174:10011", "103.7.30.91:10011", "101.227.130.79:10011" };
            textArrayArray1[7] = new string[] { "testa4.mtcls.qq.com:10001", "101.227.153.83:10001" };
            textArrayArray1[8] = new string[] { string.Empty };
            textArrayArray1[9] = new string[] { string.Empty };
            textArrayArray1[10] = new string[] { string.Empty };
        ...
        private static bool Android_IsFileExistInStreamingAssets(string fileName)
        {
            ...
            return s_androidUtilityJavaClass.CallStatic<bool>("IsFileExistInStreamingAssets", objArray1);
        }

        private void CheckAppVersion()
        {
            if (((this.m_appYYBCheckVersionInfoStartTime > 0f) && !this.m_appYYBCheckVersionInfoCallBackHandled) && ((Time.get_realtimeSinceStartup() - this.m_appYYBCheckVersionInfoStartTime) >= 10f))
            {
        ...
        {
            <CheckFirstExtractResource>c__Iterator31 iterator = new <CheckFirstExtractResource>c__Iterator31();
        ...
        private void CreateIIPSVersionMgr(string config)
        {
            ...
            CVersionUpdateCallback callbackImp = new CVersionUpdateCallback();
            callbackImp.m_onGetNewVersionInfoDelegate = (CVersionUpdateCallback.OnGetNewVersionInfoDelegate) Delegate.Combine(callbackImp.m_onGetNewVersionInfoDelegate, new CVersionUpdateCallback.OnGetNewVersionInfoDelegate(this.OnGetNewVersionInfo));
            callbackImp.m_onProgressDelegate = (CVersionUpdateCallback.OnProgressDelegate) Delegate.Combine(callbackImp.m_onProgressDelegate, new CVersionUpdateCallback.OnProgressDelegate(this.OnProgress));
            callbackImp.m_onErrorDelegate = (CVersionUpdateCallback.OnErrorDelegate) Delegate.Combine(callbackImp.m_onErrorDelegate, new CVersionUpdateCallback.OnErrorDelegate(this.OnError));
            callbackImp.m_onSuccessDelegate = (CVersionUpdateCallback.OnSuccessDelegate) Delegate.Combine(callbackImp.m_onSuccessDelegate, new CVersionUpdateCallback.OnSuccessDelegate(this.OnSuccess));
            callbackImp.m_onNoticeInstallApkDelegate = (CVersionUpdateCallback.OnNoticeInstallApkDelegate) Delegate.Combine(callbackImp.m_onNoticeInstallApkDelegate, new CVersionUpdateCallback.OnNoticeInstallApkDelegate(this.OnNoticeInstallApk));
            callbackImp.m_onActionMsgDelegate = (CVersionUpdateCallback.OnActionMsgDelegate) Delegate.Combine(callbackImp.m_onActionMsgDelegate, new CVersionUpdateCallback.OnActionMsgDelegate(this.OnActionMsg));
            this.m_IIPSVersionMgrFactory = new IIPSMobileVersion();
            this.m_IIPSVersionMgr = this.m_IIPSVersionMgrFactory.CreateVersionMgr(callbackImp, config);
        }
                ...
                if (widget != null)
                {
                    ...
                    if ((component != null) && (index >= 0))
                    {
                        ...
                        if (element != null)
                        {
                            ...
                            if (transform != null)
                            {
                                transform.get_gameObject().CustomSetActive(enabled);
                            }
                        }
                    }
                }
        ...
        private string GetSizeString(int size)
        {
            ...
            return string.Format("{0}KB", Mathf.RoundToInt(num2));
        }
        ...
        public void OnError(IIPSMobileVersionCallBack.VERSIONSTAGE curVersionStage, uint errorCode)
        {
            ...
            if (this.IsInUpdateAppStage())
            {
                ...
                IIPSMobileErrorCodeCheck.ErrorCodeInfo info = this.m_iipsErrorCodeChecker.CheckIIPSErrorCode((int) errorCode);
        ...
        private void OpenWaitingForm()
        {
            ...
            if (script != null)
            {
                script.get_transform().Find("Panel/Panel").get_gameObject().CustomSetActive(false);
                script.get_transform().Find("Panel/Image").get_gameObject().CustomSetActive(true);
            }
        }
        ...
        private void SendVersionUpdateReportEvent(DateTime startTime, int versionType, string currentVersion, string updateVersion, bool isSuccessful, uint errorCode, uint totalDownloadSize, uint downloadSize, string downloadUrl)
        {
            ...
            Debug.Log(string.Format("Send \"Service_DownloadEvent\", startTime = {0}, versionType = {1}, currentVersion = {2}, updateVersion = {3}, isSuccessful = {4}, errorCode = {5}, totalDownloadSize = {6}, downloadSize = {7}, downloadUrl = {8}", args));
            ...
            try
            {
                ...
                events.Add(new KeyValuePair<string, string>("openid", string.Empty));
                events.Add(new KeyValuePair<string, string>("begintime", Utility.ToUtcSeconds(startTime).ToString()));
                events.Add(new KeyValuePair<string, string>("versionType", versionType.ToString()));
                events.Add(new KeyValuePair<string, string>("Version", updateVersion));
                events.Add(new KeyValuePair<string, string>("oldversion", currentVersion));
        ...
        private void SetConfirmPanelButton(enVersionUpdateFormWidget widgetIndex, bool active, string textKey, enUIEventID eventID)
        {
            if (this.m_versionUpdateFormScript != null)
            {
                ...
                if (widget != null)
                {
                    ...
                    {
                        Transform transform = widget.get_transform().FindChild("Text");
                        if (transform != null)
                        {
                            Text text = transform.get_gameObject().GetComponent<Text>();
                            if (text != null)
                            {
                                text.set_text(Singleton<CTextManager>.GetInstance().GetText(textKey));
                            }
                        }
                    }
        ...
        public void StartYYBCheckVersionInfo()
        {
            ...
            this.m_appYYBCheckVersionInfoStartTime = Time.get_realtimeSinceStartup();
            this.m_appYYBCheckVersionInfoCallBackHandled = false;
        }
        ...
        private void UpdateUIProgress(enVersionUpdateFormWidget progressBarWidget, enVersionUpdateFormWidget progressPercentTextWidget, float progress)
        {
            ...
            if (text != null)
            {
                text.set_text(string.Format("{0}%", (int) (progress * 100f)));
            }
        }
        ...
        {
            <VersionUpdateComplete>c__Iterator32 iterator = new <VersionUpdateComplete>c__Iterator32();
            iterator.<>f__this = this;
            return iterator;
        }
        ...
        [CompilerGenerated]
        private sealed class <CheckFirstExtractResource>c__Iterator31 : IDisposable, IEnumerator, IEnumerator<object>
        {
            ...
            public bool MoveNext()
            {
                ...
                switch (num)
                {
                    ...
                    case 1:
                        this.<offset>__1 = 0;
                        CResourcePackerInfoSet.ReadVersionAndBuildNumber(this.<www>__0.get_bytes(), ref this.<offset>__1, ref this.<>f__this.m_firstExtractResourceVersion, ref this.<>f__this.m_firstExtractResourceBuildNumber);
        ...
        [CompilerGenerated]
        private sealed class <VersionUpdateComplete>c__Iterator32 : IDisposable, IEnumerator, IEnumerator<object>
        {
            internal object $current;
            internal int $PC;
            internal CVersionUpdateSystem <>f__this;
