namespace Assets.Scripts.GameSystem
{
    ...
    public class CSymbolWearController
    {
        ...
        private bool IsSymbolChangePanelShow(CUIFormScript form)
        {
            ...
            bool flag = false;
            Transform transform = form.get_transform().Find(s_symbolEquipPanel);
            if (transform != null)
            {
                ...
                if (component != null)
                {
                    ...
                    flag = (widget != null) && widget.get_activeSelf();
                }
            }
            return flag;
        }
        ...
        {
            if (Utility.FindChild(form.GetWidget(5), CSymbolSystem.s_symbolEquipPanel) == null)
            {
                return false;
            }
            return true;
        ...
        private void OnChangeSymbolPageName(CUIEvent uiEvent)
        {
            ...
            if (form != null)
            {
                Transform transform = form.get_transform().Find("Panel/inputText");
                CRoleInfo masterRoleInfo = Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo();
        ...
        {
            string str = uiEvent.m_srcFormScript.get_gameObject().get_transform().Find("Panel/inputText/Text").GetComponent<Text>().get_text();
            if (string.IsNullOrEmpty(str) || (str.Length > 6))
            {
                string text = Singleton<CTextManager>.GetInstance().GetText("Symbol_Name_LenError");
                Singleton<CUIManager>.GetInstance().OpenTips(text, false, 1.5f, null, new object[0]);
            }
            else
            {
                SendChgSymbolPageName(this.m_symbolPageIndex, str);
            }
        }
        ...
        private void OnSymbolBagElementEnable(CUIEvent uiEvent)
        {
            ...
            GameObject itemObj = uiEvent.m_srcWidget.get_transform().Find("itemCell").get_gameObject();
            ...
            {
                this.SetSymbolListItem(uiEvent.m_srcFormScript, itemObj, this.m_pageSymbolBagList[srcWidgetIndexInBelongedList]);
            }
        }
            ...
            else
            {
                ...
                if (toSymbol != null)
                {
                    ...
                    else if (this.IsSymbolChangePanelShow(uiEvent.m_srcFormScript))
                    {
                        ...
                        {
                            Transform transform = srcFormScript.get_transform().Find(s_symbolEquipPanel);
                            if (transform != null)
                            {
                                CUIComponent component = transform.GetComponent<CUIComponent>();
                                if (component != null)
        ...
        public void OnSymbolPageDownBtnClick(CUIEvent uiEvent)
        {
            ...
            if (form != null)
            {
                Transform transform = form.GetWidget(1).get_transform().Find("DropList/List");
        ...
        private void OnSymbolPageItemSelect(CUIEvent uiEvent)
        {
            ...
            else
            {
                ...
                if ((elementAmount == masterRoleInfo.m_symbolInfo.m_pageCount) || ((elementAmount > masterRoleInfo.m_symbolInfo.m_pageCount) && (selectedIndex != (elementAmount - 1))))
                {
                    ...
                    widget.get_transform().Find("DropList/Button_Down/Text").GetComponent<Text>().set_text(masterRoleInfo.m_symbolInfo.GetSymbolPageName(this.m_symbolPageIndex));
                    widget.get_transform().Find("DropList/Button_Down/SymbolLevel/Text").GetComponent<Text>().set_text(masterRoleInfo.m_symbolInfo.GetSymbolPageMaxLvl(this.m_symbolPageIndex).ToString());
                }
            }
        }
        ...
        private void RefreshSymbolBag(bool bNoWeatItem)
        {
            ...
            if (form != null)
            {
                Transform transform = form.get_gameObject().get_transform().Find(s_symbolBagPanel);
                ...
                if (transform2 != null)
                {
                    transform2.GetComponent<Text>().set_text(!bNoWeatItem ? Singleton<CTextManager>.GetInstance().GetText("Symbol_Title_SymbolBagList") : Singleton<CTextManager>.GetInstance().GetText("Symbol_Title_NoWear"));
                }
                GameObject obj2 = transform.Find("Panel_BagList/lblTips").get_gameObject();
                ...
                Transform transform3 = form.get_transform().Find(s_symbolEquipPanel);
                if (transform3 != null)
                {
            ...
            if ((null != form) && (fromSymbol != null))
            {
                ...
                if (transform != null)
                {
                    ...
                    if (component != null)
                    {
                        ...
                        if (null != widget)
                        {
                            GameObject symbolPanel = widget.get_transform().Find("symbolFrom").get_gameObject();
                            this.RefreshSymbolInfo(form, symbolPanel, fromSymbol);
                            GameObject obj4 = widget.get_transform().Find("symbolTo").get_gameObject();
        ...
        private void RefreshSymbolInfo(CUIFormScript form, GameObject symbolPanel, CSymbolItem symbol)
        {
            ...
            {
                symbolPanel.get_transform().Find("itemCell/imgIcon").GetComponent<Image>().SetSprite(symbol.GetIconPath(), form, true, false, false, false);
                symbolPanel.get_transform().Find("lblName").GetComponent<Text>().set_text(symbol.m_name);
                CSymbolSystem.RefreshSymbolPropContent(symbolPanel.get_transform().Find("symbolPropPanel").get_gameObject(), symbol.m_baseID);
            }
        }
        ...
        private void RefreshSymbolPage()
        {
            ...
            if (form != null)
            {
                Transform transform = form.get_gameObject().get_transform().Find(s_symbolPagePanel);
                if (transform != null)
                {
                    CRoleInfo masterRoleInfo = Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo();
                    if (masterRoleInfo != null)
                    {
                        ...
                        if (pageSymbolData != null)
                        {
                            for (int i = 0; i < 30; i++)
                            {
                                ...
                                if (transform2 != null)
                                {
                                    this.SetSymbolItem(form, transform2.get_gameObject(), i, pageSymbolData[i]);
                                }
                            }
                            Transform transform3 = form.get_transform().Find(s_symbolEquipPanel);
                            if (transform3 != null)
                            {
                                ...
                                if (component != null)
                                {
                                    component.GetWidget(10).GetComponent<Text>().set_text(masterRoleInfo.m_symbolInfo.GetSymbolPageMaxLvl(this.m_symbolPageIndex).ToString());
                                }
                            }
                        }
                    }
        ...
        private void RefreshSymbolProp()
        {
            ...
            if (form != null)
            {
                ...
                if (transform != null)
                {
                    ...
                    if (component != null)
                    {
                        CSymbolSystem.RefreshSymbolPageProp(component.GetWidget(2).get_transform().Find("propList").get_gameObject(), this.m_symbolPageIndex, true);
                        CSymbolSystem.RefreshSymbolPagePveEnhanceProp(component.GetWidget(3).get_transform().Find("propList").get_gameObject(), this.m_symbolPageIndex);
                    }
                }
            }
        }
        ...
        public void SetPageDropListData(CUIFormScript form, int selectIndex)
        {
            ...
            for (int i = 0; i < masterRoleInfo.m_symbolInfo.m_pageCount; i++)
            {
                ...
                if (elemenet != null)
                {
                    Text text = elemenet.get_gameObject().get_transform().Find("Text").GetComponent<Text>();
                    text.set_text(masterRoleInfo.m_symbolInfo.GetSymbolPageName(i));
                    text.GetComponent<RectTransform>().set_anchoredPosition(s_symbolPos1);
                    ...
                    elemenet.get_gameObject().get_transform().Find("SymbolLevel").get_gameObject().CustomSetActive(true);
                }
            }
            if (nextFreePageLevel > masterRoleInfo.PvpLevel)
            {
                ...
                if (script3 != null)
                {
                    Text text3 = script3.get_gameObject().get_transform().Find("Text").GetComponent<Text>();
                    text3.set_text(string.Format(Singleton<CTextManager>.GetInstance().GetText("Symbol_Free_GetPage"), nextFreePageLevel));
                    text3.GetComponent<RectTransform>().set_anchoredPosition(s_symbolPos2);
                    script3.get_gameObject().get_transform().Find("SymbolLevel").get_gameObject().CustomSetActive(false);
                }
            }
            ...
            widget.get_transform().Find("DropList/Button_Down/Text").GetComponent<Text>().set_text(masterRoleInfo.m_symbolInfo.GetSymbolPageName(this.m_symbolPageIndex));
            widget.get_transform().Find("DropList/Button_Down/SymbolLevel/Text").GetComponent<Text>().set_text(masterRoleInfo.m_symbolInfo.GetSymbolPageMaxLvl(selectIndex).ToString());
        }
        ...
        private void SetSymbolItem(CUIFormScript formScript, GameObject item, int i, ulong objId)
        {
            if ((Singleton<CUIManager>.GetInstance().GetForm(CSymbolSystem.s_symbolFormPath) != null) && (item != null))
            {
                ...
                GameObject obj2 = transform.Find("bg").get_gameObject();
                GameObject obj3 = transform.Find("imgLock").get_gameObject();
                GameObject obj4 = transform.Find("lblOpenLevel").get_gameObject();
                GameObject obj5 = transform.Find("imgIcon").get_gameObject();
                GameObject obj6 = transform.Find("imgLevel").get_gameObject();
                GameObject obj7 = transform.Find("imgCanBuy").get_gameObject();
                Text text = obj4.get_transform().Find("Level").GetComponent<Text>();
                obj2.CustomSetActive(true);
                obj3.CustomSetActive(false);
                ...
                switch (state)
                {
                    case enSymbolWearState.WearSuccess:
                        ...
                        {
                            obj5.GetComponent<Image>().SetSprite(symbolByObjID.GetIconPath(), formScript, false, false, false, false);
                    ...
                    case enSymbolWearState.WillOpen:
                        text.set_text("Lv." + param.ToString());
        ...
        private void SetSymbolItemSelect(int pos, bool isSelect = true)
        {
            ...
            {
                Transform transform2 = form.get_gameObject().get_transform().Find(s_symbolPagePanel).Find(string.Format("itemCell{0}/imgSelect", pos));
                if (transform2 != null)
                {
                    transform2.get_gameObject().CustomSetActive(isSelect);
                }
            }
        }
        ...
        public void SetSymbolListItem(CUIFormScript formScript, GameObject itemObj, CSymbolItem item)
        {
            ...
            {
                Image component = itemObj.get_transform().Find("imgIcon").GetComponent<Image>();
                component.SetSprite(item.GetIconPath(), formScript, true, false, false, false);
                itemObj.get_transform().Find("SymbolName").GetComponent<Text>().set_text(item.m_name);
                itemObj.get_transform().Find("SymbolDesc").GetComponent<Text>().set_text(CSymbolSystem.GetSymbolAttString(item, true));
                Text text3 = itemObj.get_transform().Find("lblIconCount").GetComponent<Text>();
                int num = item.m_stackCount - item.GetPageWearCnt(this.m_symbolPageIndex);
                text3.set_text(string.Format("x{0}", num));
                CRoleInfo masterRoleInfo = Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo();
            ...
            if (srcFormScript != null)
            {
                ...
                if (transform != null)
                {
                    ...
                    if (component != null)
                    {
                        ...
                        Text text = widget.get_transform().Find("root/lblName").GetComponent<Text>();
                        Image image = widget.get_transform().Find("root/itemCell0/imgIcon").GetComponent<Image>();
                        CSymbolItem symbol = uiEvent.m_eventParams.symbolParam.symbol;
                        this.m_curViewSymbol = symbol;
                        text.set_text(symbol.m_name);
                        image.SetSprite(symbol.GetIconPath(), uiEvent.m_srcFormScript, true, false, false, false);
                        CSymbolSystem.RefreshSymbolPropContent(widget.get_transform().Find("root/symbolPropPanel").get_gameObject(), symbol.m_baseID);
                    }
                }
            }
        }
            ...
            if ((form != null) && !form.IsClosed())
            {
                ...
                if (transform != null)
                {
                    ...
                    if (component != null)
                    {
                        ...
                        AddTip(component.GetWidget(2).get_transform().Find("titlePanel").get_gameObject(), instance.GetText("Symbol_PvpProp_Desc"), enUseableTipsPos.enLeft);
                        AddTip(component.GetWidget(3).get_transform().Find("titlePanel").get_gameObject(), instance.GetText("Symbol_EnhancePveProp_Desc"), enUseableTipsPos.enLeft);
                    }
                }
            }
        }
        ...
        public void UnInit()
        {
            ...
            Singleton<EventRouter>.instance.RemoveEventHandler("MasterPvpLevelChanged", new Action(this, (IntPtr) this.RefreshPageDropList));
        }
    }
}
