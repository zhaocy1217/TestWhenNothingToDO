namespace Assets.Scripts.GameSystem
{
    ...
    internal class PVESettleSys : Singleton<PVESettleSys>
    {
        ...
        private void OnGameEnd(CUIEvent uiEvent)
        {
            ...
            {
                srcFormScript.get_transform().Find("ClickBack").get_gameObject().CustomSetActive(true);
                srcFormScript.get_transform().Find("WaitNote").get_gameObject().CustomSetActive(false);
            }
            Singleton<GameBuilder>.instance.EndGame();
        }
        ...
        private void OnOpenLvlUp(CUIEvent uiEvent)
        {
            ...
            if (newLvl > this._lastlvTarget)
            {
                ...
                if (form != null)
                {
                    ...
                    {
                        Transform transform = form.get_transform().FindChild("PlayerLvlUp/Panel/groupPanel/SkillPanel");
                        if (transform != null)
                        {
                    ...
                    {
                        Transform transform2 = form.get_transform().FindChild("PlayerLvlUp/Panel/groupPanel/SkillPanel");
                        if (transform2 != null)
                        {
        ...
        public void StartSettle(COMDT_SETTLE_RESULT_DETAIL settleData = new COMDT_SETTLE_RESULT_DETAIL(), bool bFirstPass = true)
        {
