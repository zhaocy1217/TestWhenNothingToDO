namespace Assets.Scripts.GameSystem
{
    ...
    {
        [CompilerGenerated]
        private bool <IsUseDefault>k__BackingField;
        ...
        public void On_InBatMenu_OpenForm(CUIEvent uievent)
        {
            ...
            Singleton<CUINewFlagSystem>.instance.SetNewFlagForMessageBtnEntry(false);
            Singleton<CBattleGuideManager>.GetInstance().OpenBannerDlgByBannerGuideId(3, null, false);
        ...
        public bool IsUseDefault
        {
            ...
            get
            {
                return this.<IsUseDefault>k__BackingField;
            }
            [CompilerGenerated]
            private set
            {
                this.<IsUseDefault>k__BackingField = value;
            }
        }
    }
}
