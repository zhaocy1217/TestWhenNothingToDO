namespace Assets.Scripts.GameSystem
{
    ...
    public class CGuildInfoController : Singleton<CGuildInfoController>
    {
        ...
        public override void Init()
        {
            ...
            Singleton<EventRouter>.GetInstance().AddEventHandler<uint, int, int>("Request_Guild_Setting_Modify", new Action<uint, int, int>(this, (IntPtr) this.OnRequestGuildSettingModify));
            ...
            Singleton<EventRouter>.GetInstance().AddEventHandler<ulong, byte, ulong, string>("Guild_Position_Appoint", new Action<ulong, byte, ulong, string>(this, (IntPtr) this.OnGuildPositionAppoint));
        ...
        public void OnCreateOrAddSuccess(GuildInfo info)
        {
            ...
            string[] args = new string[] { info.briefInfo.sName };
        ...
        {
            this.RequestUpgradeGuildByDianQuan(this.m_Model.CurrentGuildInfo.briefInfo.bLevel);
        }
        ...
        {
            CSPkg msg = NetworkModule.CreateDefaultCSPKG(0x8ed);
            Singleton<NetworkModule>.GetInstance().SendLobbyMsg(ref msg, true);
        }
        ...
        private void RequestGuildAppointPosition(ulong uid, byte position, ulong replaceUid, string pwd)
        {
            ...
            StringHelper.StringToUTF8Bytes(pwd, ref msg.stPkgData.stAppointPositionReq.szPswdInfo);
            Singleton<NetworkModule>.GetInstance().SendLobbyMsg(ref msg, false);
        }
        ...
        private void RequestGuildSettingModify(uint mask, int levelLimit, int gradeLimit)
        {
            ...
            msg.stPkgData.stModifyGuildSettingReq.bLimitLevel = (byte) levelLimit;
            msg.stPkgData.stModifyGuildSettingReq.bLimitGrade = (byte) gradeLimit;
            Singleton<NetworkModule>.GetInstance().SendLobbyMsg(ref msg, false);
        }
        ...
        {
            CSPkg msg = NetworkModule.CreateDefaultCSPKG(0x8ef);
            Singleton<NetworkModule>.GetInstance().SendLobbyMsg(ref msg, true);
        }
