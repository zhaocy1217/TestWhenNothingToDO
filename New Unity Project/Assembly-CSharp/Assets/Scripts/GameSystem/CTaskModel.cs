namespace Assets.Scripts.GameSystem
{
    ...
    {
        [CompilerGenerated]
        private uint <maxCfgMasterTaskID>k__BackingField;
        [CompilerGenerated]
        private uint <maxCfgTudiTaskID>k__BackingField;
        ...
        {
            this.maxCfgTudiTaskID = 0;
            this.maxCfgMasterTaskID = 0;
            ...
            while (enumerator2.MoveNext())
            {
                ...
                if ((task2 != null) && (task2.dwTaskType == 0))
                {
                    if (dictionary.ContainsKey(task2.bTaskSubType) && (task2.dwTaskID < dictionary[task2.bTaskSubType]))
                    {
                        this.InsertCltCalcCompletedTasks(task2.dwTaskID, task2.bTaskSubType);
                    }
                    if ((task2.bTaskSubType == 3) && (task2.dwTaskID > this.maxCfgMasterTaskID))
                    {
                        this.maxCfgMasterTaskID = task2.dwTaskID;
                    }
                    if ((task2.bTaskSubType == 4) && (task2.dwTaskID > this.maxCfgTudiTaskID))
                    {
                        this.maxCfgTudiTaskID = task2.dwTaskID;
                    }
                }
            }
            ...
            while (enumerator.MoveNext())
            {
                ...
                if (reward != null)
                {
                    ...
                    if (this.GetLevelRewardData(reward.iLevel) == null)
                    {
                        ...
                        item.m_level = reward.iLevel;
                        item.m_resLevelReward = reward;
        ...
        public uint maxCfgMasterTaskID
        {
            ...
            get
            {
                return this.<maxCfgMasterTaskID>k__BackingField;
            }
            [CompilerGenerated]
            private set
            {
                this.<maxCfgMasterTaskID>k__BackingField = value;
            }
        }
        ...
        public uint maxCfgTudiTaskID
        {
            ...
            get
            {
                return this.<maxCfgTudiTaskID>k__BackingField;
            }
            [CompilerGenerated]
            private set
            {
                this.<maxCfgTudiTaskID>k__BackingField = value;
            }
        }
