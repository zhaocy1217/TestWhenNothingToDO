namespace Assets.Scripts.UI
{
    ...
    {
        [CompilerGenerated]
        private string <m_currentAnimatorStateName>k__BackingField;
        ...
        public override void Initialize(CUIFormScript formScript)
        {
            if (!base.m_isInitialized)
            {
                ...
                this.m_isEnableBeHide = base.get_enabled();
                this.m_isEnableAnimatorBeHide = this.m_animator.get_enabled();
            }
        }
        ...
        public void PlayAnimator(string stateName)
        {
            ...
            if (!this.m_animator.get_enabled())
            {
                this.m_animator.set_enabled(true);
            }
            this.m_animator.Play(stateName, 0, 0f);
            this.m_currentAnimatorStateName = stateName;
            this.m_animator.Update(0f);
            this.m_animator.Update(0f);
            this.m_currentAnimatorStateCounter = (int) this.m_animator.GetCurrentAnimatorStateInfo(0).get_normalizedTime();
        ...
        public void SetAnimatorEnable(bool isEnable)
        {
            if (this.m_animator != null)
            {
                this.m_animator.set_enabled(isEnable);
                base.set_enabled(isEnable);
            }
        }
        ...
        private void Update()
        {
            if ((((base.m_belongedFormScript == null) || !base.m_belongedFormScript.IsClosed()) && (this.m_currentAnimatorStateName != null)) && (((int) this.m_animator.GetCurrentAnimatorStateInfo(0).get_normalizedTime()) > this.m_currentAnimatorStateCounter))
            {
        ...
        public string m_currentAnimatorStateName
        {
            ...
            get
            {
                return this.<m_currentAnimatorStateName>k__BackingField;
            }
            [CompilerGenerated]
            private set
            {
                this.<m_currentAnimatorStateName>k__BackingField = value;
            }
        }
    }
}
