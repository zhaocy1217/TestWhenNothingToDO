namespace Assets.Scripts.Sound
{
    ...
    public class CSoundManager : Singleton<CSoundManager>
    {
        ...
        public override void Init()
        {
            ...
            if (obj2 != null)
            {
                this.m_soundRoot.get_transform().set_parent(obj2.get_transform());
            }
        ...
        public uint PlayBattleSound(string eventName, PoolObjHandle<ActorRoot> actor, GameObject srcGameObject = new GameObject())
        {
        ...
        public uint PostEvent(string eventName, GameObject srcGameObject = new GameObject())
        {
            if (this.m_isPrepared)
            {
                if (srcGameObject == null)
                {
                    ...
                    {
                        srcGameObject = Camera.get_main().get_gameObject();
                    }
                    else
                    {
