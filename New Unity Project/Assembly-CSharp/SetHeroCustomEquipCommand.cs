...
[ArgumentDescription(8, typeof(int), "1胜2负", new object[] {  }), ArgumentDescription(7, typeof(int), "强制刷新0或1", new object[] {  }), ArgumentDescription(1, typeof(int), "装备1", new object[] {  }), ArgumentDescription(0, typeof(int), "ID", new object[] {  }), ArgumentDescription(5, typeof(int), "装备5", new object[] {  }), ArgumentDescription(2, typeof(int), "装备2", new object[] {  }), ArgumentDescription(4, typeof(int), "装备4", new object[] {  }), ArgumentDescription(6, typeof(int), "装备6", new object[] {  }), ArgumentDescription(3, typeof(int), "装备3", new object[] {  }), CheatCommand("英雄/属性/SetHeroCustomEquip", "设置英雄自定义装备", 0x40)]
