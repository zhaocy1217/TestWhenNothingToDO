...
public class CMallBoutiqueController : Singleton<CMallBoutiqueController>
{
    ...
    public void InitBannerCtrl()
    {
        ...
        {
            GameObject obj2 = Utility.FindChild(mallForm.get_gameObject(), "pnlBodyBg/pnlBoutique/Left/Top/StepList");
            if (obj2 == null)
            {
    ...
    public void InitElements()
    {
        ...
        if ((mallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
        {
            Utility.FindChild(mallForm.get_gameObject(), "pnlBodyBg/pnlBoutique").CustomSetActive(true);
        }
    }
        ...
        else
        {
            ...
            if (shopProduct.CanBuy())
            {
                if ((shopProduct.Type == COM_ITEM_TYPE.COM_OBJTYPE_HERO) || (shopProduct.Type == COM_ITEM_TYPE.COM_OBJTYPE_HEROSKIN))
                {
                    ...
                    event2.m_eventID = enUIEventID.Mall_Boutique_Factory_Product_Confirm_Buy;
                ...
                else
                {
                    ...
                    uieventPars.m_eventID = enUIEventID.Mall_Boutique_Factory_Product_Confirm_Buy;
    ...
    public void RefreshHotSale()
    {
        ...
        if ((mallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
        {
            Utility.GetComponetInChild<CUIListScript>(mallForm.get_gameObject(), "pnlBodyBg/pnlBoutique/Right/Hot").SetElementAmount(this.m_HotSaleListView.Count);
        }
    }
    ...
    public void RefreshNewArrivals()
    {
        ...
        if ((mallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
        {
            Utility.GetComponetInChild<CUIListScript>(mallForm.get_gameObject(), "pnlBodyBg/pnlBoutique/Left/Bottom/NewArrivals").SetElementAmount(this.m_NewArrivalListView.Count);
        }
    }
