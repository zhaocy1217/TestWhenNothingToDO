...
[ArgumentDescription(9, typeof(uint), "四杀总和", new object[] {  }), ArgumentDescription(4, typeof(ulong), "KDA总和", new object[] {  }), ArgumentDescription(10, typeof(uint), "五杀总和", new object[] {  }), ArgumentDescription(8, typeof(uint), "三杀总和", new object[] {  }), ArgumentDescription(2, typeof(uint), "胜场", new object[] {  }), ArgumentDescription(5, typeof(ulong), "总输出总和", new object[] {  }), ArgumentDescription(1, typeof(EGameType), "比赛类型", new object[] {  }), ArgumentDescription(12, typeof(uint), "失败MVP", new object[] {  }), ArgumentDescription(0, typeof(byte), "英雄ID", new object[] {  }), ArgumentDescription(6, typeof(ulong), "承受伤害总和", new object[] {  }), ArgumentDescription(3, typeof(uint), "败场", new object[] {  }), CheatCommand("英雄/历史战绩/AddCommonHero", "增加常用英雄统计", 0x4d), ArgumentDescription(7, typeof(ulong), "对建筑伤害总和", new object[] {  }), ArgumentDescription(11, typeof(uint), "胜利MVP", new object[] {  })]
