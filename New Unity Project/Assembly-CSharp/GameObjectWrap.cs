...
public class GameObjectWrap
{
    ...
    private static int _CreateGameObject(IntPtr L)
    {
        ...
        switch (num)
        {
            case 0:
            {
                ...
                LuaScriptMgr.Push(L, (Object) obj2);
                return 1;
            }
            case 1:
            {
                GameObject obj3 = new GameObject(LuaScriptMgr.GetString(L, 1));
                LuaScriptMgr.Push(L, (Object) obj3);
                return 1;
            }
        }
        if (LuaScriptMgr.CheckTypes(L, 1, typeof(string)) && LuaScriptMgr.CheckParamsType(L, typeof(Type), 2, num - 1))
        {
            ...
            Type[] typeArray = LuaScriptMgr.GetParamsObject<Type>(L, 2, num - 1);
            GameObject obj4 = new GameObject(str2, typeArray);
            LuaScriptMgr.Push(L, (Object) obj4);
            return 1;
        }
    ...
    private static int AddComponent(IntPtr L)
    {
        ...
        if ((num == 2) && LuaScriptMgr.CheckTypes(L, 1, typeof(GameObject), typeof(string)))
        {
            ...
            LuaScriptMgr.Push(L, (Object) component2);
            return 1;
        }
    ...
    private static int BroadcastMessage(IntPtr L)
    {
        ...
        if ((num == 3) && LuaScriptMgr.CheckTypes(L, 1, typeof(GameObject), typeof(string), typeof(SendMessageOptions)))
        {
            ...
            obj3.BroadcastMessage(str2, luaObject);
            return 0;
        }
        ...
        if (num == 4)
        {
            ...
            obj6.BroadcastMessage(str4, obj7, options2);
            return 0;
        }
    ...
    private static int get_activeInHierarchy(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, luaObject.get_activeInHierarchy());
        return 1;
    }
    ...
    private static int get_activeSelf(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, luaObject.get_activeSelf());
        return 1;
    }
    ...
    private static int get_animation(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_animation());
        return 1;
    }
    ...
    private static int get_audio(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_audio());
        return 1;
    }
    ...
    private static int get_camera(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_camera());
        return 1;
    }
    ...
    private static int get_collider(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_collider());
        return 1;
    }
    ...
    private static int get_collider2D(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_collider2D());
        return 1;
    }
    ...
    private static int get_constantForce(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_constantForce());
        return 1;
    }
    ...
    private static int get_gameObject(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_gameObject());
        return 1;
    }
    ...
    private static int get_guiText(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_guiText());
        return 1;
    }
    ...
    private static int get_guiTexture(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_guiTexture());
        return 1;
    }
    ...
    private static int get_hingeJoint(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_hingeJoint());
        return 1;
    }
    ...
    private static int get_isStatic(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, luaObject.get_isStatic());
        return 1;
    }
    ...
    private static int get_light(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_light());
        return 1;
    }
    ...
    private static int get_networkView(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_networkView());
        return 1;
    }
    ...
    private static int get_particleEmitter(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_particleEmitter());
        return 1;
    }
    ...
    private static int get_particleSystem(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_particleSystem());
        return 1;
    }
    ...
    private static int get_renderer(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_renderer());
        return 1;
    }
    ...
    private static int get_rigidbody(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_rigidbody());
        return 1;
    }
    ...
    private static int get_rigidbody2D(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_rigidbody2D());
        return 1;
    }
    ...
    private static int get_tag(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, luaObject.get_tag());
        return 1;
    }
    ...
    private static int get_transform(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_transform());
        return 1;
    }
    ...
    private static int GetComponentInChildren(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) componentInChildren);
        return 1;
    }
    ...
    private static int GetComponents(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            ...
            {
                GameObject obj3 = (GameObject) LuaScriptMgr.GetUnityObjectSelf(L, 1, "GameObject");
                Type type2 = LuaScriptMgr.GetTypeObject(L, 2);
                List<Component> list = (List<Component>) LuaScriptMgr.GetNetObject(L, 3, typeof(List<Component>));
                obj3.GetComponents(type2, list);
                return 0;
            }
        }
    ...
    private static int GetComponentsInChildren(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            ...
            case 3:
            {
                ...
                Component[] o = obj3.GetComponentsInChildren(type2, boolean);
                LuaScriptMgr.PushArray(L, o);
                return 1;
            }
        }
    ...
    private static int GetComponentsInParent(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            ...
            case 3:
            {
                ...
                Type type2 = LuaScriptMgr.GetTypeObject(L, 2);
                bool boolean = LuaScriptMgr.GetBoolean(L, 3);
                Component[] o = obj3.GetComponentsInParent(type2, boolean);
                LuaScriptMgr.PushArray(L, o);
                return 1;
            }
        }
    ...
    private static int SendMessage(IntPtr L)
    {
        ...
        if ((num == 3) && LuaScriptMgr.CheckTypes(L, 1, typeof(GameObject), typeof(string), typeof(SendMessageOptions)))
        {
            ...
            string str2 = LuaScriptMgr.GetString(L, 2);
            SendMessageOptions luaObject = (SendMessageOptions) ((int) LuaScriptMgr.GetLuaObject(L, 3));
            obj3.SendMessage(str2, luaObject);
            return 0;
        }
        if ((num == 3) && LuaScriptMgr.CheckTypes(L, 1, typeof(GameObject), typeof(string), typeof(object)))
        {
        ...
        if (num == 4)
        {
            ...
            object obj7 = LuaScriptMgr.GetVarObject(L, 3);
            SendMessageOptions options2 = (SendMessageOptions) ((int) LuaScriptMgr.GetNetObject(L, 4, typeof(SendMessageOptions)));
            obj6.SendMessage(str4, obj7, options2);
            return 0;
        }
    ...
    private static int SendMessageUpwards(IntPtr L)
    {
        ...
        if ((num == 3) && LuaScriptMgr.CheckTypes(L, 1, typeof(GameObject), typeof(string), typeof(SendMessageOptions)))
        {
            ...
            string str2 = LuaScriptMgr.GetString(L, 2);
            SendMessageOptions luaObject = (SendMessageOptions) ((int) LuaScriptMgr.GetLuaObject(L, 3));
            obj3.SendMessageUpwards(str2, luaObject);
            return 0;
        }
        if ((num == 3) && LuaScriptMgr.CheckTypes(L, 1, typeof(GameObject), typeof(string), typeof(object)))
        {
        ...
        if (num == 4)
        {
            ...
            object obj7 = LuaScriptMgr.GetVarObject(L, 3);
            SendMessageOptions options2 = (SendMessageOptions) ((int) LuaScriptMgr.GetNetObject(L, 4, typeof(SendMessageOptions)));
            obj6.SendMessageUpwards(str4, obj7, options2);
            return 0;
        }
    ...
    private static int set_isStatic(IntPtr L)
    {
        ...
        luaObject.set_isStatic(LuaScriptMgr.GetBoolean(L, 3));
        return 0;
    }
    ...
    private static int set_tag(IntPtr L)
    {
        ...
        luaObject.set_tag(LuaScriptMgr.GetString(L, 3));
        return 0;
    }
