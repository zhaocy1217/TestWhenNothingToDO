...
public class Vector2Wrap
{
    ...
    private static int _CreateVector2(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            case 2:
            {
                ...
                Vector2 vector = new Vector2(number, num3);
    ...
    private static int get_magnitude(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, ((Vector2) luaObject).get_magnitude());
        return 1;
    }
    ...
    private static int get_normalized(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, ((Vector2) luaObject).get_normalized());
        return 1;
    }
    ...
    {
        LuaScriptMgr.Push(L, Vector2.get_one());
        return 1;
    }
    ...
    {
        LuaScriptMgr.Push(L, Vector2.get_right());
        return 1;
    }
    ...
    private static int get_sqrMagnitude(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, ((Vector2) luaObject).get_sqrMagnitude());
        return 1;
    }
    ...
    {
        LuaScriptMgr.Push(L, Vector2.get_up());
        return 1;
    }
    ...
    {
        LuaScriptMgr.Push(L, Vector2.get_zero());
        return 1;
    }
    ...
    private static int Lerp(IntPtr L)
    {
        ...
        Vector2 vector3 = Vector2.Lerp(vector, vector2, number);
    ...
    private static int Max(IntPtr L)
    {
        ...
        Vector2 vector = LuaScriptMgr.GetVector2(L, 1);
        Vector2 vector2 = LuaScriptMgr.GetVector2(L, 2);
        Vector2 vector3 = Vector2.Max(vector, vector2);
        LuaScriptMgr.Push(L, vector3);
        return 1;
    }
    ...
    private static int MoveTowards(IntPtr L)
    {
        ...
        Vector2 vector2 = LuaScriptMgr.GetVector2(L, 2);
        float number = (float) LuaScriptMgr.GetNumber(L, 3);
        Vector2 vector3 = Vector2.MoveTowards(vector, vector2, number);
        LuaScriptMgr.Push(L, vector3);
        return 1;
    }
    ...
    private static int SmoothDamp(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            case 4:
            {
                ...
                Vector2 vector4 = Vector2.SmoothDamp(vector, vector2, ref vector3, number);
                LuaScriptMgr.Push(L, vector4);
                LuaScriptMgr.Push(L, vector3);
                return 2;
            }
            case 5:
            {
                ...
                Vector2 vector8 = Vector2.SmoothDamp(vector5, vector6, ref vector7, num3, num4);
            ...
            case 6:
            {
                ...
                Vector2 vector12 = Vector2.SmoothDamp(vector9, vector10, ref vector11, num5, num6, num7);
