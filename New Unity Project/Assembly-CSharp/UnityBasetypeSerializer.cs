...
public class UnityBasetypeSerializer
{
    ...
    public static byte[] BoundsToBytes(Bounds bounds)
    {
        ...
        WriteFloat(data, 0, bounds.get_center().x);
        WriteFloat(data, 4, bounds.get_center().y);
        WriteFloat(data, 8, bounds.get_center().z);
        WriteFloat(data, 12, bounds.get_extents().x);
        WriteFloat(data, 0x10, bounds.get_extents().y);
        WriteFloat(data, 20, bounds.get_extents().z);
        return data;
    }

    public static string BoundsToString(Bounds bounds)
    {
        object[] args = new object[] { bounds.get_center().x, bounds.get_center().y, bounds.get_center().z, bounds.get_extents().x, bounds.get_extents().y, bounds.get_extents().z };
    ...
    {
        bounds.set_center(new Vector3(ReadFloat(data, 0), ReadFloat(data, 4), ReadFloat(data, 8)));
        bounds.set_extents(new Vector3(ReadFloat(data, 12), ReadFloat(data, 0x10), ReadFloat(data, 20)));
    }
    ...
    {
        rect.set_xMin(ReadFloat(data, 0));
        rect.set_xMax(ReadFloat(data, 4));
        rect.set_yMin(ReadFloat(data, 8));
        rect.set_yMax(ReadFloat(data, 12));
    }
    ...
    {
        byte[] data = new byte[0x10];
        WriteFloat(data, 0, rect.get_xMin());
        WriteFloat(data, 4, rect.get_xMax());
        WriteFloat(data, 8, rect.get_yMin());
        WriteFloat(data, 12, rect.get_yMax());
        return data;
    }

    public static string RectToString(Rect rect)
    {
        object[] args = new object[] { rect.get_xMin(), rect.get_xMax(), rect.get_yMin(), rect.get_yMax() };
        return GetStringBuilder().AppendFormat("{0:G9},{1:G9},{2:G9},{3:G9}", args).ToString();
    }
    ...
    public static void StringToBounds(ref Bounds bounds, string s)
    {
        ...
        bounds.set_center(new Vector3(Convert.ToSingle(strArray[0]), Convert.ToSingle(strArray[1]), Convert.ToSingle(strArray[2])));
        bounds.set_extents(new Vector3(Convert.ToSingle(strArray[3]), Convert.ToSingle(strArray[4]), Convert.ToSingle(strArray[5])));
    }
    ...
    public static void StringToRect(ref Rect rect, string s)
    {
        char[] separator = new char[] { ',' };
        string[] strArray = s.Split(separator);
        rect.set_xMin(Convert.ToSingle(strArray[0]));
        rect.set_xMax(Convert.ToSingle(strArray[1]));
        rect.set_yMin(Convert.ToSingle(strArray[2]));
        rect.set_yMax(Convert.ToSingle(strArray[3]));
    }
