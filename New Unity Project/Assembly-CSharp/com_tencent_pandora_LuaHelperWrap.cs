...
public class com_tencent_pandora_LuaHelperWrap
{
    ...
    private static int Action(IntPtr L)
    {
        ...
        System.Action action = LuaHelper.Action(LuaScriptMgr.GetLuaFunction(L, 1));
        LuaScriptMgr.Push(L, (Delegate) action);
        return 1;
    }
    ...
    private static int GetPanelManager(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) panelManager);
        return 1;
    }
    ...
    private static int GetResManager(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) resManager);
        return 1;
    }
    ...
    {
        LuaScriptMgr.CheckArgsCount(L, 1);
        Type o = LuaHelper.GetType(LuaScriptMgr.GetLuaString(L, 1));
