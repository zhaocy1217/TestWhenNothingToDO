...
public class TdirConfig
{
    ...
    public static string[] iplist_competition_official = new string[] { "exp.mtcls.qq.com", "61.151.234.47", "182.254.42.103", "140.207.62.111", "140.207.123.164", "117.144.242.28", "117.144.243.174", "103.7.30.91", "101.227.130.79" };
    public static string[] iplist_competition_test = new string[] { "testa4.mtcls.qq.com", "101.227.153.83" };
    public static string[] iplist_experience = new string[] { "exp.mtcls.qq.com", "61.151.234.47", "182.254.42.103", "140.207.62.111", "140.207.123.164", "117.144.242.28", "117.144.243.174", "103.7.30.91", "101.227.130.79" };
    ...
    {
        if ((tdirConfigData == null) && File.Exists(Application.get_persistentDataPath() + tdirConfigDataPath))
        {
            try
            {
                byte[] bytes = CFileManager.ReadFile(Application.get_persistentDataPath() + tdirConfigDataPath);
