...
[ArgumentDescription(ArgumentDescriptionAttribute.EDefaultValueTag.Tag, 0, typeof(int), "年", "2016", new object[] {  }), ArgumentDescription(1, typeof(int), "月", new object[] {  }), ArgumentDescription(2, typeof(int), "日", new object[] {  }), ArgumentDescription(3, typeof(int), "时", new object[] {  }), ArgumentDescription(ArgumentDescriptionAttribute.EDefaultValueTag.Tag, 4, typeof(int), "分", "0", new object[] {  }), ArgumentDescription(ArgumentDescriptionAttribute.EDefaultValueTag.Tag, 5, typeof(int), "秒", "0", new object[] {  }), CheatCommand("工具/服务器/SetPvpBanTime", "设置禁止PVP截止时间", 0x5b)]
