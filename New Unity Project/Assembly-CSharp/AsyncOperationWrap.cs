...
public class AsyncOperationWrap
{
    ...
    private static int get_allowSceneActivation(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, luaObject.get_allowSceneActivation());
        return 1;
    }
    ...
    private static int get_priority(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, luaObject.get_priority());
        return 1;
    }
    ...
    {
        LuaMethod[] regs = new LuaMethod[] { new LuaMethod("New", new LuaCSFunction(AsyncOperationWrap._CreateAsyncOperation)), new LuaMethod("GetClassType", new LuaCSFunction(AsyncOperationWrap.GetClassType)) };
        LuaField[] fields = new LuaField[] { new LuaField("isDone", new LuaCSFunction(AsyncOperationWrap.get_isDone), null), new LuaField("progress", new LuaCSFunction(AsyncOperationWrap.get_progress), null), new LuaField("priority", new LuaCSFunction(AsyncOperationWrap.get_priority), new LuaCSFunction(AsyncOperationWrap.set_priority)), new LuaField("allowSceneActivation", new LuaCSFunction(AsyncOperationWrap.get_allowSceneActivation), new LuaCSFunction(AsyncOperationWrap.set_allowSceneActivation)) };
    ...
    private static int set_allowSceneActivation(IntPtr L)
    {
        ...
        luaObject.set_allowSceneActivation(LuaScriptMgr.GetBoolean(L, 3));
        return 0;
    }
    ...
    private static int set_priority(IntPtr L)
    {
        ...
        luaObject.set_priority((int) LuaScriptMgr.GetNumber(L, 3));
        return 0;
    }
}
