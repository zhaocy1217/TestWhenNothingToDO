...
public class InBattleShortcutMenu
{
    ...
    private void On_InBatShortcut_Delete(CUIEvent uievent)
    {
        ...
        if ((srcWidgetIndexInBelongedList >= 0) && (srcWidgetIndexInBelongedList < menuEntList.Count))
        {
            ...
            this.SetLeftItemState(uievent.m_srcWidget.get_transform().get_parent().get_parent().get_gameObject(), data, EItemState.Record);
        }
    }
    ...
    private void On_InBatShortcut_Record(CUIEvent uievent)
    {
        ...
        {
            CUIListElementScript component = uievent.m_srcWidget.get_transform().get_parent().get_parent().GetComponent<CUIListElementScript>();
    ...
    public void OpenForm()
    {
        ...
        {
            this.RegEvent();
            this.m_rightTablist = this.m_form.get_transform().Find("Panel_Main/Panel_Right/Menu").GetComponent<CUIListScript>();
            this.m_rightContentList = this.m_form.get_transform().Find("Panel_Main/Panel_Right/ShortcutList").GetComponent<CUIListScript>();
            ...
            if ((this.m_rightTablist != null) && (this.m_rightContentList != null))
            {
                ...
                this.m_leftContentList = this.m_form.get_transform().Find("Panel_Main/Panel_Left/SelectedList").GetComponent<CUIListScript>();
                this.ReviseBtn = this.m_form.get_transform().Find("Panel_Main/Panel_Left/BtnGroup/ReviseBtn").get_gameObject();
                this.CancelBtn = this.m_form.get_transform().Find("Panel_Main/Panel_Left/BtnGroup/CancelBtn").get_gameObject();
                this.SureBtn = this.m_form.get_transform().Find("Panel_Main/Panel_Left/BtnGroup/SureBtn").get_gameObject();
    ...
    private void SetLeftItemState(GameObject node, TabElement data, EItemState state)
    {
        if (data != null)
        {
            Text component = node.get_transform().Find("titleText").GetComponent<Text>();
            GameObject obj2 = node.get_transform().Find("BtnGroup").get_gameObject();
            ...
            else if (state == EItemState.Delete)
            {
                ...
                component.get_gameObject().CustomSetActive(true);
                component.set_text(data.configContent);
                GameObject obj3 = obj2.get_transform().Find("WriteBtn").get_gameObject();
                if (obj3 != null)
                {
                    obj3.CustomSetActive(false);
                }
                GameObject obj4 = obj2.get_transform().Find("RemoveBtn").get_gameObject();
                if (obj4 != null)
                {
            ...
            else if (state == EItemState.Record)
            {
                ...
                GameObject obj5 = obj2.get_transform().Find("WriteBtn").get_gameObject();
                if (obj5 != null)
                {
                    obj5.CustomSetActive(true);
                }
                GameObject obj6 = obj2.get_transform().Find("RemoveBtn").get_gameObject();
                if (obj6 != null)
                {
