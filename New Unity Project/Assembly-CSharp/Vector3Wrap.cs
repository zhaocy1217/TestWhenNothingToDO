...
public class Vector3Wrap
{
    ...
    private static int _CreateVector3(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            case 2:
            {
                ...
                Vector3 vector = new Vector3(number, num3);
                LuaScriptMgr.Push(L, vector);
                return 1;
            }
            case 3:
            {
                float num4 = (float) LuaScriptMgr.GetNumber(L, 1);
    ...
    {
        LuaScriptMgr.Push(L, Vector3.get_back());
        return 1;
    }
    ...
    {
        LuaScriptMgr.Push(L, Vector3.get_down());
        return 1;
    }
    ...
    {
        LuaScriptMgr.Push(L, Vector3.get_forward());
        return 1;
    }
    ...
    private static int get_Item(IntPtr L)
    {
        ...
        float d = vector.get_Item(number);
        LuaScriptMgr.Push(L, d);
        return 1;
    }
    ...
    {
        LuaScriptMgr.Push(L, Vector3.get_left());
        return 1;
    }
    ...
    private static int get_magnitude(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, ((Vector3) luaObject).get_magnitude());
        return 1;
    }
    ...
    private static int get_normalized(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, ((Vector3) luaObject).get_normalized());
        return 1;
    }
    ...
    {
        LuaScriptMgr.Push(L, Vector3.get_one());
        return 1;
    }
    ...
    {
        LuaScriptMgr.Push(L, Vector3.get_right());
        return 1;
    }
    ...
    private static int get_sqrMagnitude(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, ((Vector3) luaObject).get_sqrMagnitude());
        return 1;
    }
    ...
    {
        LuaScriptMgr.Push(L, Vector3.get_up());
        return 1;
    }
    ...
    {
        LuaScriptMgr.Push(L, Vector3.get_zero());
        return 1;
    }
    ...
    private static int Lerp(IntPtr L)
    {
        ...
        Vector3 vector3 = Vector3.Lerp(vector, vector2, number);
        LuaScriptMgr.Push(L, vector3);
        return 1;
    }
    ...
    private static int Max(IntPtr L)
    {
        ...
        Vector3 vector = LuaScriptMgr.GetVector3(L, 1);
        Vector3 vector2 = LuaScriptMgr.GetVector3(L, 2);
        Vector3 vector3 = Vector3.Max(vector, vector2);
        LuaScriptMgr.Push(L, vector3);
        return 1;
    }
    ...
    private static int MoveTowards(IntPtr L)
    {
        ...
        Vector3 vector2 = LuaScriptMgr.GetVector3(L, 2);
        float number = (float) LuaScriptMgr.GetNumber(L, 3);
        Vector3 vector3 = Vector3.MoveTowards(vector, vector2, number);
        LuaScriptMgr.Push(L, vector3);
        return 1;
    }
    ...
    private static int Reflect(IntPtr L)
    {
        ...
        Vector3 vector = LuaScriptMgr.GetVector3(L, 1);
        Vector3 vector2 = LuaScriptMgr.GetVector3(L, 2);
        Vector3 vector3 = Vector3.Reflect(vector, vector2);
        LuaScriptMgr.Push(L, vector3);
        return 1;
    }
    ...
    private static int RotateTowards(IntPtr L)
    {
        ...
        Vector3 vector2 = LuaScriptMgr.GetVector3(L, 2);
        float number = (float) LuaScriptMgr.GetNumber(L, 3);
        float num2 = (float) LuaScriptMgr.GetNumber(L, 4);
        Vector3 vector3 = Vector3.RotateTowards(vector, vector2, number, num2);
        LuaScriptMgr.Push(L, vector3);
        return 1;
    }
    ...
    private static int Slerp(IntPtr L)
    {
        ...
        Vector3 vector2 = LuaScriptMgr.GetVector3(L, 2);
        float number = (float) LuaScriptMgr.GetNumber(L, 3);
        Vector3 vector3 = Vector3.Slerp(vector, vector2, number);
        LuaScriptMgr.Push(L, vector3);
        return 1;
    }
    ...
    private static int SmoothDamp(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            case 4:
            {
                ...
                Vector3 vector4 = Vector3.SmoothDamp(vector, vector2, ref vector3, number);
                LuaScriptMgr.Push(L, vector4);
                LuaScriptMgr.Push(L, vector3);
                return 2;
            }
            case 5:
            {
                ...
                Vector3 vector8 = Vector3.SmoothDamp(vector5, vector6, ref vector7, num3, num4);
            ...
            case 6:
            {
                ...
                float num7 = (float) LuaScriptMgr.GetNumber(L, 6);
                Vector3 vector12 = Vector3.SmoothDamp(vector9, vector10, ref vector11, num5, num6, num7);
