...
public class com_tencent_pandora_UtilWrap
{
    ...
    {
        LuaScriptMgr.CheckArgsCount(L, 1);
        Transform go = LuaScriptMgr.GetUnityObject(L, 1, typeof(Transform));
        Util.ClearChild(go);
        return 0;
    }
    ...
    {
        LuaScriptMgr.CheckArgsCount(L, 2);
        AssetBundle bundle = LuaScriptMgr.GetUnityObject(L, 1, typeof(AssetBundle));
        string luaString = LuaScriptMgr.GetLuaString(L, 2);
    ...
    public static void Register(IntPtr L)
    {
        LuaMethod[] regs = new LuaMethod[] { 
            ...
            new LuaMethod("GetKey", new LuaCSFunction(com_tencent_pandora_UtilWrap.GetKey)), new LuaMethod("GetInt", new LuaCSFunction(com_tencent_pandora_UtilWrap.GetInt)), new LuaMethod("HasKey", new LuaCSFunction(com_tencent_pandora_UtilWrap.HasKey)), new LuaMethod("SetInt", new LuaCSFunction(com_tencent_pandora_UtilWrap.SetInt)), new LuaMethod("GetString", new LuaCSFunction(com_tencent_pandora_UtilWrap.GetString)), new LuaMethod("SetString", new LuaCSFunction(com_tencent_pandora_UtilWrap.SetString)), new LuaMethod("RemoveData", new LuaCSFunction(com_tencent_pandora_UtilWrap.RemoveData)), new LuaMethod("ClearMemory", new LuaCSFunction(com_tencent_pandora_UtilWrap.ClearMemory)), new LuaMethod("IsNumber", new LuaCSFunction(com_tencent_pandora_UtilWrap.IsNumber)), new LuaMethod("GetFileText", new LuaCSFunction(com_tencent_pandora_UtilWrap.GetFileText)), new LuaMethod("AppContentPath", new LuaCSFunction(com_tencent_pandora_UtilWrap.AppContentPath)), new LuaMethod("AddClick", new LuaCSFunction(com_tencent_pandora_UtilWrap.AddClick)), new LuaMethod("getassetbundle", new LuaCSFunction(com_tencent_pandora_UtilWrap.getassetbundle)), new LuaMethod("LuaPath", new LuaCSFunction(com_tencent_pandora_UtilWrap.LuaPath)), new LuaMethod("SearchLuaPath", new LuaCSFunction(com_tencent_pandora_UtilWrap.SearchLuaPath)), new LuaMethod("AddLuaPath", new LuaCSFunction(com_tencent_pandora_UtilWrap.AddLuaPath)), 
            new LuaMethod("RemoveLuaPath", new LuaCSFunction(com_tencent_pandora_UtilWrap.RemoveLuaPath)), new LuaMethod("Log", new LuaCSFunction(com_tencent_pandora_UtilWrap.Log)), new LuaMethod("LogWarning", new LuaCSFunction(com_tencent_pandora_UtilWrap.LogWarning)), new LuaMethod("LogError", new LuaCSFunction(com_tencent_pandora_UtilWrap.LogError)), new LuaMethod("LoadAsset", new LuaCSFunction(com_tencent_pandora_UtilWrap.LoadAsset)), new LuaMethod("AddComponent", new LuaCSFunction(com_tencent_pandora_UtilWrap.AddComponent)), new LuaMethod("LoadPrefab", new LuaCSFunction(com_tencent_pandora_UtilWrap.LoadPrefab)), new LuaMethod("CallMethod", new LuaCSFunction(com_tencent_pandora_UtilWrap.CallMethod)), new LuaMethod("CheckEnvironment", new LuaCSFunction(com_tencent_pandora_UtilWrap.CheckEnvironment)), new LuaMethod("New", new LuaCSFunction(com_tencent_pandora_UtilWrap._Createcom_tencent_pandora_Util)), new LuaMethod("GetClassType", new LuaCSFunction(com_tencent_pandora_UtilWrap.GetClassType))
         };
