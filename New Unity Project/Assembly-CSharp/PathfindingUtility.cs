...
public class PathfindingUtility
{
    ...
    private static VInt3 InternalMove(VInt3 srcLoc, VInt3 delta, ref VInt groundY, ActorRoot actor, MoveDirectionState state = new MoveDirectionState())
    {
        VInt3 num4;
        if (AstarPath.active == null)
        {
    ...
    public static VInt3 Move(ActorRoot actor, VInt3 delta, out VInt groundY, MoveDirectionState state = new MoveDirectionState())
    {
        if (actor.isMovable)
        {
            groundY = (actor == null) ? 0 : actor.groundY;
    ...
    public static VInt3 Move(ActorRoot actor, VInt3 delta, out VInt groundY, out bool collided, MoveDirectionState state = new MoveDirectionState())
    {
