...
[ArgumentDescription(ArgumentDescriptionAttribute.EDefaultValueTag.Tag, 1, typeof(int), "MobaLevel", "-2", new object[] {  }), ArgumentDescription(ArgumentDescriptionAttribute.EDefaultValueTag.Tag, 3, typeof(int), "RecommendHeroType", "-2", new object[] {  }), ArgumentDescription(ArgumentDescriptionAttribute.EDefaultValueTag.Tag, 4, typeof(int), "MobaUsedType", "-2", new object[] {  }), CheatCommand("关卡/SetMobaInfo", "设置mobalevel", 0x4f), ArgumentDescription(ArgumentDescriptionAttribute.EDefaultValueTag.Tag, 2, typeof(int), "SelectdHeroType", "-2", new object[] {  })]
