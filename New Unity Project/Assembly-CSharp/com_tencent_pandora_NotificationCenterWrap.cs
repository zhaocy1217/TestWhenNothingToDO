...
{
    private static Type classType = typeof(NotificationCenter);
    ...
    private static int AddObserver(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            case 3:
            {
                ...
                Component observer = LuaScriptMgr.GetUnityObject(L, 2, typeof(Component));
            ...
            case 4:
            {
                ...
                Component component2 = LuaScriptMgr.GetUnityObject(L, 2, typeof(Component));
                string name = LuaScriptMgr.GetLuaString(L, 3);
                Component sender = LuaScriptMgr.GetUnityObject(L, 4, typeof(Component));
    ...
    private static int DefaultCenter(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) center);
        return 1;
    }
    ...
    private static int PostNotification(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            ...
            {
                NotificationCenter center2 = (NotificationCenter) LuaScriptMgr.GetUnityObjectSelf(L, 1, "com.tencent.pandora.NotificationCenter");
                Component aSender = LuaScriptMgr.GetUnityObject(L, 2, typeof(Component));
                string luaString = LuaScriptMgr.GetLuaString(L, 3);
    ...
    {
        LuaScriptMgr.CheckArgsCount(L, 2);
        Component observer = LuaScriptMgr.GetUnityObject(L, 1, typeof(Component));
