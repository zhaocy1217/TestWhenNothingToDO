    ...
    public class MoveBeamDuration : DurationCondition
    {
        ...
        private Vector3 GetSrcPosition()
        {
            ...
            if (this.bindPointName.Length != 0)
            {
                ...
                if (obj2 != null)
                {
                    return obj2.get_transform().get_position();
                }
            }
            return (Vector3) IntMath.Transform(this.bindPosOffset, this.srcActor.handle.forward, this.srcActor.handle.location);
        }
        ...
        private bool Init(Action _action)
        {
            ...
            this.lineRenderer = this.beamObject.get_gameObject().GetComponentInChildren<LineRenderer>();
            if (this.lineRenderer == null)
            {
                return false;
            }
        ...
        {
            Vector3 srcPosition = this.GetSrcPosition();
            Vector3 vector2 = (Vector3) IntMath.Transform(this.bindDestOffet, this.targetActor.handle.forward, (VInt3) this.targetActor.handle.myTransform.get_position());
        ...
        private void SetTextureScale(int _tileX, int _tileY)
        {
            ...
            if ((component != null) && (component.get_material() != null))
            {
                component.get_material().SetTextureScale("_MainTex", new Vector2((float) _tileX, (float) _tileY));
            }
        }
        ...
        private void UnInit()
        {
            ...
            if (this.beamObject != null)
            {
                this.beamObject.get_transform().set_position(new Vector3(10000f, 10000f, 10000f));
