namespace AGE
{
    ...
    public class ScaleMeshDuration : DurationEvent
    {
        ...
        public override void OnUse()
        {
            base.OnUse();
            this.targetId = 0;
            this.originalScale = Vector3.get_one();
        ...
        private void RecorveMeshScale()
        {
            ...
            {
                this.actorObj.handle.ActorMesh.get_transform().set_localScale(this.originalScale);
            }
        }
        ...
        private void SetMeshScale(int _scaleRate)
        {
            if ((this.actorObj != 0) && (this.actorObj.handle.ActorMesh != null))
            {
                ...
                this.originalScale = this.actorObj.handle.ActorMesh.get_transform().get_localScale();
                this.actorObj.handle.ActorMesh.get_transform().set_localScale(vector);
            }
        }
