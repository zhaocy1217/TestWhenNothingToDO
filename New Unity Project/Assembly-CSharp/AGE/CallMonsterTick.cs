                ...
                if (dataByKey != null)
                {
                    ...
                    if (dataCfgInfo != null)
                    {
                        ...
                        if (content != null)
                        {
                            ...
                            meta2.ConfigId = (int) dataByKey.dwMonsterID;
                            meta2.ActorType = ActorTypeDef.Actor_Type_Monster;
                            meta2.ActorCamp = this.SelectCamp(ref refParamObject.Originator);
                            meta2.EnCId = (CrypticInt32) dataByKey.dwMonsterID;
                            meta2.Difficuty = (byte) diffLevel;
                            meta2.SkinID = refParamObject.Originator.handle.TheActorMeta.SkinID;
