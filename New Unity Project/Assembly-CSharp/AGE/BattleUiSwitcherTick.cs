            ...
            if (this.bIncludeBattleUi)
            {
                ...
                if (fightFormScript != null)
                {
                    if (this.bOpenOrClose)
                    {
                        ...
                        {
                            Transform transform = Camera.get_main().get_transform().Find(Camera.get_main().get_name() + " particles");
                            if (null == transform)
                            {
                            }
                        }
                    ...
                    else
                    {
                        ...
                        if (GameSettings.EnableOutline)
                        {
                            Transform transform2 = Camera.get_main().get_transform().Find(Camera.get_main().get_name() + " particles");
                            if (null == transform2)
                            {
                            }
                        }
