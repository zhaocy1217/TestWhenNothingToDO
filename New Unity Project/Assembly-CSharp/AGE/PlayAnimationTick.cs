    ...
    public class PlayAnimationTick : TickEvent
    {
        ...
        public override void PostProcess(Action _action, Track _track, int _localTime)
        {
            ...
            if (gameObject != null)
            {
                ...
                if (actorMesh != null)
                {
                    AnimationState state = this.GetAnimation(actorMesh).get_Item(this.clipName);
                    if (state != null)
                    {
                        state.set_speed(this.playSpeed * (!this.applyActionSpeed ? 1f : _action.playSpeed.single));
                    }
                }
            }
        }
        ...
        public override void Process(Action _action, Track _track)
        {
            ...
            if (gameObject != null)
            {
                ...
                if (actorMesh != null)
                {
                    ...
                    AnimationState state = animation.get_Item(this.clipName);
                    if (state != null)
                    {
                        if (this.alwaysAnimate && (animation.get_cullingType() != null))
                        {
                            animation.set_cullingType(0);
                        }
