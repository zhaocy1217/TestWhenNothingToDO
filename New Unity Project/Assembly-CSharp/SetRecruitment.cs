...
[ArgumentDescription(1, typeof(ulong), "ullUid", new object[] {  }), ArgumentDescription(2, typeof(uint), "worldID", new object[] {  }), ArgumentDescription(3, typeof(byte), "招募关系", new object[] {  }), CheatCommand("工具/SetRecruitment", "设置招募关系", 0x59)]
