...
{
    [CompilerGenerated]
    private uint <currentMainLineId>k__BackingField;
    [CompilerGenerated]
    private static CUIFormScript <FormGuideMask>k__BackingField;
    [CompilerGenerated]
    ...
    private NewbieGuideBaseScript AddScript(NewbieGuideScriptType type)
    {
        ...
        {
            return this.addScriptDelegate(type, base.get_gameObject());
        }
        return null;
    }
    ...
    public static void CloseGuideForm()
    {
        ...
        {
            FormGuideMask.get_transform().FindChild("GuideTextStatic").get_transform().get_gameObject().CustomSetActive(false);
    ...
    public static void OpenGuideForm()
    {
        if (FormGuideMask == null)
        {
            FormGuideMask = Singleton<CUIManager>.GetInstance().OpenForm(FormGuideMaskPath, true, true);
            if (FormGuideMask != null)
            {
                Transform transform = FormGuideMask.get_transform().FindChild("GuideTextStatic");
                if (transform != null)
                {
    ...
    private void Update()
    {
        ...
        {
            this.m_timeOutTimer -= Time.get_deltaTime();
    ...
    public uint currentMainLineId
    {
        ...
        get
        {
            return this.<currentMainLineId>k__BackingField;
        }
        [CompilerGenerated]
        private set
        {
            this.<currentMainLineId>k__BackingField = value;
        }
    }
