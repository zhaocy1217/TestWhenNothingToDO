...
public class ComponentWrap
{
    ...
    private static int BroadcastMessage(IntPtr L)
    {
        ...
        if ((num == 3) && LuaScriptMgr.CheckTypes(L, 1, typeof(Component), typeof(string), typeof(SendMessageOptions)))
        {
            ...
            component2.BroadcastMessage(str2, luaObject);
            return 0;
        }
        ...
        if (num == 4)
        {
            ...
            component4.BroadcastMessage(str4, obj3, options2);
            return 0;
        }
    ...
    private static int GetComponent(IntPtr L)
    {
        ...
        if ((num == 2) && LuaScriptMgr.CheckTypes(L, 1, typeof(Component), typeof(Type)))
        {
            ...
            LuaScriptMgr.Push(L, (Object) component4);
            return 1;
        }
    ...
    private static int GetComponentsInChildren(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            ...
            case 3:
            {
                ...
                Component[] o = component2.GetComponentsInChildren(type2, boolean);
    ...
    private static int GetComponentsInParent(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            ...
            case 3:
            {
                ...
                Type type2 = LuaScriptMgr.GetTypeObject(L, 2);
                bool boolean = LuaScriptMgr.GetBoolean(L, 3);
                Component[] o = component2.GetComponentsInParent(type2, boolean);
                LuaScriptMgr.PushArray(L, o);
                return 1;
            }
        }
    ...
    private static int SendMessage(IntPtr L)
    {
        ...
        if ((num == 3) && LuaScriptMgr.CheckTypes(L, 1, typeof(Component), typeof(string), typeof(SendMessageOptions)))
        {
            ...
            string str2 = LuaScriptMgr.GetString(L, 2);
            SendMessageOptions luaObject = (SendMessageOptions) ((int) LuaScriptMgr.GetLuaObject(L, 3));
            component2.SendMessage(str2, luaObject);
            return 0;
        }
        if ((num == 3) && LuaScriptMgr.CheckTypes(L, 1, typeof(Component), typeof(string), typeof(object)))
        {
        ...
        if (num == 4)
        {
            ...
            object obj3 = LuaScriptMgr.GetVarObject(L, 3);
            SendMessageOptions options2 = (SendMessageOptions) ((int) LuaScriptMgr.GetNetObject(L, 4, typeof(SendMessageOptions)));
            component4.SendMessage(str4, obj3, options2);
            return 0;
        }
    ...
    private static int SendMessageUpwards(IntPtr L)
    {
        ...
        if ((num == 3) && LuaScriptMgr.CheckTypes(L, 1, typeof(Component), typeof(string), typeof(SendMessageOptions)))
        {
            ...
            string str2 = LuaScriptMgr.GetString(L, 2);
            SendMessageOptions luaObject = (SendMessageOptions) ((int) LuaScriptMgr.GetLuaObject(L, 3));
            component2.SendMessageUpwards(str2, luaObject);
            return 0;
        }
        if ((num == 3) && LuaScriptMgr.CheckTypes(L, 1, typeof(Component), typeof(string), typeof(object)))
        {
        ...
        if (num == 4)
        {
            ...
            object obj3 = LuaScriptMgr.GetVarObject(L, 3);
            SendMessageOptions options2 = (SendMessageOptions) ((int) LuaScriptMgr.GetNetObject(L, 4, typeof(SendMessageOptions)));
            component4.SendMessageUpwards(str4, obj3, options2);
            return 0;
        }
