...
public class PreloadActionAssets
{
        ...
        while (enumerator.MoveNext())
        {
            ...
            switch (type)
            {
                ...
                case AssetRefType.SkillCombine:
                {
                    ...
                    ulong num = (ulong) pair4.Key;
                    int skillCombineID = (int) (num & 0xffffffffL);
                ...
                case AssetRefType.MonsterConfigId:
                {
                    ...
                    ulong num5 = (ulong) pair6.Key;
                    uint soldierID = (uint) (num5 & 0xffffffffL);
    ...
    {
        <Exec>c__Iterator26 iterator = new <Exec>c__Iterator26();
    ...
    {
        float num = Time.get_realtimeSinceStartup() - this.curTime;
    ...
    [CompilerGenerated]
    private sealed class <Exec>c__Iterator26 : IDisposable, IEnumerator, IEnumerator<object>
    {
        internal object $current;
        internal int $PC;
        internal PreloadActionAssets <>f__this;
        internal Action <action>__5;
        internal Dictionary<object, AssetRefType> <actionAssets>__2;
        internal string <actionName>__4;
        internal DictionaryView<string, Action> <actions>__1;
        internal DictionaryView<string, Action>.Enumerator <etr>__3;
        ...
        public bool MoveNext()
        {
            ...
            switch (num)
            {
                ...
                case 1:
                    this.<>f__this.curTime = Time.get_realtimeSinceStartup();
                    this.<startFrame>__0 = Time.get_frameCount();
                    if (ActionManager.Instance == null)
                    {
                        goto Label_05B3;
                    }
                    this.<actions>__1 = new DictionaryView<string, Action>();
                ...
                case 8:
                    ...
                    {
                        Object.Destroy(this.<instantiatedObjs>__15[this.<i>__18]);
                        this.<i>__18++;
                    }
                ...
                case 9:
                    this.<>f__this.loadTime += Time.get_realtimeSinceStartup() - this.<>f__this.curTime;
                    this.<frameCount>__19 = Time.get_frameCount() - this.<startFrame>__0;
                    goto Label_05B3;
        ...
        Label_029B:
            ...
            {
                this.<obj>__17 = Object.Instantiate(this.<prefabObjs>__8[this.<i>__16], this.<invalidPos>__14, Quaternion.get_identity()) as GameObject;
