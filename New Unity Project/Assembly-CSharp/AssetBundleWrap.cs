...
public class AssetBundleWrap
{
    ...
    private static int _CreateAssetBundle(IntPtr L)
    {
        if (LuaDLL.lua_gettop(L) == 0)
        {
            ...
            LuaScriptMgr.Push(L, (Object) bundle);
            return 1;
        }
    ...
    private static int get_mainAsset(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, luaObject.get_mainAsset());
        return 1;
    }
    ...
    private static int Load(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            case 2:
            {
                AssetBundle bundle = (AssetBundle) LuaScriptMgr.GetUnityObjectSelf(L, 1, "AssetBundle");
                string luaString = LuaScriptMgr.GetLuaString(L, 2);
                Object obj2 = bundle.Load(luaString);
            ...
            case 3:
            {
                ...
                Object obj3 = bundle2.Load(str2, typeObject);
    ...
    private static int LoadAll(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            case 1:
            {
                Object[] o = ((AssetBundle) LuaScriptMgr.GetUnityObjectSelf(L, 1, "AssetBundle")).LoadAll();
            ...
            case 2:
            {
                ...
                Object[] objArray2 = bundle2.LoadAll(typeObject);
