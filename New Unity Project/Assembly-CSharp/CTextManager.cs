...
public class CTextManager : Singleton<CTextManager>
{
    ...
    public string GetText(string key)
    {
        ...
        this.m_textMap.TryGetValue(key.JavaHashCode(), out str);
    ...
    public void LoadText(DatabinTable<ResText, ushort> textDataBin)
    {
        if (textDataBin != null)
        {
            ...
            while (enumerator.MoveNext())
            {
                ...
                this.m_textMap.Add(StringHelper.UTF8BytesToString(ref text.szKey).JavaHashCode(), StringHelper.UTF8BytesToString(ref text.szValue));
            }
        }
    }
}
