...
public class PlaneShadowSettings : MonoBehaviour
{
    ...
    public static Vector3 defaultProjDir = new Vector3(1f, -1f, 1f).get_normalized();
    public static Vector4 shadowParams = new Vector4(defaultFadeBegin, defaultFadeExp, defaultIntensity, 0f);
    public static Vector3 shadowProjDir = defaultProjDir;
    ...
    public void ApplySettings()
    {
        ...
        shadowProjDir = base.get_transform().get_forward().get_normalized();
