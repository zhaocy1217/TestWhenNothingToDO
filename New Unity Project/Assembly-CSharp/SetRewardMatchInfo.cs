...
[ArgumentDescription(ArgumentDescriptionAttribute.EDefaultValueTag.Tag, 3, typeof(int), "败场数", "-1", new object[] {  }), ArgumentDescription(ArgumentDescriptionAttribute.EDefaultValueTag.Tag, 2, typeof(int), "胜场数", "-1", new object[] {  }), ArgumentDescription(1, typeof(uint), "地图ID", new object[] {  }), ArgumentDescription(ArgumentDescriptionAttribute.EDefaultValueTag.Tag, 5, typeof(int), "全胜次数", "-1", new object[] {  }), ArgumentDescription(ArgumentDescriptionAttribute.EDefaultValueTag.Tag, 4, typeof(int), "比赛轮数", "-1", new object[] {  }), CheatCommand("通用/赏金赛/SetRewardMatchPoint", "变更赏金赛信息", 0x49)]
