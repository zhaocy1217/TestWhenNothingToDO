...
{
    [CompilerGenerated]
    private RVOController <rvo>k__BackingField;
    [CompilerGenerated]
    ...
    Label_0088:
        if (this.currentWaypointIndex < (vectorPath.Count - 1))
        {
            ...
            if (num == 0)
            {
                ...
                this.lastFoundWaypointTime = Time.get_time();
    ...
    public void Move(out VInt3 targetDir, int dt)
    {
        ...
        if (!this.targetReached && this.canMove)
        {
            ...
            bool flag = (this.rvo != null) && this.rvo.get_enabled();
            bool collided = false;
    ...
    {
        if ((this.rvo != null) && this.rvo.get_enabled())
        {
    ...
    public bool hasCollidedWithAgents
    {
        get
        {
            return ((((this.rvo != null) && this.rvo.get_enabled()) && (this.rvo.rvoAgent != null)) && this.rvo.rvoAgent.hasCollided);
        }
    }
    ...
    public RVOController rvo
    {
        ...
        get
        {
            return this.<rvo>k__BackingField;
        }
        [CompilerGenerated]
        protected set
        {
            this.<rvo>k__BackingField = value;
        }
    }
