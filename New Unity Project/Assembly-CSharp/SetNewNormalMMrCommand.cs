...
[ArgumentDescription(1, typeof(int), "MMR", new object[] {  }), ArgumentDescription(0, typeof(int), "MMR类型", new object[] {  }), ArgumentDescription(3, typeof(int), "总场数", new object[] {  }), ArgumentDescription(4, typeof(int), "连胜场数", new object[] {  }), ArgumentDescription(5, typeof(int), "连负场数", new object[] {  }), CheatCommand("英雄/属性/SetNewNormalMMr", "新MMR设置", 0x47), ArgumentDescription(2, typeof(int), "胜场", new object[] {  })]
