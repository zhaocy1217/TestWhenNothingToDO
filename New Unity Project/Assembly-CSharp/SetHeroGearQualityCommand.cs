...
[ArgumentDescription(2, typeof(int), "装备品阶", new object[] {  }), CheatCommand("英雄/属性修改/数值/SetGearQyality", "设置所有装备品阶", 0x2d), ArgumentDescription(1, typeof(int), "装备品质", new object[] {  }), ArgumentDescription(0, typeof(int), "ID", new object[] {  })]
