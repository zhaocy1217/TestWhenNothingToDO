namespace com.tencent.pandora
{
    ...
    public class Facade
    {
        ...
        public virtual void RegisterCommand(string commandName, Type commandType)
        {
            ...
            Logger.d("RegisterCommand(commandName, commandType);");
        }
        ...
        public void SendMessageCommand(string message, object body = new object())
        {
            Logger.d("  send message :" + message);
            this.m_controller.ExecuteCommand(new Message(message, body));
            Logger.d("execute command finished " + message);
        }
