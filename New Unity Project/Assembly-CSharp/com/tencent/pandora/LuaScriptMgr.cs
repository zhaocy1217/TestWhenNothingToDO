namespace com.tencent.pandora
{
    ...
    public class LuaScriptMgr
    {
        ...
        [CompilerGenerated]
        private static LuaScriptMgr <Instance>k__BackingField;
        ...
        public LuaScriptMgr()
        {
            ...
            this.DoFile = new FileExecutor(this.DefaultFileExecutor);
            LuaDLL.luaopen_cjson(this.lua.L);
            LuaDLL.luaopen_cjson_safe(this.lua.L);
            if ((Application.get_platform() == 8) || (Application.get_platform() == null))
            {
        ...
        {
            Type c = GetLuaObject(L, pos).GetType();
            if (t == c)
            {
                return true;
            }
        ...
        public void FixedUpdate()
        {
            ...
            {
                this.fixedUpdateFunc.Call((double) Time.get_fixedDeltaTime());
            }
        }
        ...
        public static Bounds GetBounds(IntPtr L, int stackPos)
        {
            ...
            return new Bounds(vector, new Vector3(num4, num5, num6));
        }
        ...
        public static Ray GetRay(IntPtr L, int stackPos)
        {
            ...
            Vector3 vector = new Vector3(x, y, z);
            return new Ray(vector, new Vector3(num4, num5, num6));
        }
        ...
        public static int NewIndexArray(IntPtr L)
        {
            ...
            Type elementType = luaObject.GetType().GetElementType();
        ...
        private void PrintLua(params string[] param)
        {
            ...
            {
                object[] args = new object[] { param[1] };
                this.CallLuaFunction("PrintLua", args);
            }
        }
        ...
        public static void Push(IntPtr L, Bounds bound)
        {
            ...
            Push(L, bound.get_center());
            Push(L, bound.get_size());
        ...
        public static void Push(IntPtr L, Ray ray)
        {
            ...
            LuaDLL.tolua_pushfloat3(L, mgrFromLuaState.packVec3, ray.get_direction().x, ray.get_direction().y, ray.get_direction().z);
            LuaDLL.tolua_pushfloat3(L, mgrFromLuaState.packVec3, ray.get_origin().x, ray.get_origin().y, ray.get_origin().z);
            LuaDLL.lua_call(L, 2, -1);
        }
        ...
        public static void Push(IntPtr L, RaycastHit hit)
        {
            ...
            Push(L, (Object) hit.get_collider());
            Push(L, hit.get_distance());
            Push(L, hit.get_normal());
            Push(L, hit.get_point());
            Push(L, (Object) hit.get_rigidbody());
            Push(L, (Object) hit.get_transform());
        ...
        public static void Push(IntPtr L, Touch touch)
        {
            ...
            LuaDLL.lua_pushinteger(L, touch.get_fingerId());
            LuaDLL.tolua_pushfloat2(L, mgrFromLuaState.packVec2, touch.get_position().x, touch.get_position().y);
            LuaDLL.tolua_pushfloat2(L, mgrFromLuaState.packVec2, touch.get_rawPosition().x, touch.get_rawPosition().y);
            LuaDLL.tolua_pushfloat2(L, mgrFromLuaState.packVec2, touch.get_deltaPosition().x, touch.get_deltaPosition().y);
            LuaDLL.lua_pushnumber(L, (double) touch.get_deltaTime());
            LuaDLL.lua_pushinteger(L, touch.get_tapCount());
            LuaDLL.lua_pushinteger(L, touch.get_phase());
        ...
        private static bool PushLuaTable(IntPtr L, string fullPath)
        {
            ...
            if (LuaDLL.lua_type(L, -1) != LuaTypes.LUA_TTABLE)
            {
                LuaDLL.lua_settop(L, newTop);
                LuaDLL.lua_pushnil(L);
                Debug.LogError("Push lua table " + strArray[0] + " failed");
                return false;
            }
        ...
        public static void PushVarObject(IntPtr L, object o)
        {
            ...
            else
            {
                ...
                else if (child.IsSubclassOf(typeof(Object)))
                {
        ...
        public void Start()
        {
            ...
            foreach (Type type in checkBaseType)
            {
                Debug.LogWarning("BaseType " + type.FullName + " not register to lua");
            }
            checkBaseType.Clear();
        }
        ...
        public void Update()
        {
            if (this.updateFunc != null)
            {
                ...
                Push(luaState, Time.get_deltaTime());
                Push(luaState, Time.get_unscaledDeltaTime());
