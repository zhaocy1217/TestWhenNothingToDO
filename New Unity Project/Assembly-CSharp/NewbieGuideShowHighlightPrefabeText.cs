...
internal class NewbieGuideShowHighlightPrefabeText : NewbieGuideBaseScript
{
    ...
    protected override void Update()
    {
        ...
        else
        {
            ...
            if (form != null)
            {
                Transform transform = form.GetWidget(0x36).get_transform();
                this.info = transform.FindChild("info").get_gameObject();
                this.highlighter = transform.FindChild("highlighter").get_gameObject();
