...
public class TypeWrap
{
    ...
    private static int Equals(IntPtr L)
    {
        ...
        {
            Type varObject = LuaScriptMgr.GetVarObject(L, 1) as Type;
        ...
        {
            Type type3 = LuaScriptMgr.GetVarObject(L, 1) as Type;
    ...
    {
        <FindInterfaces>c__AnonStorey94 storey = new <FindInterfaces>c__AnonStorey94();
        storey.L = L;
        LuaScriptMgr.CheckArgsCount(storey.L, 3);
        Type typeObject = LuaScriptMgr.GetTypeObject(storey.L, 1);
        TypeFilter filter = null;
        if (LuaDLL.lua_type(storey.L, 2) != LuaTypes.LUA_TFUNCTION)
        {
            filter = (TypeFilter) LuaScriptMgr.GetNetObject(storey.L, 2, typeof(TypeFilter));
        }
        else
        {
            <FindInterfaces>c__AnonStorey93 storey2 = new <FindInterfaces>c__AnonStorey93();
            storey2.<>f__ref$148 = storey;
            storey2.func = LuaScriptMgr.GetLuaFunction(storey.L, 2);
            filter = new TypeFilter(storey2.<>m__A9);
        }
        object varObject = LuaScriptMgr.GetVarObject(storey.L, 3);
    ...
    {
        <FindMembers>c__AnonStorey96 storey = new <FindMembers>c__AnonStorey96();
        storey.L = L;
        ...
        {
            <FindMembers>c__AnonStorey95 storey2 = new <FindMembers>c__AnonStorey95();
            storey2.<>f__ref$150 = storey;
            storey2.func = LuaScriptMgr.GetLuaFunction(storey.L, 4);
            filter = new MemberFilter(storey2.<>m__AA);
        }
    ...
    {
        Type luaObject = (Type) LuaScriptMgr.GetLuaObject(L, 1);
        if (luaObject == null)
        {
    ...
    private static int GetConstructor(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            ...
            case 5:
            {
                Type type2 = LuaScriptMgr.GetTypeObject(L, 1);
                ...
                Type[] types = LuaScriptMgr.GetArrayObject<Type>(L, 4);
            ...
            case 6:
            {
                Type type3 = LuaScriptMgr.GetTypeObject(L, 1);
                ...
                Type[] typeArray3 = LuaScriptMgr.GetArrayObject<Type>(L, 5);
    ...
    {
        LuaScriptMgr.CheckArgsCount(L, 1);
        Type elementType = LuaScriptMgr.GetTypeObject(L, 1).GetElementType();
    ...
    {
        LuaScriptMgr.CheckArgsCount(L, 1);
        Type[] genericArguments = LuaScriptMgr.GetTypeObject(L, 1).GetGenericArguments();
    ...
    {
        LuaScriptMgr.CheckArgsCount(L, 1);
        Type[] genericParameterConstraints = LuaScriptMgr.GetTypeObject(L, 1).GetGenericParameterConstraints();
    ...
    {
        LuaScriptMgr.CheckArgsCount(L, 1);
        Type genericTypeDefinition = LuaScriptMgr.GetTypeObject(L, 1).GetGenericTypeDefinition();
    ...
    private static int GetInterface(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            case 2:
            {
                Type typeObject = LuaScriptMgr.GetTypeObject(L, 1);
                string luaString = LuaScriptMgr.GetLuaString(L, 2);
                Type o = typeObject.GetInterface(luaString);
            ...
            case 3:
            {
                ...
                Type type4 = type3.GetInterface(name, boolean);
    ...
    private static int GetInterfaceMap(IntPtr L)
    {
        ...
        Type typeObject = LuaScriptMgr.GetTypeObject(L, 1);
        Type interfaceType = LuaScriptMgr.GetTypeObject(L, 2);
    ...
    {
        LuaScriptMgr.CheckArgsCount(L, 1);
        Type[] interfaces = LuaScriptMgr.GetTypeObject(L, 1).GetInterfaces();
    ...
    private static int GetMethod(IntPtr L)
    {
        ...
        if (num == 4)
        {
            Type type4 = LuaScriptMgr.GetTypeObject(L, 1);
            string str4 = LuaScriptMgr.GetLuaString(L, 2);
            Type[] types = LuaScriptMgr.GetArrayObject<Type>(L, 3);
        ...
        if (num == 6)
        {
            Type type5 = LuaScriptMgr.GetTypeObject(L, 1);
        ...
        if (num == 7)
        {
            Type type6 = LuaScriptMgr.GetTypeObject(L, 1);
            ...
            Type[] typeArray4 = LuaScriptMgr.GetArrayObject<Type>(L, 6);
    ...
    private static int GetNestedType(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            ...
            case 3:
            {
                ...
                string name = LuaScriptMgr.GetLuaString(L, 2);
                BindingFlags bindingAttr = (BindingFlags) ((int) LuaScriptMgr.GetNetObject(L, 3, typeof(BindingFlags)));
                Type o = type3.GetNestedType(name, bindingAttr);
                LuaScriptMgr.Push(L, o);
                return 1;
            }
        }
    ...
    private static int GetNestedTypes(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            case 1:
            {
                Type[] nestedTypes = LuaScriptMgr.GetTypeObject(L, 1).GetNestedTypes();
            ...
            case 2:
            {
                Type typeObject = LuaScriptMgr.GetTypeObject(L, 1);
                BindingFlags bindingAttr = (BindingFlags) ((int) LuaScriptMgr.GetNetObject(L, 2, typeof(BindingFlags)));
                Type[] o = typeObject.GetNestedTypes(bindingAttr);
                LuaScriptMgr.PushArray(L, o);
                return 1;
            }
        }
    ...
    private static int GetProperty(IntPtr L)
    {
        ...
        if ((num == 3) && LuaScriptMgr.CheckTypes(L, 1, typeof(Type), typeof(string), typeof(Type)))
        {
            Type type3 = LuaScriptMgr.GetTypeObject(L, 1);
            string str3 = LuaScriptMgr.GetString(L, 2);
            Type returnType = LuaScriptMgr.GetTypeObject(L, 3);
        ...
        if (num == 4)
        {
            Type type6 = LuaScriptMgr.GetTypeObject(L, 1);
            string str5 = LuaScriptMgr.GetLuaString(L, 2);
            Type type7 = LuaScriptMgr.GetTypeObject(L, 3);
            Type[] types = LuaScriptMgr.GetArrayObject<Type>(L, 4);
        ...
        if (num == 5)
        {
            Type type8 = LuaScriptMgr.GetTypeObject(L, 1);
            string str6 = LuaScriptMgr.GetLuaString(L, 2);
            Type type9 = LuaScriptMgr.GetTypeObject(L, 3);
            Type[] typeArray3 = LuaScriptMgr.GetArrayObject<Type>(L, 4);
            ParameterModifier[] modifiers = LuaScriptMgr.GetArrayObject<ParameterModifier>(L, 5);
        ...
        if (num == 7)
        {
            Type type10 = LuaScriptMgr.GetTypeObject(L, 1);
            string str7 = LuaScriptMgr.GetLuaString(L, 2);
            BindingFlags bindingAttr = (BindingFlags) ((int) LuaScriptMgr.GetNetObject(L, 3, typeof(BindingFlags)));
            Binder binder = (Binder) LuaScriptMgr.GetNetObject(L, 4, typeof(Binder));
            Type type11 = LuaScriptMgr.GetTypeObject(L, 5);
            Type[] typeArray4 = LuaScriptMgr.GetArrayObject<Type>(L, 6);
    ...
    private static int GetType(IntPtr L)
    {
        ...
        if (num == 1)
        {
            Type type = LuaScriptMgr.GetTypeObject(L, 1).GetType();
            LuaScriptMgr.Push(L, type);
            return 1;
        }
        if ((num == 1) && LuaScriptMgr.CheckTypes(L, 1, typeof(string)))
        {
            Type o = Type.GetType(LuaScriptMgr.GetString(L, 1));
            LuaScriptMgr.Push(L, o);
            return 1;
        }
        if (num == 2)
        {
            ...
            Type type4 = Type.GetType(luaString, boolean);
            LuaScriptMgr.Push(L, type4);
            return 1;
        }
        if (num == 3)
        {
            ...
            Type type5 = Type.GetType(typeName, throwOnError, ignoreCase);
    ...
    {
        LuaScriptMgr.CheckArgsCount(L, 1);
        Type[] o = Type.GetTypeArray(LuaScriptMgr.GetArrayObject<object>(L, 1));
        LuaScriptMgr.PushArray(L, o);
        return 1;
    }
    ...
    {
        LuaScriptMgr.CheckArgsCount(L, 1);
        TypeCode typeCode = Type.GetTypeCode(LuaScriptMgr.GetTypeObject(L, 1));
    ...
    private static int GetTypeFromCLSID(IntPtr L)
    {
        ...
        if ((num == 2) && LuaScriptMgr.CheckTypes(L, 1, typeof(Guid), typeof(string)))
        {
            ...
            Type o = Type.GetTypeFromCLSID(luaObject, server);
            LuaScriptMgr.Push(L, o);
            return 1;
        }
        if ((num == 2) && LuaScriptMgr.CheckTypes(L, 1, typeof(Guid), typeof(bool)))
        {
            ...
            Type type3 = Type.GetTypeFromCLSID(guid3, throwOnError);
        ...
        if (num == 3)
        {
            ...
            string luaString = LuaScriptMgr.GetLuaString(L, 2);
            bool boolean = LuaScriptMgr.GetBoolean(L, 3);
            Type type4 = Type.GetTypeFromCLSID(guid4, luaString, boolean);
            LuaScriptMgr.Push(L, type4);
            return 1;
        }
    ...
    private static int GetTypeFromProgID(IntPtr L)
    {
        ...
        if (num == 1)
        {
            Type typeFromProgID = Type.GetTypeFromProgID(LuaScriptMgr.GetLuaString(L, 1));
        ...
        if ((num == 2) && LuaScriptMgr.CheckTypes(L, 1, typeof(string), typeof(string)))
        {
            ...
            string server = LuaScriptMgr.GetString(L, 2);
            Type o = Type.GetTypeFromProgID(progID, server);
            LuaScriptMgr.Push(L, o);
            return 1;
        }
        if ((num == 2) && LuaScriptMgr.CheckTypes(L, 1, typeof(string), typeof(bool)))
        {
            ...
            bool throwOnError = LuaDLL.lua_toboolean(L, 2);
            Type type3 = Type.GetTypeFromProgID(str4, throwOnError);
            LuaScriptMgr.Push(L, type3);
            return 1;
        }
        if (num == 3)
        {
            ...
            string str6 = LuaScriptMgr.GetLuaString(L, 2);
            bool boolean = LuaScriptMgr.GetBoolean(L, 3);
            Type type4 = Type.GetTypeFromProgID(luaString, str6, boolean);
            LuaScriptMgr.Push(L, type4);
            return 1;
        }
    ...
    {
        LuaScriptMgr.CheckArgsCount(L, 1);
        RuntimeTypeHandle typeHandle = Type.GetTypeHandle(LuaScriptMgr.GetVarObject(L, 1));
    ...
    private static int IsAssignableFrom(IntPtr L)
    {
        LuaScriptMgr.CheckArgsCount(L, 2);
        Type typeObject = LuaScriptMgr.GetTypeObject(L, 1);
        Type c = LuaScriptMgr.GetTypeObject(L, 2);
    ...
    private static int MakeArrayType(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            case 1:
            {
                Type o = LuaScriptMgr.GetTypeObject(L, 1).MakeArrayType();
                LuaScriptMgr.Push(L, o);
                return 1;
            }
            case 2:
            {
                ...
                Type type4 = typeObject.MakeArrayType(number);
                LuaScriptMgr.Push(L, type4);
                return 1;
            }
        }
    ...
    {
        LuaScriptMgr.CheckArgsCount(L, 1);
        Type o = LuaScriptMgr.GetTypeObject(L, 1).MakeByRefType();
        LuaScriptMgr.Push(L, o);
        return 1;
    }
    ...
    private static int MakeGenericType(IntPtr L)
    {
        int num = LuaDLL.lua_gettop(L);
        Type typeObject = LuaScriptMgr.GetTypeObject(L, 1);
        Type[] typeArguments = LuaScriptMgr.GetParamsObject<Type>(L, 2, num - 1);
        Type o = typeObject.MakeGenericType(typeArguments);
        LuaScriptMgr.Push(L, o);
        return 1;
    }
    ...
    {
        LuaScriptMgr.CheckArgsCount(L, 1);
        Type o = LuaScriptMgr.GetTypeObject(L, 1).MakePointerType();
        LuaScriptMgr.Push(L, o);
        return 1;
    }
    ...
    private static int ReflectionOnlyGetType(IntPtr L)
    {
        ...
        bool boolean = LuaScriptMgr.GetBoolean(L, 2);
        bool ignoreCase = LuaScriptMgr.GetBoolean(L, 3);
        Type o = Type.ReflectionOnlyGetType(luaString, boolean, ignoreCase);
        LuaScriptMgr.Push(L, o);
        return 1;
    }
    ...
    [CompilerGenerated]
    private sealed class <FindInterfaces>c__AnonStorey93
    {
        internal TypeWrap.<FindInterfaces>c__AnonStorey94 <>f__ref$148;
        internal LuaFunction func;

        internal bool <>m__A9(Type param0, object param1)
        {
            int oldTop = this.func.BeginPCall();
            LuaScriptMgr.Push(this.<>f__ref$148.L, param0);
            LuaScriptMgr.PushVarObject(this.<>f__ref$148.L, param1);
    ...
    [CompilerGenerated]
    private sealed class <FindInterfaces>c__AnonStorey94
    {
        internal IntPtr L;
    }

    [CompilerGenerated]
    private sealed class <FindMembers>c__AnonStorey95
    {
        internal TypeWrap.<FindMembers>c__AnonStorey96 <>f__ref$150;
        internal LuaFunction func;

        internal bool <>m__AA(MemberInfo param0, object param1)
        {
            int oldTop = this.func.BeginPCall();
            LuaScriptMgr.PushObject(this.<>f__ref$150.L, param0);
            LuaScriptMgr.PushVarObject(this.<>f__ref$150.L, param1);
            this.func.PCall(oldTop, 2);
            object[] objArray = this.func.PopValues(oldTop);
            this.func.EndPCall(oldTop);
            return (bool) objArray[0];
    ...
    [CompilerGenerated]
    private sealed class <FindMembers>c__AnonStorey96
    {
        internal IntPtr L;
    }
}
