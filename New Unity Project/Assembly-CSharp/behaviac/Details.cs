namespace behaviac
{
    ...
    {
        private static DictionaryView<Type, ICompareValue> ms_comparers;
        private static DictionaryView<Type, IComputeValue> ms_computers;

        public static object ComputeValue(object value1, object value2, EComputeOperator opr)
        {
            Type key = value1.GetType();
        ...
        {
            ms_comparers = new DictionaryView<Type, ICompareValue>();
        ...
        {
            ms_computers = new DictionaryView<Type, IComputeValue>();
