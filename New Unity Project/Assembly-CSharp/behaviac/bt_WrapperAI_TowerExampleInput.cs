namespace behaviac
{
    ...
    public static class bt_WrapperAI_TowerExampleInput
    {
        public static bool build_behavior_tree(BehaviorTree bt)
        {
            ...
            pChild.SetId(0);
            bt.AddChild(pChild);
            Assignment_bt_WrapperAI_TowerExampleInput_node82 _node = new Assignment_bt_WrapperAI_TowerExampleInput_node82();
            _node.SetClassNameString("Assignment");
            _node.SetId(0x52);
            pChild.AddChild(_node);
            pChild.SetHasEvents(pChild.HasEvents() | _node.HasEvents());
            DecoratorLoop_bt_WrapperAI_TowerExampleInput_node28 _node2 = new DecoratorLoop_bt_WrapperAI_TowerExampleInput_node28();
