    ...
    public class Agent : MonoBehaviour
    {
        ...
        private void _btsetcurrent(string relativePath, TriggerMode triggerMode, bool bByEvent)
        {
            if (!string.IsNullOrEmpty(relativePath))
            {
                ...
                {
                    string str = base.GetType().FullName + "::" + base.get_name();
                }
                else
                {
        ...
        protected void Init()
        {
            Init_(this.m_contextId, this, this.m_priority, base.get_name());
        }
        ...
        public void SetName(string instanceName)
        {
            if (string.IsNullOrEmpty(instanceName))
            {
                ...
                base.set_name(base.get_name() + string.Format("{0}_{1}_{2}", str2, num, this.m_id));
            }
            else
            {
                base.set_name(instanceName);
            }
        }
