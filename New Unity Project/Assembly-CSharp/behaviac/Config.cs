namespace behaviac
{
    ...
    public static class Config
    {
        ...
        private static readonly bool ms_bIsDesktopEditor = ((Application.get_platform() == 7) || (Application.get_platform() == 1));
        private static readonly bool ms_bIsDesktopPlayer = ((Application.get_platform() == 2) || (Application.get_platform() == 1));
