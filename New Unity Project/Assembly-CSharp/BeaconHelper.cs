...
public class BeaconHelper : Singleton<BeaconHelper>
{
    ...
    public void Event_ApplicationPause(bool pause)
    {
        if (!Singleton<BattleLogic>.instance.isRuning)
        {
            ...
            events.Add(new KeyValuePair<string, string>("GameType", Singleton<GameBuilder>.GetInstance().m_kGameType.ToString()));
            events.Add(new KeyValuePair<string, string>("MapID", Singleton<GameBuilder>.GetInstance().m_iMapId.ToString()));
            events.Add(new KeyValuePair<string, string>("Status", pause.ToString()));
            if (pause)
            {
            ...
            {
                float num = Time.get_time() - m_Time;
    ...
    public void EventPhotoReport(string status, float totalTime, string errorCode)
    {
        List<KeyValuePair<string, string>> events = new List<KeyValuePair<string, string>>();
        events.Add(new KeyValuePair<string, string>("WorldID", MonoSingleton<TdirMgr>.GetInstance().SelectedTdir.logicWorldID.ToString()));
        events.Add(new KeyValuePair<string, string>("status", status));
        events.Add(new KeyValuePair<string, string>("totaltime", totalTime.ToString()));
        events.Add(new KeyValuePair<string, string>("errorCode", errorCode));
    ...
    public void ReportBuyDianEvent()
    {
        try
        {
            if (!string.IsNullOrEmpty(this.m_curBuyDianInfo.buy_dia_channel))
            {
                ...
                events.Add(new KeyValuePair<string, string>("WorldID", MonoSingleton<TdirMgr>.GetInstance().SelectedTdir.logicWorldID.ToString()));
                events.Add(new KeyValuePair<string, string>("platform", Singleton<ApolloHelper>.GetInstance().CurPlatform.ToString()));
                events.Add(new KeyValuePair<string, string>("openid", Singleton<ApolloHelper>.GetInstance().GetOpenID()));
                events.Add(new KeyValuePair<string, string>("buy_dia_channel", this.m_curBuyDianInfo.buy_dia_channel));
                events.Add(new KeyValuePair<string, string>("buy_dia_id", this.m_curBuyDianInfo.buy_dia_id));
                events.Add(new KeyValuePair<string, string>("pay_type_result", this.m_curBuyDianInfo.pay_type_result));
                events.Add(new KeyValuePair<string, string>("callback_result", this.m_curBuyDianInfo.callback_result));
                events.Add(new KeyValuePair<string, string>("apollo_stage", this.m_curBuyDianInfo.apollo_stage));
                events.Add(new KeyValuePair<string, string>("apollo_result", this.m_curBuyDianInfo.apollo_result));
                events.Add(new KeyValuePair<string, string>("buy_quantity", this.m_curBuyDianInfo.buy_quantity));
                events.Add(new KeyValuePair<string, string>("callback_time", this.m_curBuyDianInfo.call_back_time.ToString()));
    ...
    public void ReportBuyPropEvent(string buy_prop_id_result)
    {
        try
        {
            if (!string.IsNullOrEmpty(this.m_curBuyPropInfo.buy_prop_channel))
            {
                ...
                events.Add(new KeyValuePair<string, string>("platform", Singleton<ApolloHelper>.GetInstance().CurPlatform.ToString()));
                events.Add(new KeyValuePair<string, string>("openid", "NULL"));
                events.Add(new KeyValuePair<string, string>("buy_prop_channel", this.m_curBuyPropInfo.buy_prop_channel));
                events.Add(new KeyValuePair<string, string>("buy_prop_id", this.m_curBuyPropInfo.buy_prop_id));
                events.Add(new KeyValuePair<string, string>("buy_quantity", this.m_curBuyPropInfo.buy_quantity));
                events.Add(new KeyValuePair<string, string>("buy_prop_way", this.m_curBuyPropInfo.buy_prop_way));
                events.Add(new KeyValuePair<string, string>("buy_prop_id_result", buy_prop_id_result));
                float num = Time.get_time() - this.m_curBuyPropInfo.buy_prop_id_time;
    ...
    public void ReportOpenBuyDianEvent(DateTime curTime)
    {
        try
        {
            if (!string.IsNullOrEmpty(this.m_curBuyDianInfo.buy_dia_channel))
            {
                ...
                events.Add(new KeyValuePair<string, string>("platform", Singleton<ApolloHelper>.GetInstance().CurPlatform.ToString()));
                events.Add(new KeyValuePair<string, string>("openid", "NULL"));
                events.Add(new KeyValuePair<string, string>("openpage_channel", this.m_curBuyDianInfo.buy_dia_channel));
                events.Add(new KeyValuePair<string, string>("buy_dia_id", this.m_curBuyDianInfo.buy_dia_id));
                events.Add(new KeyValuePair<string, string>("openpage_time", curTime.ToString()));
