...
public class CSignalTipShower : MonoBehaviour
{
    ...
    public static void Preload(ref ActorPreloadTab preloadTab)
    {
        ...
        preloadTab.AddSprite(S_Bg_Green);
        preloadTab.AddSprite(S_Bg_Blue);
    }
    ...
    private void Show(CSignalTips data, CUIFormScript formScript)
    {
        if (data != null)
        {
            ...
            this.SetHeroHeadIcon(this.leftIcon.get_gameObject().GetComponent<Image>(), formScript, dataByKey);
            ...
            {
                component.SetSprite(str, formScript, true, false, false, false);
            }
            ...
            if (image != null)
            {
                image.SetSprite(info2.szUIIcon, formScript, true, false, false, false);
            }
            if (this.signal_txt != null)
            {
                this.signal_txt.set_text(info2.szText);
            }
            ...
            {
                case 1:
                    image3.SetSprite(S_kn_Tower_Icon, formScript, true, false, false, false);
                    goto Label_0223;

                case 2:
                    image3.SetSprite(S_Base_blue_Icon, formScript, true, false, false, false);
                    goto Label_0223;
                ...
                case 4:
                    image3.SetSprite(S_Dragon_big_Icon, formScript, true, false, false, false);
                    goto Label_0223;

                case 5:
                    image3.SetSprite(S_kn_dragon_Icon, formScript, true, false, false, false);
                    goto Label_0223;
                ...
                if ((hostPlayer != null) && (playerByUid != null))
                {
                    ...
                    if (this.bg_icon != null)
                    {
                        ...
                        if (this.inbattlemsg_txt != null)
                        {
                            ...
                            this.inbattlemsg_txt.get_gameObject().CustomSetActive(true);
                        }
