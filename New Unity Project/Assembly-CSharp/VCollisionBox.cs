...
public class VCollisionBox : VCollisionShape
{
    ...
    public VInt3 ClosestPoint(VInt3 targetPoint)
    {
        ...
        int num3 = this.worldExtends.x * 0x3e8;
        int num4 = this.worldExtends.y * 0x3e8;
        int num5 = this.worldExtends.z * 0x3e8;
        worldPos += IntMath.Divide(this.axis[0], (long) Mathf.Clamp(VInt3.Dot(ref lhs, ref this.axis[0]), -num3, num3), 0xf4240L);
    ...
    public Vector3[] GetPoints()
    {
        ...
        for (int i = 0; i < 8; i++)
        {
            vector.x = vectorArray[i].x * worldExtends.x;
            vector.y = vectorArray[i].y * worldExtends.y;
            vector.z = vectorArray[i].z * worldExtends.z;
            Vector3 vector2 = (Vector3) (vector5 * vector.x);
            vector2 += (Vector3) (vector6 * vector.y);
            vector2 += (Vector3) (vector7 * vector.z);
    ...
    public bool IntersectsOBB(VCollisionBox b)
    {
        ...
        lhs = new VInt3(IntMath.Divide(VInt3.Dot(ref lhs, ref this.axis[0]), 0x3e8), IntMath.Divide(VInt3.Dot(ref lhs, ref this.axis[1]), 0x3e8), IntMath.Divide(VInt3.Dot(ref lhs, ref this.axis[2]), 0x3e8));
