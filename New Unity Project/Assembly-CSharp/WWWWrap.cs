...
public class WWWWrap
{
    ...
    private static int _CreateWWW(IntPtr L)
    {
        ...
        if ((num == 2) && LuaScriptMgr.CheckTypes(L, 1, typeof(string), typeof(byte[])))
        {
            ...
            WWW www2 = new WWW(str2, arrayNumber);
        ...
        if (num == 3)
        {
            ...
            byte[] buffer2 = LuaScriptMgr.GetArrayNumber<byte>(L, 2);
            Dictionary<string, string> dictionary = (Dictionary<string, string>) LuaScriptMgr.GetNetObject(L, 3, typeof(Dictionary<string, string>));
            WWW www4 = new WWW(str4, buffer2, dictionary);
    ...
    private static int EscapeURL(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            ...
            case 2:
            {
                ...
                string str4 = WWW.EscapeURL(luaString, encoding);
    ...
    private static int get_assetBundle(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_assetBundle());
        return 1;
    }
    ...
    private static int get_audioClip(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_audioClip());
        return 1;
    }
    ...
    private static int get_bytes(IntPtr L)
    {
        ...
        LuaScriptMgr.PushArray(L, luaObject.get_bytes());
        return 1;
    }
    ...
    private static int get_bytesDownloaded(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, luaObject.get_bytesDownloaded());
        return 1;
    }
    ...
    private static int get_error(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, luaObject.get_error());
        return 1;
    }
    ...
    private static int get_isDone(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, luaObject.get_isDone());
        return 1;
    }
    ...
    private static int get_progress(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, luaObject.get_progress());
        return 1;
    }
    ...
    private static int get_responseHeaders(IntPtr L)
    {
        ...
        LuaScriptMgr.PushObject(L, luaObject.get_responseHeaders());
        return 1;
    }
    ...
    private static int get_textureNonReadable(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Object) luaObject.get_textureNonReadable());
        return 1;
    }
    ...
    private static int get_threadPriority(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, (Enum) luaObject.get_threadPriority());
        return 1;
    }
    ...
    private static int get_uploadProgress(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, luaObject.get_uploadProgress());
        return 1;
    }
    ...
    private static int get_url(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, luaObject.get_url());
        return 1;
    }
    ...
    private static int GetAudioClip(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            ...
            case 3:
            {
                ...
                bool flag2 = LuaScriptMgr.GetBoolean(L, 2);
                bool flag3 = LuaScriptMgr.GetBoolean(L, 3);
                AudioClip clip2 = www2.GetAudioClip(flag2, flag3);
                LuaScriptMgr.Push(L, (Object) clip2);
                return 1;
            }
            case 4:
            {
                ...
                AudioType type = (AudioType) ((int) LuaScriptMgr.GetNetObject(L, 4, typeof(AudioType)));
                AudioClip clip3 = www3.GetAudioClip(flag4, flag5, type);
                LuaScriptMgr.Push(L, (Object) clip3);
                return 1;
            }
        }
    ...
    private static int GetAudioClipCompressed(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            case 1:
            {
                ...
                LuaScriptMgr.Push(L, (Object) audioClipCompressed);
                return 1;
            }
            case 2:
            {
            ...
            case 3:
            {
                WWW www3 = (WWW) LuaScriptMgr.GetNetObjectSelf(L, 1, "WWW");
                bool flag2 = LuaScriptMgr.GetBoolean(L, 2);
                AudioType type = (AudioType) ((int) LuaScriptMgr.GetNetObject(L, 3, typeof(AudioType)));
                AudioClip clip3 = www3.GetAudioClipCompressed(flag2, type);
                LuaScriptMgr.Push(L, (Object) clip3);
                return 1;
            }
        }
    ...
    private static int LoadFromCacheOrDownload(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            ...
            case 3:
            {
                string str2 = LuaScriptMgr.GetLuaString(L, 1);
                int num3 = (int) LuaScriptMgr.GetNumber(L, 2);
                uint num4 = (uint) LuaScriptMgr.GetNumber(L, 3);
                WWW www2 = WWW.LoadFromCacheOrDownload(str2, num3, num4);
                LuaScriptMgr.PushObject(L, www2);
                return 1;
            }
        }
    ...
    private static int LoadImageIntoTexture(IntPtr L)
    {
        ...
        WWW www = (WWW) LuaScriptMgr.GetNetObjectSelf(L, 1, "WWW");
        Texture2D textured = LuaScriptMgr.GetUnityObject(L, 2, typeof(Texture2D));
        www.LoadImageIntoTexture(textured);
        return 0;
    }
    ...
    private static int set_threadPriority(IntPtr L)
    {
        ...
        luaObject.set_threadPriority((ThreadPriority) ((int) LuaScriptMgr.GetNetObject(L, 3, typeof(ThreadPriority))));
        return 0;
    }
    ...
    private static int UnEscapeURL(IntPtr L)
    {
        switch (LuaDLL.lua_gettop(L))
        {
            ...
            case 2:
            {
                string luaString = LuaScriptMgr.GetLuaString(L, 1);
                Encoding encoding = (Encoding) LuaScriptMgr.GetNetObject(L, 2, typeof(Encoding));
                string str4 = WWW.UnEscapeURL(luaString, encoding);
                LuaScriptMgr.Push(L, str4);
                return 1;
            }
        }
