...
public class NewbieGuideClickSymbol : NewbieGuideBaseScript
{
    ...
    protected override void Update()
    {
        ...
        else
        {
            ...
            if (form != null)
            {
                Transform transform = form.get_transform().Find("SymbolEquip/Panel_SymbolEquip/Panel_SymbolBag/Panel_BagList/List");
                if (transform != null)
                {
                    ...
                    if (component != null)
                    {
                        ...
                        GameObject baseGo = (elemenet == null) ? null : elemenet.get_gameObject();
                        if ((baseGo != null) && baseGo.get_activeInHierarchy())
                        {
