...
public class CHeroSelectChatView
{
    ...
    private void _refresh_list(CUIListScript listScript, ListView<CChatEntity> data_list)
    {
        if (listScript != null)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                {
                    elemenet.get_transform().Find("Text").GetComponent<Text>().set_text(string.Format("{0}：{1}", data_list[i].name, data_list[i].text));
                }
            }
        }
    }
    ...
    private void _refresh_list(CUIListScript listScript, List<CChatModel.HeroChatTemplateInfo> data_list)
    {
        if (listScript != null)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if ((elemenet != null) && listScript.IsElementInScrollArea(i))
                {
                    CChatModel.HeroChatTemplateInfo info = data_list[i];
                    elemenet.get_transform().Find("Text").GetComponent<Text>().set_text(info.GetTemplateString());
                }
            }
        }
    }
    ...
    public void On_Bottom_Btn_Click()
    {
        ...
        {
            if (this.chatEntryNode.get_activeInHierarchy())
            {
    ...
    public void On_List_ElementEnable(CUIEvent uievent)
    {
        ...
        {
            uievent.m_srcWidget.get_transform().Find("Text").GetComponent<Text>().set_text(str);
        }
    }
        ...
        if (!this.bIsInChatSend_CD)
        {
            if (this.inputField != null)
            {
                ...
                if (!string.IsNullOrEmpty(str))
                {
                    if (CFakePvPHelper.bInFakeSelect)
                    {
                        CFakePvPHelper.FakeSendChat(str);
                    }
                    else
                    {
                        CChatNetUT.Send_SelectHero_Chat(str);
                    }
                    this.Start_Input_Timer();
    ...
    {
        if ((this.inputField != null) && (this.inputField.get_gameObject() != null))
        {
            this.inputField.get_gameObject().CustomSetActive(this.curChatType == enChatType.Text);
        }
    ...
    public void OpenForm()
    {
        ...
        if (!string.IsNullOrEmpty(str))
        {
            ...
            this.backgroundObject = this.formScript.get_transform().Find("Background").get_gameObject();
            this.show_listScript = this.formScript.get_transform().Find("chatTools/node/ListView/chatList").get_gameObject().GetComponent<CUIListScript>();
            this.tablistScript = this.formScript.get_transform().Find("chatTools/node/Tab/List").get_gameObject().GetComponent<CUIListScript>();
            ...
            this.formScript.get_transform().Find("bubble_node").get_gameObject().CustomSetActive(true);
            this.bubbleObj0 = this.formScript.get_transform().Find("bubble_node/bubble0").get_gameObject();
            this.bubbleText0 = this.bubbleObj0.get_transform().Find("text_bubble0").GetComponent<Text>();
            this.bubbleObj1 = this.formScript.get_transform().Find("bubble_node/bubble1").get_gameObject();
            this.bubbleText1 = this.bubbleObj1.get_transform().Find("text_bubble0").GetComponent<Text>();
            this.bubbleObj2 = this.formScript.get_transform().Find("bubble_node/bubble2").get_gameObject();
            this.bubbleText2 = this.bubbleObj2.get_transform().Find("text_bubble0").GetComponent<Text>();
            this.bubbleObj3 = this.formScript.get_transform().Find("bubble_node/bubble3").get_gameObject();
            this.bubbleText3 = this.bubbleObj3.get_transform().Find("text_bubble0").GetComponent<Text>();
            this.bubbleObj4 = this.formScript.get_transform().Find("bubble_node/bubble4").get_gameObject();
            this.bubbleText4 = this.bubbleObj4.get_transform().Find("text_bubble0").GetComponent<Text>();
            ...
            this.bottomVoiceBtn = this.formScript.get_transform().Find("chatTools/ChatVoiceBtn").get_gameObject();
            this.inputField = this.formScript.get_transform().Find("chatTools/InputField").GetComponent<InputField>();
            this.bottomSendVoiceBtn = this.formScript.get_transform().Find("chatTools/voice_Btn").get_gameObject();
            this.textSendBtn = this.formScript.get_transform().Find("chatTools/TextSendBtn").get_gameObject();
            this.voiceBtnNode = this.formScript.get_transform().Find("VoiceBtn").get_gameObject();
            this.chatEntryNode = this.formScript.get_transform().Find("entry_node").get_gameObject();
            this.chatDetailNode = this.formScript.get_transform().Find("chatTools").get_gameObject();
            this.m_OpenSpeakeObj = this.formScript.get_transform().Find("VoiceBtn/Voice_OpenSpeaker");
            this.m_OpenMicObj = this.formScript.get_transform().Find("VoiceBtn/Voice_OpenMic");
            this.m_OpenSpeakerTipObj = this.formScript.get_transform().Find("VoiceBtn/Voice_OpenSpeaker/info");
            if ((this.m_OpenSpeakerTipObj != null) && (this.m_OpenSpeakerTipObj.get_transform().Find("Text") != null))
            {
                this.m_OpenSpeakerTipText = this.m_OpenSpeakerTipObj.get_transform().Find("Text").GetComponent<Text>();
            }
            this.m_OpenMicTipObj = this.formScript.get_transform().Find("VoiceBtn/Voice_OpenMic/info");
            if ((this.m_OpenMicTipObj != null) && (this.m_OpenMicTipObj.get_transform().Find("Text") != null))
            {
                this.m_OpenMicTipText = this.m_OpenMicTipObj.get_transform().Find("Text").GetComponent<Text>();
            }
    ...
    public void Set_Show_Bottom(bool bShow)
    {
        if ((this.inputField != null) && (this.inputField.get_gameObject() != null))
        {
            this.inputField.get_gameObject().CustomSetActive(bShow && (this.curChatType == enChatType.Text));
        }
        if (this.bottomSendVoiceBtn != null)
        {
    ...
    private void ShowTemplate(CUIListElementScript tab_element, bool bShowTemplate)
    {
        if (tab_element != null)
        {
            GameObject obj2 = tab_element.get_gameObject().get_transform().Find("img_template").get_gameObject();
            if (obj2 != null)
            {
                obj2.CustomSetActive(bShowTemplate);
            }
            GameObject obj3 = tab_element.get_gameObject().get_transform().Find("img_history").get_gameObject();
            if (obj3 != null)
            {
