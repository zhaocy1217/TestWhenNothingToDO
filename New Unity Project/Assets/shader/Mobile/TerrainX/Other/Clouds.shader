    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                fixed3 baseMorphNormals = ((cloudTexture.rgb*2 -1 + _Density) * i.vertexColor.a) - (cloudTexture2.rgb*2-1);
		...
		Pass {
            ...
            //Specific blend settings, do not modify
            ...
            float4 frag(VertexOutput i) : COLOR {
                float attenuation = LIGHT_ATTENUATION(i);
                float3 lightContrib = _LightColor0.rgb*attenuation;
                return fixed4(lightContrib, 0);
            }
            ENDCG
        }
    }
