...
#define LOD_DITHER_COORDS(idx) half3 ditherScreenPos : TEXCOORD##idx;
#define LOD_DITHER_VS o.ditherScreenPos = GOEComputeDitherScreenPos(o.pos);
#define LOD_DITHER_PS GOEApplyDitherCrossFade(i.ditherScreenPos);
#define LOD_ALPHA_PS tex.a *= unity_LODFade.x;

half3 GOEComputeDitherScreenPos(float4 hPos)
{
...
void GOEApplyDitherCrossFade(half3 ditherScreenPos)
{
...
inline float4 ObjectToWorldPos(float4 vertex)
{
